...
當貴組織中的每個人都將目標與貴組織的目標一致時，他們可以清楚瞭解其個人貢獻和團隊努力如何有助於推動大型公司層級優先順序的進展。 如需調整目標之最佳實務的詳細資訊，請參閱[Adobe Workfront目標中的目標調整概觀](../../workfront-goals/goal-alignment/goal-alignment-overview.md)。
...
本文說明如何藉由將目標相互連線來對齊目標。 如需有關將結果和活動轉換為目標以對齊目標的資訊，請參閱[將結果和活動轉換為目標以對齊目標](../../workfront-goals/goal-alignment/align-goals-by-converting-results-activities.md)。
...
1. （可選）啟動您要對齊的目標。 您可以對齊狀態為「草稿」、「作用中」或「非作用中」的目標。 如需啟用目標的相關資訊，請參閱[在Adobe Workfront目標中啟用目標](../../workfront-goals/goal-management/activate-goals.md)。
...
1. 在&#x200B;**上層目標資訊**&#x200B;區域中，如果沒有上層目標，請按一下&#x200B;**上層目標**&#x200B;欄位中的&#x200B;**新增**。

   或

   按一下上層目標的名稱以選擇其他目標。

1. 開始在&#x200B;**上層目標**&#x200B;欄位中輸入現有目標的名稱，然後在其出現在清單中時選取它。 清單中只會顯示相同或未來期間的目標。
...
當子目標的進度更新父目標的進度時，其進度會顯示在父目標的進度指示器區段中。
   ...
   ![對齊的卡片](assets/goal-1-and-2-aligned-cards-350x427.png)

1. （可選）若要檢視「目標校準」區段中的目標，請前往Workfront的「目標」區域，然後按一下左側面板中的「**目標校準**」區段。 有關「目標校準」區段的資訊，請參閱[瀏覽Adobe Workfront目標中的「目標校準」區段](../../workfront-goals/goal-alignment/navigate-goal-alignment-chart.md)。
...
1. （可選）當您認為與您組織的整體策略不再相關時，請移除兩個目標之間的對齊方式。 如需有關移除目標間對齊方式的資訊，請參閱[移除Adobe Workfront目標中的目標對齊方式](../../workfront-goals/goal-alignment/remove-goal-alignment.md)。
