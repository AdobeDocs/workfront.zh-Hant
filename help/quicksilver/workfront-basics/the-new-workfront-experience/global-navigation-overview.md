...
![頂端導覽列](assets/wf-top-navigation-070626.png)
...
**[!UICONTROL 主功能表]**&#x200B;圖示![主功能表](assets/main-menu-icon-left-nav.png)會開啟[!UICONTROL 主功能表]，您可以在此導覽至Workfront的其他區域。
...
**[!UICONTROL 我的最愛]**&#x200B;圖示![我的最愛](assets/favorites-icon.png)會開啟系統中您已標示為我的最愛的頁面清單。 您可以從此功能表新增目前所在的頁面。

若要深入瞭解我的最愛，請參閱[檢視和管理我的最愛](../../workfront-basics/navigate-workfront/recent-and-favorites/view-and-manage-favorites.md)。

## [!UICONTROL 最近]個功能表

**[!UICONTROL 最近]**&#x200B;圖示![[!UICONTROL 最近]](assets/recents-icon.png)會開啟您最近造訪過的頁面清單。
