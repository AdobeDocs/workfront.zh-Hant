...
您可以使用 [!UICONTROL 摘要] 面板，直接從任務清單、問題、檔案或的其他區域檢閱和更新工作專案資訊。 [!DNL Adobe Workfront] 顯示任務和問題。

下表顯示您可以找到和使用的區域 [!UICONTROL 摘要] 面板：
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td>[！UICONTROL工作負載平衡器]的[！UICONTROL指派的工作]區域問題</td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[！UICONTROL檢視]或更高的任務、問題、檔案存取權</p> <p>[！UICONTROL檢視]或您想要檢視其檔案之任何物件的更高存取權[！UICONTROL摘要]</p> <p>注意：如果您仍然沒有存取權，請詢問您的 [!DNL Workfront] 管理員是否對您的存取層級設定其他限制。 如需如何進行 [!DNL Workfront] 管理員可以修改您的存取層級，請參閱 <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">建立或修改自訂存取層級</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><strong>物件許可權</strong></td> 
   <td> <p>[！UICONTROL檢視]或任務、問題或檔案的較高許可權</p> <p>如需請求其他存取許可權的詳細資訊，請參閱 <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">要求物件的存取權 </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 按一下 **[!UICONTROL 摘要]** 圖示 ![](assets/qs-summary-in-new-toolbar-small.png)
   ...
   按一下 **[!UICONTROL 開啟摘要]** 圖示 ![](assets/open-summary-with-text-nwe.png) 在 [!UICONTROL 已提交] 部分 [!UICONTROL 請求] 區域。
...
使用頂端的進度列 [!UICONTROL 摘要] 更新您選取的任務或問題的完成百分比。 輸入數字或將橫條拖曳至正確的百分比。

![](assets/summary-overview-percent-complete-350x395.png)

## [!UICONTROL 更新]

使用 [!UICONTROL 更新] 部分 [!UICONTROL 摘要] 以檢視最近的更新，並對您選取的任務或問題執行更新。 按一下 **[!UICONTROL 檢視全部]** 直接前往 [!UICONTROL 更新] 標籤上的工作。

![](assets/summary-updates-with-block-quote-350x290.png)

## [!UICONTROL 文件]

使用 [!UICONTROL 檔案] 部分 [!UICONTROL 摘要] 以檢視附加到您所選任務或問題的檔案。 按一下縮圖以開啟檔案預覽。 若要直接前往 [!UICONTROL 檔案] 標籤上，按一下 **[!UICONTROL 檔案]** 標題。

![](assets/summary-overview-documents-350x84.png)

## [!UICONTROL 詳细資料]

使用 [!UICONTROL 詳細資料] 部分 [!UICONTROL 摘要] 若要檢視高階工作專案明細、指定任務或新增開始日期。 按一下 **[!UICONTROL 檢視全部]** 直接前往 [!UICONTROL 詳細資料] 標籤上的任務或問題。
...
此區段僅適用於任務。 使用 [!UICONTROL 子任務] 部分 [!UICONTROL 摘要] 以檢視 [!UICONTROL 新增]， [!UICONTROL 進行中]、和 [!UICONTROL 已關閉] 您選取之任務的子任務。 按一下 **[!UICONTROL 狀態]** 下拉式功能表以切換狀態。 若要直接前往 [!UICONTROL 子任務] 標籤上，按一下 **[!UICONTROL 子任務]**&#x200B;標&#x200B;題

如果您尚未將任何子任務新增至任務，請按一下 **[!UICONTROL 在這裡新增一個]** 直接前往 [!UICONTROL 子任務] 標籤上的工作。

![](assets/summary-overview-subtasks-350x140.png)

## [!UICONTROL 時數]

使用 [!UICONTROL 小時] 部分 [!UICONTROL 摘要] 以記錄所選任務或問題的時數。 按一下 **[!UICONTROL 記錄時間]** 並輸入小時。 若要直接前往任務或問題上的時數索引標籤，請按一下 **[!UICONTROL 小時]** 標題。

中的小時計數 [!UICONTROL 摘要] 顯示您所記錄的時數。 其他使用者在中會有不同的小時總計 [!UICONTROL 摘要] 視他們登入工作的時間而定。

如果沒有計畫 [!UICONTROL 小時] 在任務或問題上且您已記錄時間，時數列顯示紅色。

![](assets/summary-overview-hours-350x96.png)

## 核准

使用 [!UICONTROL 核准] 部分 [!UICONTROL 摘要] 以檢視附加至您所選任務或問題的核准。 如果您尚未新增任何核准，請從下拉式選單中選取現有核准，或按一下 **[!UICONTROL 建立單一使用核准流程]** 直接前往 [!UICONTROL 核准] 標籤上的任務或問題。

若要直接前往 [!UICONTROL 核准] 標籤上，按一下 **[!UICONTROL 核准]** 標題。
