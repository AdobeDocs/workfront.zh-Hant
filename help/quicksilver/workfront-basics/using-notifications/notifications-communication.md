...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>物件名稱<br>父物件名稱<br>物件參考編號<br>進行導向更新的使用者名稱<br>包含在導向更新中的所有團隊和使用者的名稱<br>進行導向更新的日期和時間<br>導向更新的文字<br><strong>[！UICONTROL Comment]</strong> button<br>*收到的評論總數<br>*每個物件收到的評論數<br>*專案名稱<br>*<strong>[！UICONTROL檢視所有通知]</strong> button<br>*每日摘要日期 </p> </td> 
   <td><strong>每日</strong> </td> 
  </tr> 
  <tr> 
