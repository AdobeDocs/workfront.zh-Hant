...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 專案名稱<br>[!UICONTROL Portfolio名稱]<br>[!UICONTROL 專案參考編號]<br>代表您核准/拒絕專案的使用者名稱<br>[!UICONTROL 核准決定]<br>[!UICONTROL 專案狀態]<br>要求核准的使用者名稱<br><strong>[!UICONTROL 檢視更多詳細資料]</strong>按鈕<br>*專案參考編號<br>*專案名稱<br>*核准者名稱<br> 1&rbrace;[!UICONTROL *每日摘要的日期]<br></td> 
   <td><strong>每日</strong> </td> 
  </tr> 
  <tr> 
