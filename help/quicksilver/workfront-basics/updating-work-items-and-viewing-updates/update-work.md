...
1. （選擇性）按一下「**回覆**」或開始在「**新增回覆……**」區域輸入註解，以回覆現有的註解，然後遵循上述步驟3-7。<!--(**************insure this stays accurate***********)--> 如需回覆更新的詳細資訊，請參閱[回覆更新](../../workfront-basics/updating-work-items-and-viewing-updates/reply-to-updates.md)。
