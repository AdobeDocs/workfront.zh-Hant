...
您可以直接從[!UICONTROL 首頁]區域中的團隊請求Widget存取指派給您團隊的請求。 [!UICONTROL 團隊請求] Widget最多可以為團隊顯示2,000個請求。

如需有關團隊請求的詳細資訊，請參閱[團隊請求概觀](../../../people-teams-and-groups/work-with-team-requests/team-requests-overview.md)。
