...
您可以在中篩選專案 [!UICONTROL 工作清單] 以僅檢視特定型別的專案。 例如，您可以篩選 [!UICONTROL 工作清單] 以僅顯示問題或請求。
...
## 分組和排序依據 [!UICONTROL 日期]， [!UICONTROL 專案]、和 [!UICONTROL 優先順序]
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>專案會依您選擇的順序顯示。 如需詳細資訊，請參閱 <a href="../../../workfront-basics/using-home/using-the-home-area/prioritize-work-in-home.md" class="MCXref xref">優先處理[！UICONTROL首頁]區域中的工作</a>.</td> 
     </tr> 
    </tbody> 
   </table>
...
[!DNL Adobe Workfront] 使用下列日期來判斷工作請求是否延遲：
...
當您搜尋 [!UICONTROL 工作清單]，則指派給您的任何專案都會在搜尋中傳回（甚至是目前未載入畫面上的專案）。 如果 [!UICONTROL 顯示完成] 選項，則會傳回您在過去兩週內標示為完成的任何專案。
...
中的專案 [!UICONTROL 工作清單] 會顯示在分組中。 您可以摺疊和展開群組，以控制特定時間頁面上顯示的資訊量。
...
1. 按一下 **[!UICONTROL 展開]** 或 **[!UICONTROL 摺疊]** 您想要展開或收合的任何群組旁的箭頭。
   ...
   或\
   若要同時展開或收合所有群組，請按一下 **[!UICONTROL 展開]** 或 **[!UICONTROL 摺疊]** 按住任何群組旁的箭頭 [!UICONTROL Shift] 機碼。
