...
description: 此 [!UICONTROL 首頁] 區域是您尋找指派給您的任務、問題和核准的一站式服務。 檢視您工作的方式有兩種： [!UICONTROL 首頁] 區域，來自 [!UICONTROL 工作清單] 或 [!UICONTROL 行事曆].
author: Nolan
...
此 [!UICONTROL 首頁] 區域是您尋找指派給您的任務、問題和核准的一站式服務。 這些篩選、分組和排序選項可共同運作，以支援您以您想要的方式組織工作專案。 您可以使用分組來分組專案，使用篩選器來專注於需要完成的工作，最後使用排序來按分組的升序或降序列出專案。
...
您可以使用分組在工作清單的通用標題下顯示相似的專案。 您可以依下列方式群組專案：
...
此 [!UICONTROL 首頁] 區域有永久分組([!UICONTROL 團隊請求])，顯示指派給團隊的任務和問題。 團隊會顯示在此區段中。 按一下團隊名稱會開啟該團隊的「團隊請求」頁面。

>[!NOTE]
>
>篩選和排序選項不會影響 [!UICONTROL 團隊請求] 分組。 只要您已將工作指派給團隊，就可以看到此分組。
...
追蹤您直接從提交以供核准的工作 [!UICONTROL 工作清單]. 「 」有一個永久分組 [!UICONTROL 我已提交的核准] 當您選取檢視時 [!UICONTROL 核准] 在 [!UICONTROL 工作清單]. 您可以提醒核准者需要核准的工作。 如有需要，您也可以恢復核准。

>[!NOTE]
>
>篩選和排序不會影響 [!UICONTROL 我已提交的核准] 分組。 只要您有工作等待核准，就可以看到此分組。
>
>中的核准數 [!UICONTROL 核准] 篩選器不顯示您提交核准的專案數。 此 [!UICONTROL 核准] 篩選器僅顯示等待您核准的專案。

![](assets/approvals-expanded-home-group-by-drop-down-nwe-350x415.png)

## 優先處理對您而言重要的事項

此 [!UICONTROL 工作清單] 可讓您透過設定優先順序來呈現對您而言重要的工作 [!UICONTROL 我的優先順序] 分組。 您最多可以新增20個專案至 [!UICONTROL 我的優先順序] 清單。
...
按一下「 」中專案名稱之後， [!UICONTROL 工作清單]，使用中的右側面板 [!UICONTROL 首頁] 更新並完成您的工作。

### 在為您自訂的空間中工作

您的 [!DNL Workfront] 管理員最多可以新增16個自訂欄位到中的專案 [!UICONTROL 工作清單]以更輕鬆地尋找及更新您所需的資訊。 大部分欄位都可編輯，因此您不必導覽至工作專案。

若要更新此區域中的任何欄位，只要按一下欄位即可。 如果欄位可編輯，您可以在右側面板中修改它。

>[!NOTE]
>
>您無法更新 [!UICONTROL 認可日期] 若將此欄位從版面配置範本新增至工作專案。

![](assets/16-fields-home-350x137.png)

### 以重要資訊更新其他人

透過以下網站與他人快速有效率地通訊： [!UICONTROL 首頁] 區域。 使用工作專案的註解區域，您可以提出問題、通知其他人最近的更新，或回覆來自下列專案的直接註解 [!UICONTROL 首頁] 區域。 此外，您還可以透過下列方式，向其他人更新您目前的進度：

* 更新 [!UICONTROL 認可日期] 在註解區域中

  >[!NOTE]
  >
  >   這是您唯一可以在首頁更新認可日期的位置。

* 透過新增評論或更新 [!UICONTROL 條件] 專案的
* 更新完成百分比列
