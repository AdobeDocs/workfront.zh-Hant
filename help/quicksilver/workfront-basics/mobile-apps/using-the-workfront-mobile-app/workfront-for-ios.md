...
description: 此 [!DNL Adobe Workfront] 應用程式可讓您存取在任何iOS裝置上的工作。 您可以安裝並使用 [!DNL Workfront] 在執行iOS 10或更新版本的手機和平板電腦上使用行動應用程式。 專用的 [!DNL Workfront] 行動應用程式可用於iPhone和iPad。
author: Nolan
...
此 [!DNL Adobe Workfront] 應用程式可讓您存取您在任何應用程式上的工作 [!DNL iOS] 裝置。 您可以安裝並使用 [!DNL Workfront] 在執行iOS 10或更新版本的手機和平板電腦上使用行動應用程式。 專用的 [!DNL Workfront] 行動應用程式同時適用於 [!DNL iPhone] 和 [!DNL iPad].
...
此 [!UICONTROL 專案] 區域可讓您與互動並管理 [!UICONTROL 專案] 您擁有以及您參與的專案。 從應用程式的專案區域，您可以：
