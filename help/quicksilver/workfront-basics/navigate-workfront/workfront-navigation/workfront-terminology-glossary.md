...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>[!UICONTROL已計畫]</td> 
   <td> <p>排程發生某件事的時間範圍。 當您在 [!DNL Workfront]，您可以建立計畫的開始和結束日期，以及發生時間範圍。 這些值代表您的原始意圖，或工作時間完成所需時間的估計。 </p></td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL計畫福利]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>[!UICONTROL計畫免除]</td> 
   <td>也稱為[!UICONTROL修改的Shift]。 排程的天數，與排程所定義的每週一般工作時間不同。 例如，排程在星期一到星期五設為僅工作時，排程將是[!UICONTROL排程例外]。</td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL計畫報表]</td> 
