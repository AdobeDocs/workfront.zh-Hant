...
<p>計畫日期對齊會顯示在專案、任務、問題清單和報告中。 </p></td> 
  ...
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Ad hoc"> 
   ...
   <td> <p>具有統一特性的專案集合。 這些專案通常會爭奪相同的資源、預算或時段。 您可以將投資組合分割成計畫，並在將專案新增到Portfolio之前建立專案與計畫的關聯。</p> <p>如需投資組合的詳細資訊，請參閱<a href="../../../manage-work/portfolios/portfolios-overview/portfolio-overview.md">中的[!DNL Adobe Workfront]</a>Portfolio概觀。</p> 
   </td> 
  </tr> 
  <tr data-mc-conditions="SnippetConitions_MaturityModel.Integrated"> 
