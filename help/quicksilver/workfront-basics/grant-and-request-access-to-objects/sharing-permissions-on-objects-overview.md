...
* **費率卡**：如需詳細資訊，請參閱[共用費率卡](/help/quicksilver/administration-and-setup/manage-enterprise-operations/share-rate-cards.md)。
  ...
  <tr> 
   ...
   <td> <p>您可以對物件執行下列動作：</p> 
    <ul> 
     ...
     <li><p>檢視物件的成本費率、收費率或一般財務資訊</p></li> 
