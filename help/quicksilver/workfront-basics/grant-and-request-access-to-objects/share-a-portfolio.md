...
1. 在&#x200B;**授與投資組合存取權**&#x200B;欄位中，開始輸入您想要與其共用投資組合的使用者、團隊、角色、群組、公司、<span class="preview">或企業設定檔</span>的名稱，然後在其出現在下拉式清單中時按一下該名稱。
...
1. 在&#x200B;**授與投資組合存取權**&#x200B;欄位中，開始輸入您要與其共用投資組合的使用者、團隊、角色、群組、公司、<span class="preview">或企業設定檔</span>的名稱，然後在其出現在下拉式清單中時按一下該名稱。
