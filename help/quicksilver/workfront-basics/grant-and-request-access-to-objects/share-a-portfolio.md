...
指派存取層級時，您的Adobe Workfront管理員可授予您檢視或編輯投資組合的存取權。 您必須擁有Standard或Plan授權才能編輯投資組合。 如需詳細資訊，請參閱[授予投資組合的存取權](../../administration-and-setup/add-users/configure-and-grant-access/grant-access-portfolios.md)。
...
1. 在&#x200B;**授與投資組合存取權**&#x200B;欄位中，開始輸入您要共用投資組合的使用者、團隊、角色、群組、公司或企業設定檔名稱，然後在其出現在下拉式清單中時按一下該名稱。
