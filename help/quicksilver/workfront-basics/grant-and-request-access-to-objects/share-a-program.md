...
指派存取層級時，您的Adobe Workfront管理員可授予您檢視或編輯方案的存取權。 您必須擁有標準或計畫授權才能編輯方案。 如需詳細資訊，請參閱[授予程式的存取權](../../administration-and-setup/add-users/configure-and-grant-access/grant-access-programs.md)。
...
* 您可以從程式中移除繼承的許可權。 如需有關移除物件許可權的詳細資訊，請參閱[移除物件許可權](../../workfront-basics/grant-and-request-access-to-objects/remove-permissions-from-objects.md)。
...
1. 在&#x200B;**授與方案存取權**&#x200B;欄位中，開始輸入您要與其共用方案的使用者、團隊、角色、群組、公司或企業設定檔的名稱，然後當名稱出現在下拉式清單中時按一下該名稱。
...
1. 在&#x200B;**授與方案存取權**&#x200B;欄位中，開始輸入您要共用方案的使用者、團隊、角色、群組、公司或企業設定檔的名稱，然後當名稱出現在下拉式清單中時，按一下該名稱。
