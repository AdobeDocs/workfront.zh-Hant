...
在屬於工作流程一部分的展示板上無法使用輸入欄。 反之，您可以設定待處理欄以從卡片清單提取卡片。 如需在工作流程中新增待處理專案欄至面板的相關資訊，請參閱 [在工作流程展示板上設定待處理專案](/help/quicksilver/agile/use-boards-agile-planning-tools/configure-backlog-workstream-board.md).
