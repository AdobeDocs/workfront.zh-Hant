...
1. 按一下&#x200B;**[!UICONTROL 更多]**&#x200B;功能表![](assets/more-menu.png)，然後選取&#x200B;**[!UICONTROL 編輯]**。
   ...
   ![編輯團隊](assets/edit-team-settings-kanban.png)
...
您必須啟用[!UICONTROL Kanban]展示板上的&#x200B;**顯示待處理專案**&#x200B;設定，才能使用此功能。

每當劇本從[!UICONTROL 進行中]欄移至劇本展示板上代表[!UICONTROL 完成]狀態（或相等於[!UICONTROL 完成]的狀態）的欄時，待處理資料欄中的下一個劇本就會自動移至[!UICONTROL Kanban展示板]的[!UICONTROL 新]欄。

下一個劇本是未完成劇本，其待處理訂單編號最低，且符合下列所有條件：
...
待處理專案順序與優先順序不同。 您可以在「待處理專案」欄中拖放內文，以安排待處理專案順序。 待處理專案最上方的故事，就是下一個被拉到展示板上的故事。

若要自動將待處理專案中的劇本新增至[!UICONTROL Kanban]面板：
...
1. 選取您要管理的Kanban團隊。
1. 按一下&#x200B;**[!UICONTROL 更多]**&#x200B;功能表![](assets/more-menu.png)，然後選取&#x200B;**[!UICONTROL 編輯]**。
1. 選取&#x200B;**[!UICONTROL 自動從待處理專案新增下一個劇本]**&#x200B;以設定待處理專案中的下一個專案，當專案移出&#x200B;**[!UICONTROL 進行中]**&#x200B;欄時，自動新增至&#x200B;**[!UICONTROL 新增]**&#x200B;欄。
