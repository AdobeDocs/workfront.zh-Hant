...
如需有關在專案上使用面板的資訊，請參閱[在面板檢視中管理敏捷專案](/help/quicksilver/manage-work/projects/manage-projects/manage-projects-in-agile-view.md)。
...
如需[!DNL Workfront]中其他Agile工具的相關資訊，請參閱[Agile總覽](../agile/agile-overview.md)。
