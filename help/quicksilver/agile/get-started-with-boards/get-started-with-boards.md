...
description: 請檢閱這些文章，了解如何使用Workfront中的展示板。
author: Lisa
feature: Agile
...
* [在主板上使用連接的卡](/help/quicksilver/agile/get-started-with-boards/connected-cards.md)
...
* [展示板電子郵件通知和偏好設定](/help/quicksilver/agile/get-started-with-boards/boards-emails.md)
