...
* 檢閱和核准工作 {#review-and-approve-work}
   ...
   * 原生整合 {#native-integrations}
      ...
      * [透過Frame.io整合使用Adobe Experience Manager](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/use-aem-with-frame.md)
...
* Adobe Workfront規劃 {#adobe-workfront-planning}
   ...
   * Adobe Workfront規劃與Gen Studio的效能行銷整合 {#planning-and-genstudio-integration}
      ...
      * [開始使用Workfront規劃和GenStudio for Performance Marketing整合](planning/planning-and-genstudio-integration/get-started-with-workfront-planning-and-genstudio-integration.md)
