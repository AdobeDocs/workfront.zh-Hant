...
* 報告 {#reporting}
   ...
   * Workfront資料連線{#data-lake}
      * [Workfront Data Connect概觀](reports-and-dashboards/data-lake/data-lake-overview.md)
      * [建立Reader帳戶或連線以進行Snowflake](reports-and-dashboards/data-lake/create-a-reader-account.md)
...
* 檢閱與核准工作 {#review-and-approve-work}
   ...
   * 資產和檔案檢閱與核准{#document-reviews-and-approvals}
      ...
      * [新檔案核准總覽](review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Adobe Workfront Fusion {#scenarios-in-fusion}中的案例
      ...
      * [使用AI產生案例區段](/help/quicksilver/workfront-fusion/scenarios/add-a-module-with-ai.md)
   ...
   * Workfront Fusion應用程式及其模組{#fusion-apps-and-modules}
      ...
      * [Adobe使用者管理模組](workfront-fusion/apps-and-their-modules/adobe-user-management-modules.md)
      ...
      * [[!DNL Draft.js]模組](/help/quicksilver/workfront-fusion/apps-and-their-modules/draft-js-modules.md)
      ...
      * [JSONata模組](workfront-fusion/apps-and-their-modules/jsonata-module.md)
      ...
      * [Microsoft Dynamics 365模組財務與營運](workfront-fusion/apps-and-their-modules/dynamics-finance-operations-modules.md)
...
* Adobe Workfront整合{#adobe-workfront-integrations}
   ...
   * 適用於Google Workspace {#workfront-for-g-suite}的Adobe Workfront
...
* [2025年第一季度版本總覽 — 測試](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/release-overview-test.md)
