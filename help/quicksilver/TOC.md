...
* 檢閱和核准工作 {#review-and-approve-work}
   ...
   * [Alpha方案 — 檔案核准](review-and-approve-work/Documents/doc-approvals-alpha.md)
...
* Adobe Workfront規劃 {#adobe-workfront-planning}
   ...
   * Adobe Workfront規劃架構 {#adobe-workfront-planning-architecture}
      ...
      * [集中式記錄型別概觀](planning/architecture/centralized-record-types-overview.md)
      * [設定記錄型別的跨工作區功能](planning/architecture/configure-record-type-cross-workspace-capabilities.md)
      * [新增現有記錄型別](planning/architecture/add-cross-workspace-record-types.md)
