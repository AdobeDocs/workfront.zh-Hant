...
1. 按一下檔名稱，前往檔案頁面，然後在版本下拉式清單中選取您要建立核准的檔案版本。 預設會選取最新版本。
...
1. 向下捲動至 **核准** 區段。 若要新增核准者，請確定 **核准者** 核取方塊，然後開始輸入 **檢閱者** 文字方塊。 您可以依名稱新增Workfront使用者或團隊。 如果您想改為新增稽核者，只需取消勾選 **核准者** 核取方塊。
