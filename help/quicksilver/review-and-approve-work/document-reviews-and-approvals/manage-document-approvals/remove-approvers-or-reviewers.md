...
1. 暫留在您要移除的核准者或檢閱者名稱上，然後按一下 **刪除** 圖示 ![](../assets/delete.png) 出現在名稱后面的「 」。

   核准或稽核請求被移除，且核准者會收到不再需要其核准的通知。 也會移除其核准相關的共用存取權。

1. （可選）若要將核准者降級給稽核者而非將其完全移除，請取消核取 **核准者** 核取方塊與其名稱一致。
...
1. 向下捲動至 **核准** 區段。 暫留在您要移除的核准者或檢閱者名稱上，然後按一下 **刪除** 圖示 ![](../assets/delete.png) 出現在名稱后面的「 」。
