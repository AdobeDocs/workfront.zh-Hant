...
>[!IMPORTANT]
>
>此功能即將推出。 目前，Frame.io帳戶是由Workfront團隊手動新增。 請聯絡您的Adobe客戶代表。
...
* **檢閱者** 可以新增註解及標籤資產。 完成後，他們可以將其稽核標籤為完成。 資產不需要將稽核標籤為完成，才能在核准程式中前進。<!--example of when to add reviewers-->
...
* **核准範本**：在Workfront設定區域中，專案專員可以建立可繼續使用的核准範本。 在範本中，使用者可以新增稽核者和核准者，並指定完成時間範圍。 將核准範本套用至資產時，截止日期是從指定的時間範圍計算。
  ...
  如需詳細資訊，請參閱 [建立及管理核准範本]
  <!--add link.-->

* 從Workfront上傳資產，並將其傳送至框架以供檢閱和核准 <!-- delayed? -Need more info on this workflow -->

### 核准Frame.io中的資產

利害關係人可以利用Frame.io檢視器檢閱和核准連結的資產。

如需在Frame.io中檢閱資產的詳細資訊，請參閱 <!-- get link from frame team?-->
...
* 核准：資產不需要變更，且可隨時使用。
* 核准，但有變更：資產需要變更，且在變更完成後即可使用。 不需要額外核准。
...
檢閱者可以在Frame.io檢視器內將其檢閱標籤為完成，但這並非資產在核准程式中前進所必需的。 <!--check if this is accurate -->
...
### 將核准的資產傳送到Adobe Experience Manager Assets

<!-- deprioritized?-->
使用原生整合，將核准的資產傳送至Adobe Experience Manager Assets。
...
![](assets/example-workflow.png)  — 可能需要其他版本，或甚至需要逐步解說影片
