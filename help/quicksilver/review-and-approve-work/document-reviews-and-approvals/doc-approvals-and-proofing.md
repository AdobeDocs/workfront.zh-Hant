...
1. （選擇性）選擇現有的核准範本。 擁有Standard授權的使用者可以從「設定」區域建立可重複使用的核准範本。 如需詳細資訊，請參閱[建立檔案的核准工作流程範本](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md)。
...
1. （選擇性）重複上一步驟，視需要新增其他階段。
   ...
   ![新階段](assets/new-stage.png)

1. 新增所有檢閱者和核准者後，請按一下&#x200B;**要求核准**。 系統會透過電子郵件通知參與者。
