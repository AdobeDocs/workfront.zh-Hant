...
title: 檢閱檔案
description: 身為稽核者，您可以預覽已提交給您稽核的檔案。
author: Nolan
...
1. 將滑鼠懸停在「預覽」方塊中的檔案上。 然後，執行以下任一操作：

   按一下 **預覽** 在新視窗中開啟檔案的唯讀版本。

   或

   按一下 **下載** 將檔案的本機副本下載到您的裝置上。

1. （選擇性）檢閱完檔案後，您可以在檔案的註解中為請求者留下註解 **更新** 區段。 如需註解的詳細資訊，請參閱 [更新工作](/help/quicksilver/workfront-basics/updating-work-items-and-viewing-updates/update-work.md).
...
1. 將滑鼠懸停在中的檔案預覽上 **詳細資料** 「檔案摘要」窗格頂端的區段。 然後，執行以下任一操作：
...
1. （可選）您也可以向下捲動至「 」，預覽或下載特定版本的檔案。 **版本** 「檔案摘要」窗格的區段，然後按一下「更多」圖示 ![](../assets/more-icon.png) ，位於您要檢閱和選取的版本旁 **下載** 或 **預覽**.