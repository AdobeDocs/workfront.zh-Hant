...
title: 變更校訂上的現有決定
description: 只要校訂處於作用中（未鎖定或封存）狀態，您就可以隨時變更您的決定。
author: Courtney
...
只要校訂處於作用中（未鎖定或封存）狀態，您就可以隨時變更您的決定。 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"><strong>校訂角色</strong> </td> 
...
1. 按一下您在校訂檢視器最上方做出的決定。
1. 在出現的&#x200B;**校訂決定**&#x200B;方塊中，按一下您先前決定下方的&#x200B;**移除決定**。
