...
1. 如果未顯示左圖示功能表，請按一下校訂檢視器左上角的&#x200B;**功能表**&#x200B;圖示。
   ...
   ![功能表圖示](assets/menu-icon-in-proofing-viewer-350x188.png)
...
1. （可選）變更人員名稱右邊的任何檢閱者選項：
   ...
   * **階段**： （只有在校訂具有自動化工作流程時才可用）。 如需詳細資訊，請參閱[自動化工作流程階段總覽](../../../../review-and-approve-work/proofing/proofing-overview/stages.md)。
