...
1. 按一下&#x200B;**比較校樣**。
   ...
   如需您可以用來比較兩個校訂的工具相關資訊，請參閱[在校訂檢視器中比較校訂](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md)中的[使用比較工具](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md#using-compare-tools)。
