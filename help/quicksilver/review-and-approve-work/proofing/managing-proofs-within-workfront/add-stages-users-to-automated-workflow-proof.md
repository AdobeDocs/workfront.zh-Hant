...
title: 將階段和使用者新增到校訂上的自動化工作流程
description: 如果您是校訂所有者，則可以將階段新增至現有的自動化工作流程。
author: Courtney
...
# 將階段和使用者新增到校訂上的自動化工作流程

如果您是校訂所有者，則可以將階段新增至現有的自動化工作流程。
...
1. 在Adobe Workfront的右上角附近，按一下&#x200B;**新增階段**。
1. 指定下列專案：
