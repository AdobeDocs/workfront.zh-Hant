...
title: 將其他核准者新增至已提交的檔案核准
description: 您可以直接從「首頁」區域將其他核准者新增至檔案核准。
author: Courtney
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>檢視或更高的存取許可權以存取與要求存取或核准相關聯的物件 </p> <p>如需請求其他存取權的資訊，請參閱<a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">請求物件</a>的存取權。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 按一下右面板右上角的&#x200B;**管理核准**。
1. 在&#x200B;**請某人核准此檔案**&#x200B;方塊中，輸入核准者的名稱。

   如果您的Adobe Workfront管理員已啟用與未使用Workfront的人員共同作業的功能（如[設定系統安全性偏好設定](../../administration-and-setup/manage-workfront/security/configure-security-preferences.md)中所述），您可以輸入他們的電子郵件地址來加入他們。
