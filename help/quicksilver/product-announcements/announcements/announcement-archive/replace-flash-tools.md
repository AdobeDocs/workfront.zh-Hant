 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p><strong>使用報告</strong> </p> <p>內建使用率報告會並排顯示計畫、預算和實際時數、成本和收入。 </p> <p>如需有關使用率報告的資訊，請參閱<a href="../../../resource-mgmt/resource-utilization/view-utilization-information.md" class="MCXref xref">檢視資源使用率資訊</a>。 </p> 
    ...
    </div> <p><strong>資源規劃工具角色檢視</strong> </p> <p>舊版資源管理工具中業務案例的預算與計畫時數，現在可以在新的原生檢視 — 資源規劃工具的角色型檢視中使用。 此檢視表提供可用時數、計畫時數和預算時數等一目瞭然的資訊，可讓您在同一位置控制和變更預算。 這確保在高層級工作角色規劃期間做出更好的決策。 </p> <p> 如需有關資源規劃工具角色檢視中預算資源的資訊，請參閱<a href="../../../resource-mgmt/resource-planning/get-started-resource-planner.md" class="MCXref xref">資源規劃工具概觀</a>中的<a href="../../../resource-mgmt/resource-planning/get-started-resource-planner.md#using2" class="MCXref xref">使用專案和角色檢視來預算資源</a>區段</p> </td> 
  </tr> 
  <tr> 
    ...
    <ul> 
     <li> <p>分析階段的<strong>：</strong> </p> 
      <ul> 
       ...
       <li> <p><strong>資源規劃工具的使用者檢視</strong><strong>：</strong>嘗試在更高的層級瞭解您的使用者要分配哪些專案時，請使用資源規劃工具的使用者檢視。 這可讓您檢視使用者正在處理哪些工作，以及他們在特定時間範圍內的過度與不足配置。 資源規劃工具也會提供使用者整體配置的視覺效果，以及實際記錄時數的視覺效果，有助於分析完成工作的進度。 </p> <p>如需有關在資源規劃工具中使用使用者檢視的資訊，請參閱<a href="../../../resource-mgmt/resource-planning/get-started-resource-planner.md" class="MCXref xref">資源規劃工具概觀</a>中的<a href="../../../resource-mgmt/resource-planning/get-started-resource-planner.md#using" class="MCXref xref">使用使用者檢視來檢視可用、計畫和實際時數，或FTE </a>區段</p> </li> 
      </ul> </li> 
