...
「畫布控制面板」是目前正在開發中的功能，可讓您將各種報表型別新增至可自訂的畫布上，輕鬆將Adobe Workfront資料視覺化。 請注意，雖然我們感謝您參與測試階段的工作，但部分功能可能不完整，或無法如期運作。 請依照以下檔案中的指示，提交有關您體驗的任何意見回饋： [提供意見回饋](#provide-feedback) 一節。

如需使用畫布控制面板的基本資訊，請參閱 [開始使用畫布儀表板](/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/get-started-canvas-dashboards.md).
如需所有畫布控制面板檔案的清單，請參閱 [Canvas儀表板概觀](/help/quicksilver/reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md).
...
1. 按一下 **傳送意見** 按鈕，然後在出現的表單中輸入您的意見反應，然後按一下 **提交**.
