...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p><strong>將於下列日期提供：</strong> </p> <p>Beta預覽版： 2020年4月10日</p> <p>生產版本：2020.2版本</p> <p><strong>適用於下列環境：</strong> </p> <p>全新Adobe Workfront體驗（先前僅供任務使用）</p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.2.-release-activity/2020-2-resource-management.md#new2" class="MCXref xref" xrefformat="{para}">工作負載平衡器的新設定方塊</a> </p> <p>為了簡化您的體驗，現在有一個設定方塊可用，顯示其他工具以更新工作負載平衡器中的檢視。 此方塊包含下列設定：</p> 
    <ul> 
     <li>依專案分組</li> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.2.-release-activity/2020-2-resource-management.md#alter" class="MCXref xref" xrefformat="{para}">變更工作負載平衡器中的日期範圍</a> </p> <p>為了進一步幫助您自訂工作負載平衡器的時間軸持續時間以符合您的需求，您現在可以選取一次顯示的2、4或6週的自訂期間。 </p> <p>在此增強功能之前，工作負載平衡器一律顯示從本週開始的資訊。</p> </td> 
   <td> <p>Beta預覽版： 2020年4月10日</p> <p>生產版本：2020.2版本</p> <p><strong>適用於下列環境：</strong> </p> <p>全新Adobe Workfront體驗（先前推出）</p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.2.-release-activity/2020-2-resource-management.md#removing" class="MCXref xref" xrefformat="{para}">從工作負載平衡器移除「測試版」標籤 </a> </p> <p>在2020.2版中，工作負載平衡器將不再處於測試版狀態，您將能夠使用資源平衡器來檢閱和管理您的資源指派和配置。 已在預覽環境中移除「測試版」標籤。 20.2生產版本將進行相同的變更。 如需有關工作負載平衡器的資訊，請參閱 <a href="../../../resource-mgmt/workload-balancer/overview-workload-balancer.md" class="MCXref xref" xrefformat="{para}">工作負載平衡器總覽</a>.</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.2.-release-activity/2020-2-project-enhancements.md#preventi" class="MCXref xref" xrefformat="{para}">在詳細資訊標籤或工作清單中進行變更時防止資料遺失</a> </p> <p>為了防止在您手動儲存變更時，在專案層級更新物件或任務清單中任務的「詳細資訊」頁面上的資訊時遺失資料，現在會顯示一則警告訊息，在您離開之前通知您尚未儲存變更。 在儲存變更之前，只允許訂閱物件或將物件加入您的最愛。</p> </td> 
   <td> <p><strong>將於下列日期提供：</strong> </p> <p>Beta預覽版： 2020年4月22日</p> <p>生產版本：2020.2版本</p> <p><strong>適用於下列環境：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p><strong>將於下列日期提供：</strong> </p> <p>Beta預覽版： 2020年4月1日</p> <p>生產版本：2020.2版本</p> <p><strong>適用於下列環境：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Beta版預覽版：不適用</p> <p>生產版本： 2020年5月9日</p> <p><strong>適用於下列環境：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
