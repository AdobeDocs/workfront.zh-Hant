...
如需詳細資訊，請參閱 [版面配置範本](../../../administration-and-setup/customize-workfront/use-layout-templates/use-layout-templates-customize-ui.md).
...
若要深入瞭解，請參閱 [常見問題集 — 事件訂閱](../../../wf-api/general/event-subs-faq.md) 和 [活動訂閱最佳實務](../../../wf-api/general/event-sub-best-practice.md).
