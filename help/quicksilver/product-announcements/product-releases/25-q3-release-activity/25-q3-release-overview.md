  ...
  <tbody>
    ...
    <tr>
        <td>
            ...
            <p>現有的實際時數欄位已重新命名為舊版實際時數。 此欄位會儲存專案、任務和問題的記錄時間（以分鐘為單位）。 欄位會以actualWorkRequired形式儲存在Workfront資料庫中。 </p>
            <p>我們新增了一個新的實際時數欄位，以時數為單位儲存專案、任務和問題的記錄時間，精確到小數。 欄位會以actualWorkRequiredDouble形式儲存在Workfront資料庫中。</p>
        </td>
        <td>2025年6月24日</td>
        <td>2025年6月24日</td>
        <td>2025年6月24日</td>
