---
title: 2026年第二季報表增強功能
description: 2026年第二季報表增強功能
author: Becky
...
自訂欄位標籤現在顯示在報告建置工具中的欄位名稱和物件之前，可幫助您更輕鬆地找到欄位。 定義清單中的篩選器、檢視和分組時，也會顯示欄位標籤。

自訂欄位標籤適用於系統介面，而欄位名稱常用於API和後端儲存用途，且在尋找欄位時可能沒有這麼實用。
