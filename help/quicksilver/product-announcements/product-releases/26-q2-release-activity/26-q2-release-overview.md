...
* [企業營運增強功能](#enterprise-operations-enhancements)
...
<table>
    ...
    <tr>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">RTF欄位以格式欄位型別取代文字</a><p>自訂表單中的新<b>RTF</b>欄位型別是強大的文字編輯器，除了粗體、斜體、底線、專案符號、編號、超連結和區塊引號等傳統選項外，還有上標和下標、標題和表格等格式選項。 字元限制仍為15,000。</p>
        </td>
...
<table>
   ...
   <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">透過Workfront </a>中的AEM Assets內容警告器，更快發現及重複使用內容<p></p>
            <p>Workfront現在提供「內容建議程式」並與Adobe Experience Manager Assets整合，讓團隊更容易探索及重複使用現有的高價值內容。</p>
        </td>
        <td><p>2026年4月16日</p></td>
        <td><p>2026年4月16日</p></td>
        <td><p>2026年4月16日</p></td>
   ...
   <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">我的核准Widget更新</a><p></p>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">由Workfront和Frame.io提供支援的統一檢閱和核准</a><p></p>
            <p>我們很高興推出由Workfront和Frame.io支援的統一檢閱和核准，這是簡化的檢閱和核准體驗，將規劃、校訂和共同作業整合為單一連線工作流程。
 </p>
        </td>
        <td><p>2026年3月12日</p></td>
        <td><p>2026年4月15日</p></td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">可用於統一核准的多階段核准工作流程</a><p></p>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">設定並使用多階段核准工作流程範本</a><p></p>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront現在提供企業作業功能</a><p></p>
            <p>Adobe Workfront的進階企業作業功能是管理財務、專案和企業存取的統一且可擴充方式。 這些功能提供企業營運獲利及有效率所需的可見度和控制能力。</p><p>這些功能包含下列更新：<ul><li>進階財務管理 — 包括匯率屬性、匯率卡、重新設計的「進階指定」體驗、日期有效匯率以及其他進階功能</li><li>歷史資料追蹤 — 包括專案快照</li><li>企業許可權 — 包括企業檔案，以及存取層級和物件許可權中的個別成本和計費率</li><li>自訂表單和欄位增強功能 — 包括新的進階邏輯型別、貨幣格式欄位的「財務」許可權型別設定、新增自訂表單至更多物件的能力，以及表單設計器介面的增強功能</li><li>版面配置範本增強功能 — 包括自訂更多物件的標題和左側導覽功能表、更新版面配置範本中的主功能表選項以及自訂更多功能表</li><li>自訂本地化 — 包括定義不同語言的自訂辭彙和短語的能力</li><li>Business Rules的增強功能，包括當符合某些條件時，為建立、編輯或修改的物件自動執行動作的功能</li></ul></p>
 </p>
        </td>
        <td><p>2026年4月2日</p></td>
        <td><p>2026年4月15日</p></td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md" class="MCXref xref" xrefformat="{para}">日期有效費率允許的間隔</a><p></p>
            <p>Workfront可讓您在計費和成本費率的日期範圍之間保留差距，但您將會收到警告，確認這是刻意為之。</p>
 </p>
        </td>
        <td><p>2026年4月2日</p></td>
        <td><p>2026年4月15日</p></td>
...
<table>
    ...
    <tr>
        <td>
            檔案版本<a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">的</a>目前版本欄位<p></p>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">已排程的報告傳送現在支援連結電子郵件</a><p></p>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">以畫布儀表板中的特定使用者身分執行報告</a><p></p>
   ...
   <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">新的資料連線驗證選項</a><p></p>
            <p>您現在可以使用RSA金鑰或程式化存取權杖(PAT)連線來驗證資料連線，為傳統使用者名稱/密碼認證新增更安全和彈性的替代方案。 </p>
        </td>
        <td><p>2026年3月12日</p></td>
        <td><p>2026年3月12日</p></td>
        <td><p>2026年4月16日</p></td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-requests.md" class="MCXref xref" xrefformat="{para}">改善要求清單</a>中建立物件的可見性<p></p>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">套用條件式格式至[要求]區域和[我的要求]小工具中提交的要求清單</a><p></p>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">在[要求]區域和[我的要求]介面工具集</a>中，將預先定義的檢視新增到要求清單中<p></p>
            <p>為協助您更妥善地組織請求清單，我們在「請求」區域中將預先定義的檢視新增至請求清單，並在首頁將我的請求Widget新增至首頁。</p>
        </td>
           <td><p>不適用</p><p>預先定義的檢視將沒有預覽版本，並將於4月16日直接發行到生產環境。 </p></td>
        <td><p>2026年4月16日</p></td>
        <td><p>2026年4月16日</p></td>
 </tr>
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">在要求清單與我的要求Widget </a>中建立群組<p></p>
