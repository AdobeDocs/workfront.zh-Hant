   ...
   <tr>
    ...
    <tr>
        <td>
            ...
            <p><span class="preview">在預覽環境中暫時無法使用</span></p>
...
<table style="table-layout:auto">
  <tbody>
   <tr>
       ...
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}">在Workfront中設定AI檢閱者的品牌<p>[!BADGE Off Schedule]{type=Neutral}</p> </a>
            <p>您現在可以在Workfront設定區域中設定AI稽核者的品牌。 這可讓您根據貴組織的品牌指導方針自訂AI檢閱程式。</p>
            <p>AI檢閱者目前處於Beta版。</p>
        </td>
        <td>2026年1月8日</td>
        <td>2026年1月8日</td>
