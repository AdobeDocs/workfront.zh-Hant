...
如需詳細資訊，請參閱[頂端導覽列總覽](../../../workfront-basics/the-new-workfront-experience/global-navigation-overview.md)。
...
如需使用新清單建立時程表的詳細資訊，請參閱[建立單一使用時程表](../../../timesheets/create-and-manage-timesheets/create-tmshts.md)。
