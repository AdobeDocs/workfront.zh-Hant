...
將Workfront Workflow和Workfront Planning連線到任何MCP相容的AI平台，包括Claude、ChatGPT、Copilot、Gemini等，並使用自然語言來尋找、建立、更新和管理Workfront專案，而不會離開您選擇的AI工具。 詢問您逾期的任務、推播專案的完成日期、傳送提醒給核准者、更新行銷活動預算，而您的AI平台會在Workfront中為您工作。
