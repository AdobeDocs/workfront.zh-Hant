...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-admin-enhancements.md#new" class="MCXref xref" xrefformat="{para}">群組管理員的新增：建立和管理任何層級群組的狀態</a> </p> <p>為了更方便組織的所有層級獨立管理和控制其工作流程，我們引進了建立和管理子群組狀態的功能。 </p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-admin-enhancements.md#new2" class="MCXref xref" xrefformat="{para}">管理員的新增：建立付費記錄自訂表單</a> </p> <p>現在您可以建立付費記錄自訂表單，以改善使用者擷取付費資訊的方式。 使用者可以將自訂表單附加至計費記錄、填寫該記錄，然後執行在表單中包含資訊的報告。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年5月20日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#associat" class="MCXref xref" xrefformat="{para}">將範本與群組建立關聯</a> </p> <p>為了協助您簡化專案建立流程，以及協助您更輕鬆地識別和報告哪些群組擁有哪些專案範本，我們新增了將群組指派給專案範本的功能。</p> <p>將群組指派給專案範本時，從範本建立的所有專案都會自動與範本的群組建立關聯。</p> <p>此外，如果範本與您的群組相關聯，則您可以將群組核准流程附加至範本及其範本任務。 </p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本 </p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#easier" class="MCXref xref" xrefformat="{para}">更輕鬆地編輯詳細資訊區段中的欄位</a> </p> <p>各種改良功能可讓您更輕鬆地編輯任何物件「詳細資訊」區段中的資訊。 這些改進包括當游標停留在欄位上時欄位周圍會出現灰色外框，表示該欄位可供編輯，以及按一下欄位即可編輯欄位。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#consider" class="MCXref xref" xrefformat="{para}">計算移交日期時考慮跨專案前置任務</a> </p> <p>隨著Adobe Workfront計算任務移交日期的方式出現新的改進，跨專案相依性現在已納入考量。 </p> <p>以前，移交日期僅根據相同專案中任務的前置任務計算。 </p> <p>現在，為了確保您一律擁有跨專案前置任務之任務的準確移交日期，您必須重新計算後續任務之專案的時間表。 重新計算時間表後，任務的移交日期會考慮任務的跨專案相依性。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#add" class="MCXref xref" xrefformat="{para}">從Scrum展示板新增現有劇本和問題</a> </p> <p>您現在可以直接從Scrum展示板新增現有劇本或問題。 這可讓您更輕鬆地新增現有內文到您目前的反複專案，而不需要移至待處理頁面。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#add2" class="MCXref xref" xrefformat="{para}">從Scrum展示板新增劇本和問題</a> </p> <p>您現在可以直接從Scrum展示板建立新劇本或問題。 這可讓您更輕鬆地將新劇本快速新增至您目前的反複專案。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#delete" class="MCXref xref" xrefformat="{para}">從Kanban面板刪除劇本或問題</a> </p> <p>您現在可以直接從Kanban面板刪除內文或問題，方法是按一下內文或問題卡上的「更多」圖示並選取「刪除」。 當您刪除內文或問題時，內文或問題會移至資源回收筒並保留30天，且只有系統管理員才能復原。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#agile" class="MCXref xref" xrefformat="{para}">敏捷卡片標題和故事板更新</a> </p> <p>在Kanban和Scrum展示板上，現在提供各種增強功能，包括內文卡和展示板欄的固定寬度，將「內文」欄重新命名為「父內文」等等。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年6月3日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#group" class="MCXref xref" xrefformat="{para}">群組專案、任務和問題偏好設定</a> </p> <p>正如我們先前所溝通，我們分階段推出專案、任務和問題偏好設定的群組層級自訂。 直到2021年6月24日為止，生產環境仍適用於所有EMEA客戶和其他所有客戶的子集。 現在所有客戶都能使用它們。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： </p> <p>2020年7月9日（群組的專案偏好設定）</p> <p>2020年12月3日（群組的任務和問題偏好設定）<br></p> <p>生產版本：透過21.3版本（僅適用於有限數量的客戶，2021年6月24日適用於所有客戶）</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#allow" class="MCXref xref" xrefformat="{para}">允許外部使用者核准檔案</a> </p> <p>您現在可以使用外部電子郵件地址，將核准者指派給新Workfront體驗中的檔案。</p> <p>之前，您只能在Workfront Classic中依電子郵件地址新增外部使用者。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年5月20日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#export" class="MCXref xref" xrefformat="{para}">從投資組合或方案的詳細資訊區段匯出資訊</a> </p> <p>您現在可以從Portfolio和Programs的Details區段匯出至.pdf檔案資訊。 在此增強功能之前，您只能從專案、任務和問題匯出詳細資訊區段的資訊。</p> </td> 
   <td> <p><strong>在以下日期可用：</strong> </p> <p>預覽版本： 2021年5月20日<br></p> <p>生產版本： 2021年6月3日</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#added" class="MCXref xref" xrefformat="{para}">在物件的標頭中新增規劃完成日期時間戳記</a> </p> <p>為方便存取、方便及準確，我們新增了選項，以在專案、任務或問題標題的計畫完成日期中選取時間戳記。 </p> <p>在此增強功能之前，當您更新物件的規劃完成日期時，Workfront會選取午夜作為預設時間。 現在，您可以自訂時間以及完成日期。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年5月20日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-project-enhancements.md#add3" class="MCXref xref" xrefformat="{para}">新增自訂表單至物件而不編輯它</a> </p> <p>我們更輕鬆地新增自訂表格，讓其他人可以填寫（或您稍後再填寫）該表格。 新增表單時，表單不再自動進入編輯模式。 您只需將空白表單儲存至物件即可。</p> <p>之前，當您新增自訂表單至物件時，頁面會進入編輯模式，您必須先完成表單上的任何必填欄位，才能將其儲存至物件。 當表單要由其他使用者填寫，或您不知道在表單上要輸入什麼內容時，這會造成不便。</p> </td> 
   <td><strong>在以下日期可用：</strong> <p>預覽版本： 2021年5月20日<br></p> <p>生產版本：第21.3發行版本</p> <p><strong>在以下環境中可用：</strong> </p> <p>全新Adobe Workfront體驗 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.3-release-activity/21-3-proofing-enhancements.md#users" class="MCXref xref" xrefformat="{para}">新增到校訂的使用者會自動被授與檔案的檢視存取權</a> </p> <p>如果使用者以前沒有檢視許可權，則以「檢閱者」或「唯讀」選取為其校訂角色的使用者將被自動授予檔案上的「檢視」存取許可權。</p> <p>先前，具有上述校訂角色的使用者在新增到校訂中時，必須請求對檔案的存取權。</p> </td> 
