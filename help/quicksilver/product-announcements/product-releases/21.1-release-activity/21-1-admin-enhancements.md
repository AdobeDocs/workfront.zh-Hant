...
此功能現在包含在新Workfront體驗第1部分：使用者組織[的Workfront One學習路徑的](https://experienceleague.adobe.com/zh-hant/docs/workfront-learn/tutorials-workfront/home)管理員基礎課程中。
...
此功能現在包含在新Workfront Experience第2部分：專案設定[的Workfront One學習路徑的](https://experienceleague.adobe.com/zh-hant/docs/workfront-learn/tutorials-workfront/home)管理員基礎課程中。
...
如需詳細資訊，請參閱[設定防火牆允許清單](../../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md#configur)一文中的[設定防火牆允許清單](../../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md)一節。
...
如需詳細資訊，請參閱文章[子群組總覽](../../../administration-and-setup/manage-groups/groups-overview/subgroups.md#for)中的[子群組的群組管理員](../../../administration-and-setup/manage-groups/groups-overview/subgroups.md)一節。
