...
如需兩個版本之間差異的詳細資訊，請參閱文章[事件訂閱版本設定](/help/quicksilver/wf-api/general/event-subs-versioning.md)。

如需用於在不同版本之間升級或降級事件訂閱的端點資訊，請參閱文章事件訂閱API中的[事件訂閱版本設定](/help/quicksilver/wf-api/general/event-subs-api.md#event-subscription-versioning)小節。
