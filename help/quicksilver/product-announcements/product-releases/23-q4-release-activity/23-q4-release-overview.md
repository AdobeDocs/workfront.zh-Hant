...
23.10版本網路研討會是在2023年10月5日舉行。 您可以[在此註冊網路研討會，以檢視隨選錄影](https://webinars.on24.com/adobe_workfront/whatsnewin2310?partnerref=releasenotes)。

<span class="preview">週期外功能（在2023年第四季發行日期之前發佈到生產環境的功能）會以黃色標示。</span>

>[!IMPORTANT]
>
>23.3版本包含將您的組織移至每月版本的選項。 因此，Workfront正在變更版本的編號方案，以兼顧每月和每季的發行追蹤。
>
>* 如果您使用&#x200B;**快速發行（每月）**&#x200B;路線，23.3之後的發行是&#x200B;**23.8**，於2023年8月31日。
>* 如果您在&#x200B;**每季**&#x200B;發行追蹤，23.3之後的發行是&#x200B;**23.10**，在2023年10月26日當週。
> 
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-admin-enhancements.md" class="MCXref xref" xrefformat="{para}">舊版授權模型客戶可用的校訂和檔案決策</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>自訂表單設計工具現在提供新的欄位型別<strong>外部查詢</strong>。 當資料儲存在外部系統時，此欄位型別可讓您從外部API載入選項，並根據自訂表單中的其他欄位值進行篩選。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-boards-enhancements.md" class="MCXref xref" xrefformat="{para}">增強在展示板和卡片上的使用者指派</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p><p>現在提供增強功能，可新增彈性將使用者新增到Adobe Workfront面板中的面板和卡片。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p><span class="preview">所有客戶的生產： 2023年8月24日</span>
                            </li> 
                       </ul>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-boards-enhancements.md" class="MCXref xref" xrefformat="{para}">在已連線的卡片上新增檔案</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p><p>您現在可以在Adobe Workfront展示板上所連線的卡片上附加檔案。 您新增到卡片上的任何檔案都可在已連線任務或問題的檔案索引標籤上使用，且兩個區域都支援相同的檔案型別。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-boards-enhancements.md" class="MCXref xref" xrefformat="{para}">專案的面板檢視現在可用於問題</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p><p>您現在可以存取專案問題清單的展示板檢視。 Kanban展示板可協助您以比在清單中檢視更直觀的方式追蹤問題進度。 </p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-financial-mgmt-enhancements.md" class="MCXref xref" xrefformat="{para}">日期有效成本與收費率</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-home-enhancements.md" class="MCXref xref" xrefformat="{para}">新貢獻者預設登陸頁面：新首頁</a>  </p><p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-home-enhancements.md" class="MCXref xref" xrefformat="{para}">新首頁</a>中的工作追蹤變更 </p>
                        <p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        新首頁的<a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-home-enhancements.md" class="MCXref xref" xrefformat="{para}">自訂術語支援</a> </p><p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        已針對已停用[新首頁]的帳戶<a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-home-enhancements.md" class="MCXref xref" xrefformat="{para}">移除[嘗試新首頁]按鈕</a> </p>
                        <p>[!BADGE In Production &#x200B;]{type=Informative}</p>
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">傳送檔案至SharePoint (GraphAPI)時體驗的增強功能</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p><p>我們已進行一些變更，以便在傳送檔案至您的SharePoint (GraphAPI)資料夾時更容易找到資料夾</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-project-enhancements.md" class="MCXref xref" xrefformat="{para}">工作清單即時更新</a> </p>
                        <p>[!BADGE In Production]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-project-enhancements.md" class="MCXref xref" xrefformat="{para}">將新問題新增至專案時更新設計</a> </p>
                        <p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                        <p>此更新已在23.3版本中公告。</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-project-enhancements.md" class="MCXref xref" xrefformat="{para}">表單</a>上計算欄位的動態重新計算</p>
                        <p>[!BADGE In Production &#x200B;]{type=Informative}</p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-other-enhancements.md" class="MCXref xref" xrefformat="{para}">貢獻者主功能表變更</a> </p><p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/betas/canvas-dashboards-beta/canvas-dashboards-release-activity.md" class="MCXref xref" xrefformat="{para}">新畫布控制面板Beta版增強功能</a> </p>
                        <p>[!BADGE In Production &#x200B;]{type=Informative}</p>
                ...
                <tr>
                    <td>
                        在2023年第四季時間範圍內<a href="/help/quicksilver/product-announcements/product-releases/23-q4-release-activity/23-q4-look-and-feel-updates.md" class="MCXref xref" xrefformat="{para}">外觀和感覺更新</a></p><p>[!BADGE In Production &#x200B;]{type=Informative}</p><p>在2023年第四季時間範圍內，對Adobe Workfront應用程式的各個區域外觀和感覺進行了小幅更新。 檢閱特定發行日期的個別發行說明。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
...
Workfront Fusion中的新功能可在2023年第四季發行排程之外的步調中推出。 如需最新功能的詳細資訊，請參閱[Adobe Workfront Fusion發行活動](https://experienceleague.adobe.com/zh-hant/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)。
