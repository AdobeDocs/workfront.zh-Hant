...
>[!NOTE]
>
>預覽： 2026年1月15日>生產快版本： 2026年1月15日>所有人生產： 2026年1月15日>[!BADGE 排程中斷]{type=Neutral}
...
>[!NOTE]
>
>預覽： 2025年12月23日>生產快速發行： 2026年1月14日>每個人的生產： 2026年1月15日

您現在可以在記錄或物件型別之間定義彈性但結構化的階層。

階層是記錄型別之間的連線。 您最多可以在一個階層中連線4個記錄和物件型別，在一個工作區中最多可以有5個階層。 階層中的第一個記錄型別是第一個父系。

您可以使用階層來組織工作，並視覺化策略如何流入執行。

建立階層時，請考量下列事項：

* 您只能從階層中的一個工作區和Workfront專案連線Planning記錄型別。
* 在同一工作區中，記錄型別或專案只能有一個父系。
* 記錄型別可以是多個階層中的父項。
* 可連線的記錄型別不能用於工作區內不屬於其本身的工作區的階層中。
* 全域記錄型別只能在其建立或加入的工作區中，用於階層中。
...
記錄階層連結反映其在階層中的位置。 建立階層後，您可以在記錄頁面頂端看到記錄的階層連結，指出有哪些其他父物件或子物件連線到記錄。 Workfront和Planning的階層一致。

例如，當專案連線至其Planning階層連結中的Planning記錄型別時，您可以檢視專案的Planning階層，而當專案連線至Workfront中的Workfront物件型別（例如投資組合或方案）時，您可以檢視專案的Workfront階層。
...
>[!NOTE]
>
>預覽： 2025年12月19日>生產快速： 2026年1月14日>每個人的生產： 2026年1月15日

為了讓您在使用連線的記錄頁面時擁有更多彈性，我們在Workfront Planning的這個區域增強了檢視功能。 記錄的已連線記錄頁面中的改良專案如下：

* 您現在可以將時間軸和行事曆檢視新增到記錄的已連線記錄頁面。
* 您現在可以從連線的記錄頁面共用所有檢視。 在Workfront Planning的任何其他區域中，與您共用這些頁面的使用者可在系統範圍內看見這些頁面共用的檢視。 在Planning的任何其他區域共用的所有檢視也會顯示在與其共用之相同使用者的連線記錄頁面中。
* 我們已新增限制，每個記錄或物件型別僅允許一個連線記錄頁面。 在此增強功能之前，您可以為相同的記錄或物件型別新增多個頁面。 現在，您可以在一個連線的記錄頁面中，針對相同的記錄型別使用多個檢視。
* 我們在表格檢視的底部新增了&#x200B;**新列**&#x200B;連結，並在連線記錄頁面的右上角區域新增了&#x200B;**連線記錄**&#x200B;按鈕。 在此增強功能之前，**新列**&#x200B;連結和&#x200B;**連線記錄**&#x200B;按鈕只存在於已連線的專案頁面上。
...
>[!NOTE]
>
>預覽： 2025年12月18日>生產快速： 2026年1月14日>每個人的生產： 2026年1月15日
...
>[!NOTE]
>
>預覽： 2025年12月11日>生產快發行： 2025年12月11日>所有人生產： 2025年12月11日>[!BADGE 排程中斷]{type=Neutral}
...
>[!NOTE]
>
>預覽： 2025年12月3日>生產快速發佈： 2025年12月4日>每個人都要生產： 2026年1月15日
...
>[!NOTE]
>
>預覽： 2025年11月6日>生產快速發行： 2025年12月11日>每個人的生產： 2026年1月15日
...
>[!NOTE]
>
>預覽： 2025年10月16日>生產快速發行： 2025年11月13日>每個人的生產： 2026年1月15日
