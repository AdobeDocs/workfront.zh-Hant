...
>[!NOTE]
>
>所有客戶的預覽和生產： 2026年6月30日
>[!BADGE 不在排程]{type=Neutral}內

Planning中的全域搜尋方塊現在會記住您最近的搜尋：最近7個瀏覽過的工作區、記錄型別和檢視會顯示在標籤明確的專用區段中，因此您可以快速存取它們，而不需要重新執行查詢。

最近的結果會考慮目前的許可權，而且最近專案的清單與即時搜尋結果在視覺上是不同的。 和之前一樣，您可以使用鍵盤組合從Planning登陸頁面或任何頁面存取搜尋。

如需詳細資訊，請參閱[Workspace概觀](/help/quicksilver/planning/architecture/workspaces-overview.md)。
...
>[!NOTE]
>
>所有客戶的預覽和生產： 2026年6月5日
>僅適用於也擁有Adobe GenStudio for Performance Marketing的Adobe Workfront Planning客戶。
>[!BADGE 不在排程]{type=Neutral}內
...
>[!NOTE]
>
>從範本套件組合建立工作區僅適用於工作流程Prime或Ultimate套件上的組織。
...
>[!NOTE]
>
>每個人都能預覽和生產： 2026年5月28日
>僅適用於同時擁有Adobe GenStudio for Performance Marketing和Adobe Experience Manager的Adobe Workfront Planning客戶。
>[!BADGE 不在排程]{type=Neutral}內
...
>
>所有客戶的預覽和生產： 2026年5月14日
>僅適用於也擁有Adobe Experience Manager的Adobe Workfront Planning客戶。
>[!BADGE 不在排程]{type=Neutral}內
