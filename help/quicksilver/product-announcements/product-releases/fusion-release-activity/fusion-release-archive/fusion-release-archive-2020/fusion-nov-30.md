...
title: '''Workfront Fusion發行活動：《2020年11月30日周》'
description: 本頁說明2020年11月30日當周在Adobe Workfront Fusion中所做的所有增強功能。
author: Luke
...
# Workfront Fusion發行活動： 2020年11月30日起第一週

本頁說明2020年11月30日當周在Adobe Workfront Fusion中所做的所有增強功能。
...
我們已推出Workfront Fusion 2.0的全新效能護欄。現在，Webhook的速率限制為每秒100個請求。 達到此限制時，Workfront Fusion 2.0會傳送429（請求過多）狀態。

過去，網頁連結請求不受限。

如需詳細資訊，請參閱 [Adobe Workfront融合效能護欄](../../../../../workfront-fusion/get-started/fusion-performance-guardrails.md).

## 在Workfront Fusion 2.0中將自訂表單新增至Workfront物件

為了讓您將自訂表單新增至物件，Workfront Fusion 2.0已將AssignCategories動作新增至Workfront > Misc。 動作模組。

之前，您無法使用Workfront Fusion 2.0模組將自訂表單新增至Workfront中的物件。

有關Workfront >雜項的詳細資訊。 動作模組，請參閱 [Adobe Workfront模組](../../../../../workfront-fusion/apps-and-their-modules/workfront-modules.md).
