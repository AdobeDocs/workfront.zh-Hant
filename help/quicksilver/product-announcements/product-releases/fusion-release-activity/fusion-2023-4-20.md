...
## Chrome線上應用程式商店現已提供全新Fusion DevTool

最新版本的DevTool瀏覽器擴充功能現可從Chrome線上應用程式商店取得。 您可以將DevTool新增到Chrome瀏覽器，而無需下載和安裝，現在對DevTool進行任何變更時，擴充功能會自動更新。 您也可以安心瞭解Chrome線上應用程式商店已驗證DevTool。

之前，使用者必須下載並安裝DevTool。

如需詳細資訊，請參閱 [使用對案例進行偵錯 [!DNL Adobe Workfront Fusion] DevTool](../../../workfront-fusion/scenarios/debug-scenarios-with-dev-tool.md).
...
如需詳細資訊，請參閱 [可投放模組](../../../workfront-fusion/apps-and-their-modules/airtable-modules.md)
...
如需詳細資訊，請參閱 [HTTP >[!UICONTROL 提出API金鑰授權請求]](/help/quicksilver/workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-api-key-auth-request.md)
