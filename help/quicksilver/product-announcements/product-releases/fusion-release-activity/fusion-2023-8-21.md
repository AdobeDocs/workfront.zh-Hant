...
如需Workfront >觀看活動模組中的活動訂閱詳細資訊，請參閱 [!DNL Workfront] > [!UICONTROL 觀看活動]模組](/help/quicksilver/workfront-fusion/apps-and-their-modules/workfront-modules.md#event-subscription-filters-in-the-workfront--watch-events-modules)中的[活動訂閱篩選器
