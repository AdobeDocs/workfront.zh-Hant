...
如需新體驗與舊體驗不同之處的資訊，請參閱[在Workfront Fusion中瀏覽新體驗](/help/quicksilver/workfront-fusion/get-started/new-fusion-ui.md)。
...
如需有關Fusion Dev工具的詳細資訊，請參閱[使用 [!DNL Adobe Workfront Fusion] Devtool](/help/quicksilver/workfront-fusion/scenarios/debug-scenarios-with-dev-tool.md)偵錯案例。
