...
title: 2019.3版本活動概覽
description: 本頁提供2019.3版所含功能的相關資訊。 此頁面上的功能已在2019年8月19日當週的生產環境中提供。 如需發行日期與時間的特定說明，請參閱Workfront信任網站。
author: Luke
...
* [開啟篩選器現在會在問題清單中顯示更多結果](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#changes)
  ...
  當您將「開啟」篩選套用至問題清單時，該清單包括處於「已關閉 — 未決核准」狀態或與解決物件關聯的問題。
  ...
  * <MadCap:conditionalText data-mc-conditions="OnlineOrPDF.OnlineOnly">  <a href="../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#new" class="MCXref xref" xrefformat="{para}">New experience when inline editing information in lists</a> </MadCap:conditionalText><MadCap:conditionalText data-mc-conditions="OnlineOrPDF.PrintOnly">  <a href="https://experience.workfront.com/s/article/2019-3-Project-enhancements-1332102832" target="_blank" data-mc-conditions="QuicksilverOrClassic.Draft mode">New experience when inline editing information in lists</a> </MadCap:conditionalText>
  ...
  當您內聯新清單中的編輯資訊時，已編輯的列將會變暗，但資訊將保持可見。
...
* [建立已編列預算時數的報表](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#build)
...
* [隱藏資源規劃工具中實際時數欄的新設定](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#new2)
  ...
  您現在可以在「資源規劃工具」中依使用者檢視資訊時，顯示或隱藏「實際時數」欄。
...
* [資源集區會持續保留在業務案例的資源預算區域中](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#resource)
  ...
  現在，當您在Business Case的「資源預算」區域中預算資源時，當您離開頁面並返回時，您已在專案中儲存的「資源集區」是永久性的。
...
* [對成本費率的財務資料存取會影響資源規劃工具中依成本顯示的資訊](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#financia)
  ...
  Workfront管理員現在可以確定哪些使用者有權在資源規劃工具中檢視或編輯角色、使用者或專案的成本資訊。
...
* [所有Workfront登入都需要網域規格](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#domain)
  ...
  如果網域尚未在Workfront URL中指定，則所有Workfront登入現在都會要求使用者指定網域。 要求提供此資訊可讓您的Workfront執行個體更安全。

* 適用於Blackberry Marketplace的Workfront行動應用程式（即將推出）

  Workfront行動應用程式即將在Blackberry Dynamics for Blackberry Marketplace發行。
...
* [使用指紋或面容ID登入行動應用程式](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#log)
  ...
  根據您的裝置，您可以選擇使用指紋或面容ID技術登入Workfront行動應用程式。

* [自動將使用者登出行動裝置的新設定](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#new2)
  ...
  為了讓您和您的公司更安全，Workfront行動應用程式8分鐘非使用狀態後會自動將使用者登出。

* [依行動應用程式中失效的專案篩選](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#filter) [依行動應用程式中失效的專案篩選](https://experience.workfront.com/s/article/2019-3-Integration-and-mobile-enhancements-1150184880)

  我們已在行動應用程式的「專案」索引標籤上新增「無法使用專案」作為篩選選項。
...
* [在iOS上使用行動應用程式刪除物件](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#delete)
  ...
  您現在可以刪除行動應用程式中的任務、問題和時程表等物件。 您必須擁有物件的正確許可權才能刪除它。
...
* [首頁外觀的更新](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-home-enhancements.md#new3)
...
本節說明在2019.3發行時間範圍內所做的變更，這些變更將會在2019.3年一般版本之前發行至生產環境。
...
* [變更自訂表單中欄位的顯示型別](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#change)
  ...
  例如，如果您已建立「核取方塊」欄位，您可以將其變更為「下拉式清單」欄位或「選項按鈕」欄位。 這三種欄位顯示型別可以互換。
...
* [建立休假行事曆和報告](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#create)
  ...
  您現在可以看到使用者的休假時間，以便進行更好的規劃和執行。 您也可以將新的休假報告和行事曆新增到您的儀表板，以即時檢視使用者可用性。
...
現在，當您在檔案上進行註解時，檔案與附加檔案的物件的「更新」標籤上都會顯示您的更新。
...
當您將使用者指派給任務或問題時，如果所選使用者在任務或問題的計畫日期之間的任何時間都安排了休假，您現在可以看到內聯警告。
...
我們已在自訂表單產生器中建立名為Typeahead的新欄位型別。 此欄位可讓您將代表物件的欄位新增到自訂表單。
...
全新的Workfront體驗除了提供新功能外，還提供全新現代的設計。
...
對API第3版的支援已於2018年11月終止。 如需Workfront API版本支援排程的詳細資訊，請參閱 [API版本設定和支援排程](../../../../wf-api/api/api-version-support-schedule.md)
...
進一步瞭解此期間將推出的功能 [第3季藍圖網路研討會](https://event.on24.com/eventRegistration/EventLobbyServlet?target=reg20.jsp&amp;partnerref=Product&amp;eventid=2040896&amp;sessionid=1&amp;key=EFBB434E2FDF446E010DA62D1C27E9E5&amp;regTag=&amp;sourcepage=register) 8月1日上午9:00。 最低
