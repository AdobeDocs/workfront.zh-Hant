...
title: 2019.3版本活動概覽
description: 本頁提供2019.3版所含功能的相關資訊。 此頁面上的功能已在2019年8月19日當週的生產環境中提供。 如需特定日期和時間說明發行時間，請參閱Workfront信任網站。
author: Luke
...
本頁提供2019.3版所含功能的相關資訊。 此頁面上的功能已在2019年8月19日當週的生產環境中提供。
...
* [開啟篩選器現在會在問題清單中顯示更多結果](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#changes)
  ...
  當您套用開啟篩選器至問題清單時，該清單包括處於「已關閉 — 未決核准」狀態或與解決物件關聯的問題。
  ...
  * <MadCap:conditionalText data-mc-conditions="OnlineOrPDF.OnlineOnly">  <a href="../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#new" class="MCXref xref" xrefformat="{para}">New experience when inline editing information in lists</a> </MadCap:conditionalText><MadCap:conditionalText data-mc-conditions="OnlineOrPDF.PrintOnly">  <a href="https://experience.workfront.com/s/article/2019-3-Project-enhancements-1332102832" target="_blank" data-mc-conditions="QuicksilverOrClassic.Draft mode">New experience when inline editing information in lists</a> </MadCap:conditionalText>
  ...
  當您在新清單中內聯編輯資訊時，已編輯的列將會變暗，但資訊將保持可見。

* [編輯甘特圖而不啟用特殊編輯模式](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#edit)
  ...
  現在當啟用或未啟用自動儲存時，您可以編輯工作清單甘特圖。

* [更新專案、任務和問題時數標籤的清單](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#updated2)
  ...
  改善的清單檢視現在可用於專案、任務和問題的小時索引標籤。

### 資源規劃增強功能

* [建立預算時數的報表](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#build)
...
* [隱藏資源規劃工具中實際時數欄的新設定](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#new2)
...
* [資源集區會持續保留在業務案例的資源預算區域中](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#resource)
...
* [對成本費率的財務資料存取會影響資源規劃工具中依成本顯示的資訊](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#financia)
  ...
  Workfront管理員現在可以確定哪些使用者有權檢視或編輯資源規劃工具中角色、使用者或專案的成本資訊。

### 整合與行動裝置增強功能

* [在MS OneDrive整合中支援共用專案](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#support)
  ...
  現在您可以將共用的OneDrive檔案和資料夾連結至Workfront物件。

* [所有Workfront登入都需要網域規格](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#domain)
  ...
  如果Workfront URL中未指定網域，則所有Workfront登入現在都會要求使用者指定網域。 要求提供此資訊可讓您的Workfront執行個體更安全。

* 適用於Blackberry Marketplace的Workfront行動應用程式（即將推出未來版本）

  Blackberry Marketplace適用的Blackberry Dynamics未來將推出Workfront行動應用程式。

* [在iOS上使用行動應用程式將任務和問題轉換為專案](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#convert)
  ...
  您現在可以在Workfront行動應用程式中將個別任務和問題轉換為專案。

* [使用指紋或面容ID登入行動應用程式](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#log)
  ...
  視您的裝置而定，您可以選擇使用指紋或面容ID技術登入Workfront行動應用程式。

* [新設定，可自動將使用者從行動裝置登出](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#new2)
...
我們已新增數項外觀和感覺改善，以增強您在Workfront行動應用程式中的體驗。

### 首頁增強功能

* [更新首頁的外觀與風格](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-home-enhancements.md#new3)
...
本節說明在2019.3版本時間範圍內所做的變更，這些變更將會在2019.3年一般版本之前發佈至生產環境。

* [變更自訂表單中欄位的顯示型別](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#change)
...
* [建立休假行事曆和報告](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#create)
...
現在，當您在檔案上加上註解時，您的更新會顯示在檔案及附加檔案的物件的「更新」標籤上。
...
我們已在自訂表單產生器中建立一個名為「自動提示」的新欄位型別。 此欄位可讓您將代表物件的欄位新增至自訂表單。
