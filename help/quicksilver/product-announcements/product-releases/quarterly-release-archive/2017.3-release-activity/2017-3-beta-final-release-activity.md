...
2017.3測試版最終版本包含適用於Workfront管理員和其他使用者的增強功能：
...
如需有關使用新「首頁」區域的詳細資訊，請參閱 [使用首頁區域](../../../../workfront-basics/using-home/using-the-home-area/use-the-home-area.md).
...
* 設定待處理專案上的專案，以便在其他專案移至等同於完成的狀態時，自動新增到看板敏捷故事板中。
  ...
  如需詳細資訊，請參閱 [設定劇本以從待處理專案自動新增](../../../../agile/get-started-with-agile-in-workfront/configure-kanban.md#configur5) 在 [設定Kanban](../../../../agile/get-started-with-agile-in-workfront/configure-kanban.md).

* 設定要在Kanban敏捷故事板上顯示的進行中工作(WIP)限制。

  如需詳細資訊，請參閱 [設定進行中的工作(WIP)限制](../../../../agile/get-started-with-agile-in-workfront/configure-kanban.md#configur4) 在 [設定Kanban](../../../../agile/get-started-with-agile-in-workfront/configure-kanban.md).
...
* 包括敏捷團隊待處理專案上的問題。
  ...
  如需詳細資訊，請參閱 [設定將工作專案新增至疊代時日期的套用方式](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur5) 在 [設定Scrum](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md).
...
如需為敏捷團隊啟用和設定Kanban的詳細資訊，請參閱 [決定敏捷方法](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md#deciding) 在 [建立敏捷團隊](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md).
...
如需啟用問題以供敏捷Scrum團隊待處理專案使用的相關資訊，請參閱  [設定將工作專案新增至疊代時日期的套用方式](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur5) 在 [設定Scrum](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md).
...
如需詳細資訊，請參閱 [在敏捷故事板上設定狀態列](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur2) 在 [設定Scrum](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md).
...
套用至更新串流中評論的格式也會顯示在更新電子郵件通知中。 若要進一步瞭解格式化註解，請參閱 [更新工作](../../../../workfront-basics/updating-work-items-and-viewing-updates/update-work.md).

## 預覽環境中傳回增強的@Tagging功能 {#enhanced-tagging-functionality-returns-in-the-preview-environment}

您可以再次使用@符號，在「預覽」環境中所有物件的「更新流」中標籤其他使用者。 在過去@tagging會將標籤使用者的名字和姓氏放在更新流中。 現在，增強的@tagging功能只會顯示使用者的名字。 若要進一步瞭解如何在更新中標籤使用者，請參閱 [標籤其他人的更新](../../../../workfront-basics/updating-work-items-and-viewing-updates/tag-others-on-updates.md).
...
>[!NOTE]
>
>此功能在Beta版最終發行後的修補程式中發行。

現在，當執行「使用率」報告時，系統會提示您在執行報告之前套用篩選器。 此變更可確保儘快在「使用率」報告中產生最相關的資訊。

如需有關執行「使用率」報表的詳細資訊，請參閱 [資源使用率報表概要](../../../../reports-and-dashboards/reports/using-built-in-reports/resource-utilization-report.md) 在 [資源使用率報表概要](../../../../reports-and-dashboards/reports/using-built-in-reports/resource-utilization-report.md).
...
* [請求檔案](../../../../documents/adding-documents-to-workfront/request-a-document.md)
...
>[!NOTE]
>
>此功能僅適用於新校訂（在2017.3版之後建立的校訂），且僅適用於與Workfront Proof Premium帳戶整合的Workfront執行個體。

在此變更之前，您只能透過建立連結，然後與使用者共用該連結來共用。 

如需詳細資訊，請參閱 [在Adobe Workfront中共用校訂](../../../../review-and-approve-work/proofing/managing-proofs-within-workfront/share-a-proof-in-workfront.md) 在 [在Adobe Workfront中共用校訂](../../../../review-and-approve-work/proofing/managing-proofs-within-workfront/share-a-proof-in-workfront.md).
...
如需有關可用鍵盤快速鍵的詳細資訊，請參閱 [Workfront校訂檢視器中的鍵盤快速鍵](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/keyboard-shortcuts.md).
...
* 在測量工具中指定自訂值
* 在Workfront Proof的校訂檢視器中為校訂內的文字加上註解時，您可以包含用來指示文字應該以粗體、斜體和底線加註的選項。
...
如需有關在甘特圖中設定選項的詳細資訊，請參閱 [設定資訊在甘特圖上的顯示方式](../../../../manage-work/gantt-chart/use-the-gantt-chart/configure-info-on-gantt-chart.md). 
...
在此變更之前，此欄位中沒有搜尋欄位 **選取父系** 步驟，且任務的階層在任務清單中不可見。
...
如需有關從Slack存取Workfront的詳細資訊，請參閱 [透過Slack使用Workfront。](https://support.workfront.com/hc/en-us/sections/115000458033)
...
* 在轉換為任務、問題或請求的原始電子郵件中保留Workfront物件的連結：當您從Outlook 365轉換電子郵件至任務、問題或請求時，Outlook 365會保留從原始電子郵件中轉換至任務或問題的連結。 在此變更之前，Outlook中不會指出電子郵件是否已轉換為任務或提交為請求。 
  ...
  如需有關將電子郵件從Outlook 365轉換為任務或問題的詳細資訊，請參閱 [將Outlook電子郵件作為任務或問題新增至專案](../../../../workfront-integrations-and-apps/using-workfront-with-outlook/add-outlook-email-to-project-as-task-or-issue.md).
...
如需Workfront API變更清單，請參閱 [API第8版的更新](../../../../wf-api/api/new-api-version-8-updates.md).

### 已移除和已棄用的API版本 {#removed-and-deprecated-versions-of-the-api}

### 更新活動訂閱的訊息格式

為了提供您整合的更多實用資訊(包括Workfront事件訂閱API)，我們已包含與支援資源關聯的舊值和新值，以變更這些資源的傳出訊息格式。 為避免失敗，您需要將使用Workfront事件訂閱API的任何整合更新為新格式，如中所述 [事件訂閱API](../../../../wf-api/general/event-subs-api.md).

### 無法傳遞訊息的事件訂閱重試 {#event-subscription-retries-for-undeliverable-messages}

Workfront事件訂閱架構現在提供機制，可處理無法傳送至客戶端點的事件觸發傳出訊息。 為確保訊息持續傳遞，客戶應確保正確設定任何使用事件訂閱傳出訊息的端點。 如需詳細資訊，請參閱 [事件訂閱重試次數](../../../../wf-api/api/event-sub-retries.md).
