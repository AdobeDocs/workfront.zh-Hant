...
* [新Portfolio Optimizer](#new-portfolio-optimizer)
...
如需詳細資訊，請參閱[在Workfront Proof中產生校樣](../../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/generate-proofs.md)。
...
任何包含文字的檔案型別（例如PDF、DOC等）皆支援此功能。 不支援影像檔案。
...
## 全新Portfolio Optimizer {#new-portfolio-optimizer}

Workfront的Portfolio Optimizer區域現在已更新為新外觀。 功能未變更。
