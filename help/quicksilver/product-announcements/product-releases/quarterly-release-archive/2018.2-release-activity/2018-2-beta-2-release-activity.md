...
* [在Portfolio Optimizer中使用預算成本來計算Portfolio財務](#use-budgeted-cost-in-the-portfolio-optimizer-to-calculate-portfolio-finances)
...
如需詳細資訊，請參閱文章[更新或編輯首頁區域的工作專案](../../../../workfront-basics/using-home/using-the-home-area/update-and-edit-work-item-home.md)中的[更新或編輯首頁區域的工作專案](../../../../workfront-basics/using-home/using-the-home-area/update-and-edit-work-item-home.md)。
...
## 使用Portfolio Optimizer中的預算成本來計算Portfolio財務 {#use-budgeted-cost-in-the-portfolio-optimizer-to-calculate-portfolio-finances}

新的Portfolio Optimizer現在會使用業務案例之新資源預算區域或資源規劃工具的預算成本來計算下列欄位：

* 淨值
* 投資報酬率(ROI)
* 成本

之前，新版和舊版Portfolio Optimizer都使用舊版預算成本。 舊版Portfolio Optimizer仍會使用舊版預算成本來計算淨值、投資報酬率和成本。

我們也在Portfolio財務欄位中新增了兩個欄位：舊版ROI和舊版淨值，以便從新的資源管理工具中擷取新值。

如需詳細資訊，請參閱文章[Portfolio Optimizer概觀](../../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md)中的[Portfolio Optimizer概觀](../../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md)。
