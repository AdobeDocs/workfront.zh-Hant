...
此頁面說明22.1版本對預覽環境提出的所有要求增強功能。 這些增強功能將在生產環境中提供
...
為了改善使用者處理請求的體驗，我們引進了介面改進，向登入使用者指出他們無權建立請求。 經過這項改善後，沒有許可權建立問題的使用者的新請求按鈕將變暗。 將滑鼠懸停在變暗的按鈕上會顯示工具提示，說明Workfront管理員已限制目前使用者建立請求的存取權。
...
為了最佳化您提交請求的流程，我們推出新功能，可讓您複製現有請求，並將其提交為新請求。 如果您經常提交類似的請求，這會很有幫助。 在這種情況下，您可以重複使用現有請求，進行一些變更，然後將其作為新請求提交。

透過這項變更，可以檢視其他提交之請求的使用者也可以複製這些請求，並將其作為新請求提交。 您可以更新請求佇列專案中的下列設定，以防止此情況發生：來自相同公司的人員將繼承所有請求的相同許可權。
...
>[!NOTE]
>
>此功能已於2021年11月12日暫時從預覽環境中移除。 稍後將重新新增。
