...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-admin-enhancements.md" class="MCXref xref" xrefformat="{para}">顯示邏輯，並略過表單設計工具Beta版中顯示的邏輯指標和規則</a></p>
                        <p>表單設計工具公開測試版已於2023年7月21日在預覽和生產中重新啟用。 此外，您現在可以在表單設計工具中，檢視在舊版自訂表單中建立的現有邏輯規則。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>專案的敏捷檢視現在包含額外的功能，以便篩選、分組和排序看板中的工作。 新的彈性檢視設計包含強大的搜尋功能，並可直接從展示板將新任務新增至專案。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">面板電子郵件通知和偏好設定</a></p>
                        <p>Adobe Workfront面板現在提供電子郵件通知。 通知預設為開啟，您可以在偏好設定中選取要接收哪些電子郵件。 當您新增至展示板及指派卡片給您時，將會收到電子郵件。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>檔案核准正在分階段重新設計，將在每個版本提供給更多使用者使用。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        ...
                        <p>已從專案、任務和問題的更多選單中提取「共用」選項，以讓共用更直覺。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
...
<table>
            ...
            <tr>
                    <td>
                        ...
                        <p>為了讓所有型別的使用者都能更妥善地利用Workfront來滿足其特定需求，首頁收到重大更新！ 新首頁體驗提供首頁的視覺效果和內容自訂功能，讓您有彈性只顯示與工作最相關的資訊。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>在23.3版發佈至生產環境後不久，以下物件將可使用新的評論體驗：範本任務、範本、時程表、團隊、使用者、計畫、投資組合。</p>
                    </td>
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p>快速發行客戶的生產版本：將在23.3生產版本之後宣佈 </p>
                                <p>適用於所有客戶的生產版本：第23.10版本（2023年10月）</p>
                            </li>
                        </ul>
                    </td>
                 </tr>                
                 ...
                 <tr>
                    ...
                    <td><p><b>將於下列日期提供：</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">生產版本：搭配23.3版（除非另有指定）</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
...
Workfront Fusion中的新功能可在23.3發行排程之外的步調中用於生產環境。 如需最新功能的詳細資訊，請參閱[Adobe Workfront Fusion發行活動](https://experienceleague.adobe.com/zh-hant/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)。
