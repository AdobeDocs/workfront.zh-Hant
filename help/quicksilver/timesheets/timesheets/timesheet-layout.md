...
您可以在時程表上發表意見，與您的時程表核准者或其他使用者在左側面板的更新區段中溝通。

在時程表上所做的任何評論都會顯示在時程表底部的此區域中。 此區域顯示在時程表下方和時程表頁尾的上方。 如需詳細資訊，請參閱 [檢視和管理時程表上的註解](../create-and-manage-timesheets/view-and-manage-comments-timesheets.md).
