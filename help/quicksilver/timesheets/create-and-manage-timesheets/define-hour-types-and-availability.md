...
1. 移至您要判斷小時型別可用性的專案。
1. 按一下標題中專案名稱旁的&#x200B;**更多**&#x200B;功能表，然後按一下&#x200B;**編輯**。
**編輯專案**&#x200B;方塊開啟。
...
1. 選取&#x200B;**否**&#x200B;讓專案可用的所有特定專案小時型別。
   ...
   選取&#x200B;**是**，讓專案上只能使用專案特定時數型別的子集，然後選取您想讓可用的時數型別。
   ...
   >   
   >   * 如果您選取&#x200B;**是**，但未選取任何小時型別，專案只會顯示一般小時型別。
   >
...
1. 按一下Adobe Workfront右上角的&#x200B;**主要功能表**&#x200B;圖示![](assets/main-menu-icon.png)，然後按一下左上角的使用者頭像

   或

   按一下右上角的&#x200B;**主要功能表**&#x200B;圖示![](assets/adobe-main-menu.png) （如果有的話），然後按一下&#x200B;**Workfront設定檔**。
...
1. 按一下「**儲存變更**」。
   ...
   現在，當您在專案、任務或問題上記錄時數時，如果您在專案層級提供了您選取的相同時數型別，則這些小時型別可供使用。
