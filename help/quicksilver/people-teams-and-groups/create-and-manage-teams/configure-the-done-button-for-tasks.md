...
* 如果使用者擁有指派的主團隊、[!DNL Workfront]管理員或具有[!UICONTROL Standard]或[!UICONTROL Plan]授權的使用者，可以設定[!UICONTROL Done]按鈕以反映團隊成員的特定狀態。 請參閱本文中的[設定團隊](#configure-the-uicontrol-done-button-for-a-team)的[!UICONTROL 完成]按鈕。
