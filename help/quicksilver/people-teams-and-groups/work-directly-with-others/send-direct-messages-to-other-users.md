...
[!DNL Adobe Workfront]可讓您快速輕鬆地直接傳送與任何工作專案無關的訊息給其他[!DNL Workfront]使用者。 依照本節所述傳送的訊息會顯示在使用者首頁的[!UICONTROL 更新]索引標籤中，且所有使用者皆可看到。 如需更新的其他資訊，請參閱[更新工作專案並檢視更新：文章索引](../../workfront-basics/updating-work-items-and-viewing-updates/update-work-items-and-view-updates.md)。
...
1. 前往您要傳送訊息之使用者的首頁。\
   ...
   * 按一下連結的使用者名稱，因為該名稱出現在[!DNL Workfront]介面中的任何位置。 使用者名稱會顯示在[!DNL Workfront]介面的許多區域中，例如使用者所做的註解。

1. 在&#x200B;**[!UICONTROL 更新]**&#x200B;索引標籤上，按一下文字方塊欄位。

   ![訊息使用者在[!UICONTROL 更新]索引標籤](assets/message-user-NWE.png)
...
1. 按一下&#x200B;**[!UICONTROL 更新]。**
訊息會張貼在使用者首頁的**[!UICONTROL 更新]**&#x200B;索引標籤上的訊息清單頂端。
