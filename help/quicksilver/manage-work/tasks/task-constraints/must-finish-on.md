...
* 「必須完成時間」限制對具有子任務的任務沒有影響。 包含子任務的任務一律有自己的計劃開始日期、計畫完成日期及期間，從最早的子任務開始日期及最晚的子任務完成日期累計，無論套用至該任務的限製為何。 您必須將「必須完成時間」限制與需要固定日期的子任務直接關聯。 父項將繼續自動向上彙整。

如需詳細資訊，另請參閱[工作期間和期間型別](/help/quicksilver/manage-work/tasks/taskdurtn/task-duration-duration-type.md)。
