...
工作負載平衡器![中的](assets/planned-hours-on-wb-expanded-with-pti-info.png)計畫時數
...
每個物件的計畫時數會依您套用至資源規劃工具的檢視而有所不同。 如需詳細資訊，請參閱資源規劃工具[的專案與角色檢視中的](../../../resource-mgmt/resource-planning/overview-of-planner-hour-fte-cost-information-in-role-project-views.md)時數概觀、約當全職人數與成本資訊。
...
如需有關管理任務的每日分派資訊，請參閱工作負載平衡器[中的](../../../resource-mgmt/workload-balancer/manage-user-allocations-workload-balancer.md)管理使用者分派。
