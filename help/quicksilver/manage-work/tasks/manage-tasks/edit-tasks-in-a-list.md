...
1. 在工作清單中選取多個工作。
1. <span class="preview">（選擇性）按一下工作清單頂端的&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-icon.png)，然後&#x200B;**重新計算運算式**&#x200B;以更新計算自訂欄位中的所有資訊。</span>
1. 按一下&#x200B;**編輯**&#x200B;圖示![編輯圖示](assets/qs-edit-icon.png)。 **編輯任務**&#x200B;對話方塊會在新體驗<span class="preview">中開啟</span>。

   編輯所有任務的資訊與編輯一個任務的資訊相同。

   如需編輯工作的詳細資訊，請參閱[編輯工作](../../../manage-work/tasks/manage-tasks/edit-tasks.md)。

1. <span class="preview">（條件式）在新體驗中，執行下列動作：</span>
   ...
   1. <span class="preview"> （選擇性）按一下[編輯工作]方塊底部的&#x200B;**切換回舊體驗**。</span>

1. <span class="preview">（條件式）在舊體驗中，執行下列動作：</span>
