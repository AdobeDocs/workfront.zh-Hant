...
title: 編輯清單中的任務
description: 您可以編輯工作清單中顯示的欄位，以編輯工作清單中的工作資訊。 如需有關編輯任務的其他方法的資訊，請參閱編輯任務。
author: Alina
...
編輯清單中的任務是一種同時變更多個任務的快速方法，可清楚瞭解您的變更可能會如何影響專案時間表。
...
您可以決定對清單中工作所做的變更在發生時會自動儲存於何處，或者是否要手動儲存每個變更。
...
>[!TIP]
>
>如果您的專案有超過2000個任務，或如果它有許多相依性，則可能需要一段時間才能直觀地識別您對任務所做的變更，以及這些變更如何影響所有專案相依性。 在此情況下，如果您的專案有超過2000個任務或有許多相依性，儲存您的變更可能需要更長的時間。
...
1. 按一下清單頂端的&#x200B;**計畫模式**&#x200B;功能表![](assets/qs-list-mode-or-save-mode-icon-small.png)，並選取&#x200B;**手動儲存**，然後按一下&#x200B;**時間表計畫**>**套用**。
   ...
   >[!TIP]
   >
   >當您導覽離開此頁面時，Workfront會重新啟用「自動儲存」選項。
...
1. 按一下瀏覽器上的[上一步]按鈕，在您更新完工作後返回工作清單。
