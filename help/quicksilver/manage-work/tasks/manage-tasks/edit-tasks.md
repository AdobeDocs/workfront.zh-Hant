...
>[!NOTE]
>
><span class="preview">某些客戶可以在生產環境中編輯編輯任務方塊中的工作分派，就像在預覽環境中編輯工作分派一樣。</span>
>
><span class="preview">如需有關在預覽環境中編輯任務的資訊，請參閱本文中的[在預覽環境中編輯工作分派區域](#edit-the-assignments-area-in-the-preview-environment)一節。</span>
