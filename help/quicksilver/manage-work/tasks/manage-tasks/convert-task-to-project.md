...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>編輯任務與專案的存取權</p> <p>使用範本轉換為專案時，檢視或更高的範本存取許可權</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">物件許可權</td> 
   <td> <p>管理任務的許可權</p> <p>如果使用範本轉換為專案，檢視範本的許可權</p> <p>建立專案後，您即擁有專案的管理許可權</p></td> 
  </tr> 
 </tbody> 
</table>
...
* 如果您的組織同時使用舊版Workfront和Adobe企業檔案儲存，則當將任務轉換為專案時，會出現下列情況： <!--this info also duplicated in Document management overview for projects and related objects and Convert an issue to a project-->
...
1. 在&#x200B;**轉換成專案**&#x200B;方塊中，指定下列專案：
   ...
   * **名稱**：為專案命名。 預設名稱是任務的名稱。 這是必填欄位。
   * **描述**：描述此專案的用途。
   * （視條件而定）如果您已選取從範本建立專案，請更新&#x200B;**轉換為專案**&#x200B;方塊中的可用欄位。
