...
* 如果您的組織同時使用舊版Workfront和Adobe雲端儲存空間存放檔案，則當將任務轉換為專案時，會出現下列情況： <!--this info also duplicated in Document management overview for projects and related objects and Convert an issue to a project-->
