...
您可以在計畫頁面中編輯計畫，或者可以在清單中大量編輯一個或多個計畫。
...
1. （選擇性）若要編輯程式的有限資訊，請按一下左側面板中的&#x200B;**[!UICONTROL 程式詳細資料]**。
   ...
   ![包含自訂表單區段的程式詳細資料](assets/program-details-with-a-custom-form-section-nwe-350x137.png)
...
1. 若要編輯一或多個程式的所有資訊，請執行下列其中一個動作：
   ...
   * 按一下程式名稱旁的&#x200B;**[!UICONTROL 更多]**&#x200B;功能表![更多功能表](assets/more-icon.png)，然後&#x200B;**[!UICONTROL 編輯]。**
   * 前往程式清單，並選取您要編輯的一或多個程式，然後按一下清單頂端的&#x200B;**[!UICONTROL 編輯]**&#x200B;圖示![編輯圖示](assets/edit-icon.png)。

     **[!UICONTROL 編輯程式]**&#x200B;方塊隨即顯示。
...
當您大量編輯程式時，您更新的所有資訊都會套用至所有選取的程式，並覆寫每個程式的原始資訊。
...
1. 更新下列章節的資訊：
   ...
   * 評論
   ...
   如需詳細資訊，請參閱本文[編輯程式](#edit-programs-1)一節，從步驟4開始。<!--ensure this stays accurate-->
