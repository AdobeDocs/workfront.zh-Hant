...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL Edit]對[!UICONTROL Portfolios]的存取權</p>  </td> 
  </tr> 
  <tr> 
   <td role="rowheader">物件許可權</td> 
   <td> <p>投資組合的[!UICONTROL Manage]許可權</p>
   <p>[!UICONTROL Manage]對投資組合中專案的許可權，以將其從投資組合中新增或移除</p>  </td> 
  </tr> 
 </tbody> 
</table>
...
1. （可選）若要編輯投資組合的有限資訊，請執行下列動作：
   ...
   1. （選擇性和條件性）當區域摺疊時，按一下每個區域旁的&#x200B;**展開**&#x200B;圖示![展開圖示](assets/right-pointing-arrow.png)以展開您要編輯的區域。
      ...
      如需&#x200B;[!UICONTROL **Portfolio詳細資料**]&#x200B;區段中可見欄位的相關資訊，請繼續編輯&#x200B;[!UICONTROL **編輯Portfolio**]&#x200B;方塊中的投資組合，如下所述。
   1. （選擇性）如果沒有自訂表單附加至投資組合，請在&#x200B;**詳細資料**&#x200B;頁面右上角的&#x200B;**[!UICONTROL 新增自訂表單]**&#x200B;欄位中開始輸入表單的名稱，然後在其顯示在清單中時選取它。
...
1. 請考慮在下列任何一節中指定資訊：
   ...
   * [註解](#comment)
   ...
   >[!TIP]
   >
   >若要一次重新計算多個產品組合的自訂欄位，請在清單中選取多個產品組合，然後按一下清單頂端的&#x200B;**更多**&#x200B;功能表![更多](assets/more-icon.png)，然後&#x200B;**重新計算運算式**。
...
1. 按一下&#x200B;**[!UICONTROL 概述]**&#x200B;並指定下列欄位：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader"> <p role="rowheader">[!UICONTROL 一致性計分卡]</p> </td> 
