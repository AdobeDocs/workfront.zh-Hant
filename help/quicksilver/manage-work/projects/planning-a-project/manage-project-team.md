...
如果您仍然沒有存取權，請詢問您的Workfront管理員是否對您的存取層級設定了其他限制。 如需有關Workfront管理員如何修改您的存取層級的資訊，請參閱 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">建立或修改自訂存取層級</a>.</p> </td>
  ...
  <tr> 
   ...
   <td> <p>檢視專案或更高許可權</p> <p>如需請求其他存取許可權的詳細資訊，請參閱 <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">要求物件的存取權 </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
當您將使用者新增到專案團隊時，他們將獲得有關專案和專案任務、問題和檔案的「檢視」許可權。 如需詳細資訊，請參閱文章 [專案團隊概觀](../../../manage-work/projects/planning-a-project/project-team-overview.md).

>[!TIP]
>
>專案團隊中的使用者不會自動新增到專案的資源管理工具中。
...
如果專案上未履行任何角色的使用者希望在專案存留期間收到有關特定更新或變更的通知，您可以手動將其新增到專案團隊。

有關可以為專案團隊中的使用者啟用哪些通知的詳細資訊，請參閱 [Adobe Workfront中可用的事件通知](../../../administration-and-setup/manage-workfront/emails/event-notifications-available-in-wf.md).
...
1. 按一下 **人員** 在左側面板中。 您可能需要按一下 **顯示更多** 首先。
...
1. 在 **新增使用者** 方塊中，開始輸入您想要新增至專案團隊的作用中Workfront使用者名稱，然後在其出現在下拉式清單中時按一下該名稱。

   重複此步驟，將多位使用者新增至專案團隊。 使用者必須屬於與專案相關聯的群組。

   >[!TIP]
   >
   >* 您無法藉由新增使用者的團隊、群組、公司或職務角色來新增使用者。
...
1. 按一下 **新增**.
   ...
   使用者取得專案的檢視許可權，並作為專案團隊的一分子收到有關專案的通知。

## 從專案團隊中移除使用者

當您從使用者在專案中的角色中移除使用者時，他們仍然是專案團隊的一部分。

如果您從專案團隊中移除使用者，並且該使用者被指派到專案中的任務或問題，則未完成的任務和問題中將取消指派該使用者。 在這種情況下，任務和問題返回到工作負載平衡器中的未指派工作區域。

即使您將已完成的任務和問題從專案團隊中移除，仍會指派給已指派任務和問題的使用者。

如需有關從專案團隊中移除使用者的詳細資訊，請參閱 [從專案中移除使用者](../../../manage-work/projects/manage-projects/remove-users-from-projects.md).
