...
您必須擁有具有「編輯專案」存取權的標準或計畫授權，才能建立專案的工作劃分結構。 視您在建立WBS時執行的活動數量而定，可能需要額外存取Adobe Workfront的其他區域。
...
* 使用者\
  只有具有「標準」、「供需規劃員」或「工作人員」存取層級的使用者才能指派至任務。 雖然您可以將工作指派給請求者和檢閱者，但他們無法完成這些工作。 因此，我們不建議指派工作給對方。
