...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Adobe Workfront封裝</td> 
   <td> <p>任何</p> </td> 
  </tr> 
  <tr> 
...
1. 按一下左側面板中的&#x200B;**人員**。
   ...
   ![傳送更新給專案](assets/send-update-to-user-box-on-project.png)上的使用者方塊

1. 在&#x200B;**將更新發佈至專案**&#x200B;區域中，輸入您的更新。
1. （選擇性）若要將更新設為私人，請選取&#x200B;**我的公司私有**&#x200B;選項。

   公司外部的使用者無法檢視私人更新。

1. （選擇性）按一下「**標籤人員**」以新增更多未選取的收件者。
1. 按一下「**傳送**」。

   更新及包含的使用者名稱會顯示在專案的&#x200B;**更新**&#x200B;區段中。
...
1. 傳送更新給專案團隊成員，如本文中[傳送電子郵件給專案團隊成員](#send-an-email-to-a-project-team-member)一節所述。

   更新及其中所包含的使用者名稱會顯示在專案的&#x200B;**更新**&#x200B;區段中。
