...
![專案量度](assets/project-metrics-full-screen-350x238.png)
...
![專案量度](assets/project-metrics-kpis-350x52.png)
...
>![已完成的工作](assets/completed-tasks-dialog-350x75.png)\
...
![依狀態的任務問題](assets/project-metrics-task-issue-by-status-350x120.png)

在此圖表中選取優先順序時，您可以檢視專案中任務或問題的所有優先順序。

![依優先順序的任務和問題](assets/project-metrics-task-issue-by-priority-350x121.png)

>[!TIP]
>
>若要顯示具有特定狀態或優先順序的工作專案清單，請按一下圖表中的長條圖。 在該清單中，您可以按一下特定工作專案以在新的索引標籤中檢視更多詳細資訊。\
>![已完成的工作方塊](assets/completed-tasks-dialog-350x75.png)\
>如需詳細資訊，請參閱[檢視量度詳細資料](#view-metrics-details)。
...
![按完成狀態排列的任務或問題](assets/tasks-issues-by-complete-status-350x250.png)
...
![受指派者的任務和問題](assets/tasks-issues-by-assignee-350x104.png)
...
1. 在左側面板中，按一下&#x200B;**度量**。\
   ...
   ![度量區段](assets/metrics-section-350x298.png)

1. （視條件而定）如果圖表上顯示下拉箭頭，請按一下圖表上的&#x200B;**下拉箭頭**&#x200B;圖示![下拉箭頭](assets/dropdown-arrow.png)，然後從選單中選取您想要的選項。\
...
1. （可選）若要更密切地檢視頁面上任何量度的任務或問題，請執行下列動作：
   ...
   1. 使用清單底部的箭頭來找出您要檢視的任務或問題。
      ...
      ![分頁](assets/pagination-300x152.png)

   1. 選取一個任務或問題以檢視更多詳細資料。

      任務或問題會在新標籤中開啟。

1. （選擇性）若要將專案度量儀表板匯出至.png檔案，請按一下&#x200B;**匯出**&#x200B;圖示![匯出圖示](assets/export.png)，然後從下拉式選單中選取&#x200B;**匯出為PNG**。
