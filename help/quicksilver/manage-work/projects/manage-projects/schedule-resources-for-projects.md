...
1. 按一下 **排程** 或左面板中的「工作負載平衡器」部分。 「調度」或「工作負載平衡器」部分可能位於 **顯示更多**.
   ...
   有關在項目中使用計畫工具計畫資源的資訊，請參閱 [修改用戶分配和分配](../../../resource-mgmt/resource-scheduling/get-started-resource-scheduling.md#modify) 文章一節 [開始使用資源計畫](../../../resource-mgmt/resource-scheduling/get-started-resource-scheduling.md).
