...
1. 工作1 **的** CPI&#x200B;**&#x200B;** = .14計算方式如下：\
   **CPI** **工作1** = *IF*&#x200B;實際勞力成本+ GeneratedActualExpenseCost &lt;> 0 *THEN*
...
1. 任務1 **的** EAC&#x200B;**&#x200B;** = $13,400.00\
   **工作1**&#x200B;的CPI勞力&#x200B;**&#x200B;**&#x200B;若為實際勞力成本&lt;> 0，則
   ...
   否則CPI_Labor = 1\
   **工作1**&#x200B;的CPI人力&#x200B;**&#x200B;** = 100/2500\
   **CPI人力** **針對任務1** = .04&#x200B;**&#x200B;**&#x200B;**EAC人力&#x200B;**&#x200B;**針對任務1**=* IF *CPI_Labor &lt;> 0* THEN *EAC人力=計畫勞力成本/CPI_Labor
...
1. 專案的&#x200B;**CPI** = .32，計算方式如下：\
   專案的&#x200B;**CPI**&#x200B;**1&rbrace; =** IF *實際勞力成本+ GeneratedActualExpenseCost &lt;> 0* THEN **
...
1. 從專案動作，執行重新計算財務
1. 工作2的&#x200B;**CPI** = .17計算方式如下：\
   **CPI任務2** = *IF*&#x200B;實際勞力成本+ GeneratedActualExpenseCost &lt;> 0 *然後* CPI = (TotalBudgetedCostWorkPerformed + GeneratedPlannedExpenseCost) / (ActualLaborCost + GeneratedActualExpenseCost)
   * ELSE* CPI = CPI_Labor\
...
1. 作業3的CPI = .31計算方式如下：\
   **CPI**&#x200B;**任務3** = *IF*&#x200B;實際勞力成本+ GeneratedActualExpenseCost &lt;> 0 *THEN*
   ...
   * ELSE* CPI = CPI_Labor\
     ...
     **CPI**&#x200B;**工作3** = 1650 / 5400\
     **CPI**&#x200B;**任務3** = .31 **&#x200B;**&#x200B;**&#x200B;任務3 &#x200B;** 的EAC = $9,521.74計算如下：\
...
1. 作業1的CPI = .16計算方式如下：\
   **CPI**&#x200B;**任務1** = *IF*&#x200B;實際勞力成本+ GeneratedActualExpenseCost &lt;> 0 *THEN*
