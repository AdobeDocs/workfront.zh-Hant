...
<tbody> 
  ...
  <tr> 
   ...
   <td> <p><span class="preview"><strong>計畫成本</strong>的計算公式如下：</span></p> <p><span class="preview"><code style="font-style: normal;">Task Planned Cost = Task Planned Labor Cost + Task Planned Expense Cost</code> </span></p> <p><span class="preview">其中任務計畫勞力成本的計算方式：</span></p> <p><span class="preview"><code>Planned Labor Cost = Planned Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> <p><span class="preview"><strong>實際成本</strong>的計算公式如下：</span></p> <p><span class="preview"><code style="font-style: normal;">Task Actual Cost = Task Actual Labor Cost + Task Actual Expense Cost</code> </span></p> <p><span class="preview">其中作業實際勞力成本的計算方式：</span></p> <p><span class="preview"><code>Task Actual Labor Cost = Actual Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> </td> 
  </tr> 
  <tr> 
   <td> <p>固定每小時</p> </td> 
