...
* **計畫權益**：這是專案所有者完成業務案例的&#x200B;**專案資訊**&#x200B;區域時所指定的手動專案。\
  如需有關專案計畫權益的詳細資訊，請參閱文章[業務案例領域概觀](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md#project-info)中的[專案資訊](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md)區段。
