...
您可以存取專案詳細資訊區段的財務區域，以檢視或編輯專案的財務資訊。 您可以在此區域中檢視或編輯的欄位數量有限。 如需有關編輯專案的所有資訊，請參閱[編輯專案](../../../manage-work/projects/manage-projects/edit-projects.md)。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>檢視專案或更高版本的許可權，包括檢視一般財務許可權</p> <p>管理專案的許可權，包括編輯一般財務以編輯專案的財務資訊</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 您可以在「專案明細」的「財務」區域中找到的財務資訊，代表從作業累計至專案層次的值，以及直接在專案上輸入的資訊。 某些財務資訊可在專案與作業層級管理。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>這些是顯示您的專案在指定時間的表現情形的專案績效量度。 它們的值是根據績效指數方法計算的。<br>如需詳細資訊，請參閱下列文章： </p> 
       <ul> 
     ...
     <tr> 
      ...
      <td> 專案的預計總成本，如果績效指數方法(PIM)是以時數為基礎，則以時數表示；如果績效指數方法(PIM)是以成本為基礎，則以貨幣值表示。<br>如需有關計算完工預估的詳細資訊，請參閱文章<a href="../../../manage-work/projects/project-finances/calculate-eac.md" class="MCXref xref">計算完工預估值(EAC)</a></td> 
     </tr> 
     <tr> 
