...
* 如果時數記錄於任務上，則任務必須具有以下收入型別：
   ...
   * 如果「收入型別」設為「每小時角色」，則記錄時間之使用者的主要角色必須具有每小時收費率。
     ...
     >
     >您可以在專案層級覆寫職務角色的收費率。\
     >如需詳細資訊，請參閱文章[覆寫工作角色收費率以及計算專案收入的總覽](../../../manage-work/projects/project-finances/override-role-billing-rates-and-calculate-project-revenue.md)中的「覆寫專案層級的工作角色收費率」一節。
