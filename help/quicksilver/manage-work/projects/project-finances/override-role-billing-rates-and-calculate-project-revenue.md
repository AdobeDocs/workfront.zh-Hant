...
您也可以在專案中附加費率卡，這會從費率卡將職務角色帳單費率匯入專案。
...
* 當任務的&#x200B;**收入型別**&#x200B;是&#x200B;**每小時使用者和角色**&#x200B;時，Workfront會使用階層來決定每個任務的收費率。 如需詳細資訊，請參閱[收入與成本階層概覽](/help/quicksilver/manage-work/projects/project-finances/overview-revenue-cost-hierarchy.md)。
...
* 對於具有&#x200B;**收入型別** （每小時&#x200B;**個角色**）或&#x200B;**每小時使用者和角色**)並指派給工作角色的工作，**計畫收入**&#x200B;的計算方式為將任務的&#x200B;**計畫時數**&#x200B;乘以工作角色的計費率。
...
* 當任務的&#x200B;**收入型別**&#x200B;是&#x200B;**每小時角色數**&#x200B;或&#x200B;**每小時使用者和角色數**&#x200B;時，Workfront會將任務的&#x200B;**實際小時數**&#x200B;乘以指派給任務之工作角色的計費率，以計算&#x200B;**實際收入**。 實際時數是直接記錄至工作的時數。
