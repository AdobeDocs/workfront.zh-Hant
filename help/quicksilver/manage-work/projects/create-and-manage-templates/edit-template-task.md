...
根據您選擇編輯任務的環境，編輯範本任務會有所不同。

### 在生產環境中編輯範本任務

>[!NOTE]
>
><span class="preview">某些客戶可以像在預覽環境中編輯範本任務一樣，在其生產環境中編輯範本任務。</span>
>
><span class="preview">如需有關在預覽環境中編輯任務的資訊，請參閱本文中的[在預覽環境中編輯範本任務](#edit-template-tasks-in-the-preview-environment)一節。</span>
...
1. （條件式與選擇性）若您的&#x200B;**期間型別**&#x200B;是&#x200B;**計算的工作量**&#x200B;或&#x200B;**投入比導向**，請為每個受指派者指定&#x200B;**配置%** （配置百分比）。 這是受指派人排程中可在此任務上花費的時間。 變更受指派人的配置百分比將會變更任務的計畫時數。
1. （條件式與選擇性）若您的&#x200B;**期間型別**&#x200B;是&#x200B;**簡單**，請指定每個受指派者的&#x200B;**小時**

   或

   指定範本任務的&#x200B;**計畫時數**&#x200B;總數。 這會將總時數平均分配到所有被指定者。

1. （條件式與選擇性）若您的&#x200B;**期間型別**&#x200B;為簡單，請指定範本任務的&#x200B;**期間** （以天為單位）。 這會成為從此範本建立之任務的工期。
...
1. 如上所述，開始編輯範本任務。
1. 在&#x200B;**編輯範本任務**&#x200B;方塊中，按一下左側面板中的&#x200B;**工作**。

   ![範本任務編輯指派](assets/template-task-edit-assignments.png)

1. 在&#x200B;**搜尋人員、角色或團隊**&#x200B;欄位中，開始輸入受指派人的名稱，然後在其顯示在清單中時選取它
