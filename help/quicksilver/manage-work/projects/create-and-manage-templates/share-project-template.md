...
1. 執行下列其中一項：\
   ...
   從清單中選取範本，按一下「共用」圖示![「共用範本](assets/share-icon.png)」，然後按一下&#x200B;**「範本」。**
...
1. 從與您共用之每個實體的下拉式選單中，選取下列選項：
   ...
   * **管理**：具有這些許可權的使用者可以編輯或刪除範本。
     ...
     如需此處可用之進階設定![齒輪圖示](assets/gear-icon-in-access-levels.png)的相關資訊，請參閱[共用範本](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md#template-permissions)一文中的[範本共用的進階設定](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md)一節。
