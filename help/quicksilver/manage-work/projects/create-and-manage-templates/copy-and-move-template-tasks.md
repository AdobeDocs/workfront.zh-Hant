...
如果您還是沒有存取權，請詢問您的Workfront管理員，他們是否在您的存取層級中設定其他限制。 如需有關Workfront管理員如何修改您的存取層級的資訊，請參閱 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">建立或修改自訂存取層級</a>.</p> </td>
  ...
  <tr> 
   ...
   <td> <p>管理範本和範本任務的許可權 </p> <p>如需請求其他存取許可權的詳細資訊，請參閱 <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">要求物件的存取權 </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 子任務會轉移至新範本任務。
* 自訂表單會與範本任務一起複製。 只有在您選擇複製自訂資料時，自訂欄位中的資訊才會傳輸到新範本任務。
* 在復製程式進行期間，您可以選取將某些與範本任務相關聯的專案複製到複製的任務。 但是，依預設，下列物件不會轉移到複製的任務：

   * 使用者註解

* 您可以在Adobe Workfront Web應用程式的下列區域中複製範本任務：

   * 在範本任務層級，從 **「更多」圖示** ![](assets/more-icon.png) 範本任務名稱的右側。

   * 在範本任務清單中。
* 您可以一次複製或移動一個範本任務，或選取多個範本任務。
...
1. 執行下列任一項作業：
   * 按一下範本任務的名稱以開啟它。
   * 在清單中選取一或多個範本任務。
1. （視條件而定）按一下 **更多** 功能表 ![](assets/more-icon.png) 在範本任務清單頂端或範本任務名稱右側（如果您開啟任務），然後按一下 **複製到** 或 **複製**，視您從何處存取「複製」選項而定。
「複製範本任務」方塊開啟。
   ![](assets/copy-template-task-box-unshimmed.png)
1. （可選）將範本任務重新命名為 **範本任務名稱** 欄位。

   >[!TIP]
   >
   >選擇複製清單中的多個範本任務時，此欄位會變暗且無法編輯。 您可以將滑鼠移至「範本任務名稱」欄位上，所有選取的範本任務清單隨即顯示。

1. 開始輸入 **目的地範本** 您要將範本任務複製到 **選取目的地範本** 欄位，然後在其顯示在清單中時選取它。
...
1. （視條件而定）按一下 **要求存取權** 以請求對目的地範本的存取權（如果您沒有所選範本的存取權）。
1. （視條件而定）如果您有權將範本任務新增至目的地範本上的其中一個範本任務，請繼續將範本任務複製到所選目的地範本，而不要求存取權。

1. 按一下 **選項** 在左側面板中，取消選取您不想要與範本任務一起複製的範本任務屬性。 依預設會選取所有選項。
...
1. （選用）按一下 **選取父系** 在左側面板中，選取目的地範本中要成為所複製範本任務之父系的範本任務。
...
除了複製範本任務外，您還可以將範本任務移動到相同範本中的另一個範本任務或移動到另一個範本。
...
1. 執行下列任一項作業：
   * 按一下範本任務的名稱以開啟它。
   * 在清單中選取一或多個範本任務。
1. （視條件而定）按一下 **更多** 功能表 ![](assets/more-icon.png) 在範本任務清單頂端或範本任務名稱右側（如果您開啟任務），然後按一下 **移至** 或 **移動**，視您從何處存取「移動」選項而定。
「移動範本任務」方塊開啟。
...
1. 開始輸入 **目的地範本** 您要將範本任務移動到的位置 **選取目的地範本** 欄位，然後在其顯示在清單中時選取它。

   >[!TIP]
   >
   >您也可以開始輸入「參照編號」或輸入範本的ID。 這可能會協助您區分具有相同名稱的範本。

1. （視條件而定）按一下 **要求存取權** 來要求存取範本（如果您沒有目的地範本的存取權）。
...
1. （選用）按一下 **選取父系** 在左側面板中，選取目的地範本中要成為已移動範本任務之父系的範本任務。
