---
title: 使用先前請求的資料自動完成請求
content-type: reference
description: 您可以使用AI來使用來自先前請求的資料自動完成請求欄位。
author: Becky
...
自動完成可以在您填寫表單時建議欄位值。 當您在請求欄位中輸入值時，Workfront會將這些值與先前的請求進行比較。 如果輸入的值與先前請求中類似內容中的其他欄位值緊密相關，Workfront會建議這些值。
