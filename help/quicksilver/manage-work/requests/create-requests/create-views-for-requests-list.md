...
1. 若要將自訂欄位新增為欄，請按一下熒幕右邊附近的&#x200B;**新增欄**&#x200B;圖示![新增欄](assets/add-column.png)，然後按一下您想要新增為欄位至檢視的自訂表單欄位旁的加號圖示。
...
> * 為確保檢視套用至使用檢視的使用者，無論檢視的建立者為何，您可在任何以使用者作為值的欄位中使用「我（登入使用者）」篩選器萬用字元。
