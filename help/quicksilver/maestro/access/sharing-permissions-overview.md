...
description: 您可以共用或移除Adobe Workfront規劃工作區或檢視的許可權。
hidefromtoc: true
hide: true
...
您可以在Adobe Workfront規劃中共用或移除工作區或檢視的許可權。

本文說明Workfront規劃物件的許可權層級。
...
* 您的Adobe Workfront授權型別與Workfront規劃許可權搭配使用，可讓您在使用Workfront規劃時檢視、貢獻或管理物件。

  如需有關授權型別如何影響Workfront規劃許可權等級的資訊，請參閱 [使用Adobe Workfront規劃時的授權型別概觀](/help/quicksilver/maestro/access/license-type-overview.md).
...
## 共用Adobe Workfront計畫物件的許可權

以下各節中的表格說明了共用工作區或檢視時您可以選取的許可權層級，以及每個層級允許的功能。

>[!IMPORTANT]
>
>並非所有使用者都可擁有下述許可權層級。 使用者的個別授權會決定他們可以針對Workfront計畫物件收到的許可權層級。
>
>如需詳細資訊，請參閱 [使用Adobe Workfront規劃時的授權型別概觀](/help/quicksilver/maestro/access/license-type-overview.md).
