...
* 您想要管理其工作負載的使用者必須符合下列條件，以便其使用狀態和技能的資訊是準確的：
   ...
   * 在設定檔中更新其休假行事曆。\
     如需有關更新使用者休假行事曆的資訊，請參閱 [在Adobe Workfront中設定個人休假](../../workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md).
