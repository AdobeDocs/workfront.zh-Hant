...
1. 按一下任務或問題列以開啟右側的「摘要」面板。
   ...
   按一下任務或問題右側的&#x200B;**更多**&#x200B;功能表![更多圖示](assets/more-icon.png)，然後按一下&#x200B;**開啟摘要**。
...
1. 修改工作專案的許多欄位、輸入更新，或從此處導覽至Workfront的其他區域，將檔案或其他資訊新增至工作專案。
   ...
   >[!NOTE]
   >
   >如果您的組織使用Adobe雲端儲存空間存放檔案，您無法將檔案新增到「摘要」面板中的Adobe雲端儲存空間工作專案。
   >
...
1. 按一下[摘要]右上角的&#x200B;**關閉圖示** ![關閉圖示](assets/close-icon.png)以關閉它。
