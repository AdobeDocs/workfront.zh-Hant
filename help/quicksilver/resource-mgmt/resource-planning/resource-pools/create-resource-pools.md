   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p> 個別新增使用者到資源集區。<br>或<br>一次新增大量使用者到資源集區。您可以新增下列與使用者或使用者集合相關聯的實體之一：
        <ul>
        ...
        <p>備註：若使用者成為群組、專案團隊、公司的成員，或在群組、專案團隊、公司或工作角色新增至資源集區後，成為工作角色的相關聯者，則新成員不會自動新增至資源集區。 <br>如果使用者屬於您新增的團隊、群組、公司和工作角色，則使用者只會新增一次至資源集區。<br>使用者新增至資源集區後停用的使用者，在使用者清單中會變暗並標籤為停用。</p></p></td>
     </tr>
    </tbody>
   </table>
