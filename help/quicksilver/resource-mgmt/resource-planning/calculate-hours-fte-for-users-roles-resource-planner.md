...
* 小時差異\
  如需此值代表的詳細資訊，請參閱資源規劃工具[&#128279;](../../resource-mgmt/resource-planning/overview-of-planner-hour-fte-cost-information-in-role-project-views.md)的專案和角色檢視中的時數概觀、約當全職人數和成本資訊。
