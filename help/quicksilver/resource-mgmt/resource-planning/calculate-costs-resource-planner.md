...
您可以在Adobe Workfront資源規劃工具中使用成本值（而不是時數或FTE值）來預算資源。 資源規劃工具中的&#x200B;**依使用者檢視**&#x200B;檢視沒有成本值可用。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>存取層級設定</td> 
   <td> <p>編輯對資源管理的存取權，包括存取資源規劃工具中的編輯優先順序和預算時數</p> <p>編輯財務資料的存取權，包括編輯成本費率與編輯一般財務的存取權</p>
   <p>編輯專案和使用者的存取權</p></td> 
  </tr> 
  <tr> 
   <td>物件許可權</td> 
   <td> <p>管理您想要編列預算資訊之專案的許可權，並具備編輯成本費率與編輯一般財務的功能</p></td>
  </tr> 
 </tbody> 
</table>
