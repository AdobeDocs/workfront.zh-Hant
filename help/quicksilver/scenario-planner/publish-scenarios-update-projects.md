...
1. （選擇性）按一下&#x200B;**[!UICONTROL 搜尋]**&#x200B;圖示![](assets/search-icon.png)並開始輸入計畫的名稱，以便在清單中快速找到它。
...
1. 從&#x200B;**[!UICONTROL 初始情境]**&#x200B;下拉式功能表中選取您要發佈的情境，然後按一下右上角的&#x200B;**[!UICONTROL 前往Publish]** ![](assets/go-to-publish-button-icon.png)。

   或

   按一下「**[!UICONTROL 比較案例]**」，將游標暫留在您要發佈的案例卡片上，然後按一下「**[!UICONTROL 前往Publish]**」![](assets/go-to-publish-button-icon.png)。

   此時會顯示[!UICONTROL Publish方案]頁面，其中顯示情境中所有方案的清單。 如果先前已發佈任何方案，則專案圖示![](assets/project-icon-sp.png)會顯示在方案的名稱之後，且清單會填入&#x200B;**[!UICONTROL 上次發佈]**&#x200B;日期。

   >[!TIP]
   >
   >透過匯入專案建立的方案也會在其名稱右側顯示專案圖示![](assets/project-icon-sp.png)
...
1. （選擇性）按一下&#x200B;**[!UICONTROL 搜尋]**&#x200B;圖示![](assets/search-icon.png)並開始輸入方案名稱以在清單中快速找到。
1. 選取一個或多個方案以發佈和建立或更新它們的專案，然後按一下&#x200B;**[!UICONTROL Publish方案]**。
...
1. 移至下列區域以檢視專案上的方案資訊：
   ...
   * **[!UICONTROL 專案詳細資料]區段**&#x200B;的[!UICONTROL 總覽]區域：此區域中已建立新的[!DNL Scenario Planner]區段，其中包含連結的方案的資訊。

     ![](assets/scenario-planner-on-project-details-350x135.png)

     下列方案資訊發佈在[!UICONTROL 專案詳細資料]區段的[!DNL Scenario Planner]區域：
     ...
     >[!NOTE]
     >
     >所有擁有專案[!UICONTROL 檢視]存取權的使用者都可以在[!UICONTROL 總覽]區域中看到[!DNL Scenario Planner]區段。 您可以使用版面配置範本來控制此區域是否顯示在[!UICONTROL 詳細資料]區段中。 如果使用者沒有關聯的版面配置範本，預設會顯示此區域。
     >
     >   
     >   
     ...
     >   * 如需在[!UICONTROL 專案詳細資料]的[!UICONTROL 總覽]區域中檢視資訊的詳細資訊，請參閱專案[!UICONTROL 總覽]區域](../manage-work/projects/manage-projects/understand-project-overview-area.md)中的[[!UICONTROL 管理]資訊。
     >   
     >
   ...
   * **專案**&#x200B;之[!UICONTROL 商業案例]的[!UICONTROL 資源預算]區域：專案[!UICONTROL 商業案例]的[!UICONTROL 資源預算]區域新增了使用[!DNL Scenario Planner]資訊管理專案資源的新選項。

     如需詳細資訊，請參閱[!UICONTROL 業務案例]中使用 [!DNL Scenario Planner]](../manage-work/projects/define-a-business-case/budget-resources-in-business-case-use-scenario-planner.md)的[預算資源。
...
1. （選擇性）在您發佈情境後，檢閱[!DNL Scenario Planner]中的下列資訊：
   ...
   * 從情境發佈至少一個方案後，[!UICONTROL 前往Publish]選項會從所有其他情境中移除。
