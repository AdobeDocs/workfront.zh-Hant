    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p><span>根據您選擇使用計畫的時數或FTE，檢閱或更新</span>下列欄位中適用於情境的每月工作角色FTE數量<span>或時數</span>：</p> 
       <ul> 
        <li> <p><strong>[！UICONTROL可用] （最大&lt;FTE數量&gt;）</strong>：括弧中的數字顯示情境中任一月可用角色的最大數量。 檢閱或更新情境每個月的FTE數量。 變更每月配置可能會更新括弧中的FTE數量。 </p> </li> 
     ...
     <tr> 
      ...
      <td> <p><span>根據您選擇使用計畫的時數或FTE，檢閱</span>下列欄位中案例所需的每月工作角色FTE或時數： </p> 
       <ul> 
        <li> <p><strong>[！UICONTROL必要] （最大&lt;FTE數量&gt;）</strong>：括弧中的數字顯示情境中任一月份所需的角色數量上限。 </p> </li> 
