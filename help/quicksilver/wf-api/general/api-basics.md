...
<pre>POST /attask/api/v15.0/document？updates={<br>名稱： aFileName，<br>控制代碼： abc...123，（檔案上傳的控制代碼）<br> docObjCode： PROJ， （或TASK、OPTASK等）<br> objID： abc...123，<br> currentVersion：{version：v1.0，fileName：aFileName}<br></pre>
...
<pre>PUT /attask/api/v15.0/project/123abcxxxxxxxxxxxxxxxxxxxxxx？method=PUT&amp;updates={accessRules：[{accessorID：'123abcxxxxxxxxxxxxxxxxxxxxxxxxxx'，accessorObjCode：'TEAMOB'，coreAction：'VIEW'}]</pre>下列範例顯示將任務從一個專案移動到另一個專案的語法：
