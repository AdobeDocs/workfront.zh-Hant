...
title: API 9版的新功能（續）
description: 這份清單是較大清單的後半部分。 前半部位於API 9版的新功能。 您可以在API 9版的更新中找到9版的更新清單。
author: John
...
這份清單是較大清單的後半部分。 前半部位於 [API 9版的新功能](../../wf-api/api/new-api-version-9.md). 如需第9版的更新清單，請前往 [API第9版的更新](../../wf-api/api/new-api-version-9-updates.md).
