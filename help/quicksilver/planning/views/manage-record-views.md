...
在Adobe Workfront Planning區域中選取記錄型別後，您就可以以各種方式顯示該型別的所有記錄。

您可以檢視幾種格式的記錄，讓您以最適合自己的方式靈活地探索和瞭解資訊。 無論您想要結構化概觀、依時間順序的內文、以日期為基礎的版面，還是簡單的可捲動清單，每個檢視都提供獨特的視角。
...
* 清單
  ...
  您可以在清單檢視的「連線記錄」頁面中檢視記錄。

  >[!IMPORTANT]
  >
  >您無法將清單檢視套用至記錄型別頁面上的記錄清單。 您只能將記錄之「已連線」記錄頁面中的清單檢視套用至已連線專案的清單。<!--this will change-->
...
如需有關清單檢視的資訊，請參閱[管理清單檢視](/help/quicksilver/planning/views/manage-the-list-view.md)。
