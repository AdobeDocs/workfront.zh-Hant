...
* 版本1.0 - 2024年7月發行
  ...
  如需詳細資訊，請參閱本文章的[Workfront Planning API 1.0](#workfront-planning-api-version-10)版。
  <!--
...
## Workfront Planning API 1.0版

Workfront Planning API 1.0版已於2024年7月發行。

以下小節說明Workfront API 1.0版中可用的功能。
