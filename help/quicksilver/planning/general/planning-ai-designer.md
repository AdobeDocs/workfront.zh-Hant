...
>[!IMPORTANT]
>
>Planning Designer目前可供處於Beta狀態的所有客戶使用。
>
...
## 為您的組織啟用Planning Designer

作為系統管理員，您可以為組織開啟Planning Designer Beta 。 開啟此設定後，Workfront執行個體中的所有人都可在其Planning區域中檢視Planning Designer的功能。

1. 以Workfront管理員身分登入。
1. 按一下&#x200B;**主功能表** ![主功能表圖示](assets/main-menu-shell.png)，然後按一下&#x200B;**設定**。
1. 移至&#x200B;**系統** > **偏好設定** > **AI偏好設定**。
1. 開啟&#x200B;**啟用AI**。

   >[!NOTE]
   >
   >在Beta版中使用Planning Designer時，不需要接受AI合約。

1. 開啟&#x200B;**選擇加入AI Betas**&#x200B;設定（如果未啟用）。
1. 開啟&#x200B;**計畫Designer**&#x200B;設定（如果未啟用）。

   ![系統偏好設定中的規劃Designer設定](assets/ai-preferences-with-planning-designer-unaccepted-agreement.png)。

   >[!TIP]
   >
   >預設會開啟&#x200B;**選擇加入AI Betas**&#x200B;和&#x200B;**Planning Designer**&#x200B;選項，但您必須接受Beta合約，才能使用Planning Designer。

1. （條件式與強制式）如果您尚未接受Beta合約，請按一下&#x200B;**檢閱Beta合約**&#x200B;並閱讀合約，然後按一下&#x200B;**接受**。

1. 按一下「**儲存**」。

   您組織內所有可存取Planning的使用者現在都能使用Planning Designer功能來建立或編輯工作區。
...
* 在存取Planning Designer之前，您不需要啟用AI合約。

* 您必須簽署Beta合約才能存取Planning Designer。
...
1. 登入Workfront，然後按一下左上角的&#x200B;**主功能表**&#x200B;圖示![行主功能表](assets/lines-main-menu.png)，然後按一下&#x200B;**規劃**。
   ...
   **規劃**&#x200B;區域隨即開啟。<!--update screen shot when they change the name of the button-->
   ...
   ![使用AI建立工作區頁面上的按鈕](assets/design-with-ai-button-on-workspaces-page.png)
...
1. （可選）若要編輯工作區，請執行下列任一項作業：
   ...
   * 開啟工作區並按一下&#x200B;**使用AI編輯**。 如此將可開啟Planning Designer。 重複上述步驟以使用AI，並對工作區進行進一步的變更。
