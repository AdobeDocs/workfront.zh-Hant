...
<tr> 
   ...
   <p><span class="preview">管理您執行自動化之記錄的許可權。</span></p>
...
* 當您的組織同時使用舊版Workfront和Adobe雲端儲存空間時，系統會使用Workfront管理員在設定區域中選取的預設儲存空間，建立從Planning自動建立的專案。
...
本節說明如何使用Button click-automation建立物件。
