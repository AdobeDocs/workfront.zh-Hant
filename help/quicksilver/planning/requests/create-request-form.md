...
1. 按一下記錄型別卡。 如需有關建立記錄型別的資訊，請參閱[建立記錄型別](/help/quicksilver/planning/architecture/create-record-types.md)。
   ...
   記錄型別頁面會在您上次存取的檢視中開啟。 依預設，記錄型別頁面會在清單檢視中開啟。

1. 按一下頁面標頭中記錄型別名稱右側的&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)，然後按一下&#x200B;**建立請求表單** （如果您是第一次建立表單）。 按一下&#x200B;**管理申請表單**&#x200B;或&#x200B;<span class="preview">**申請表單**.</span> （如果您已經有表單，而且想要建立其他表單）。

   **請求表單**&#x200B;頁面會開啟，且請求會顯示在清單檢視中。

   ![要求表單頁面](assets/request-forms-in-list-view.png)
...
1. 按一下「**建立**」。
   ...
   * **預設節**：這是Workfront套用至要求表單的預設節符號。 所有記錄欄位會顯示在&#x200B;**預設區段**&#x200B;區域中。
...
1. （選擇性）按一下表單左側的&#x200B;**Content elements**&#x200B;標籤，然後新增下列任一元素：
   ...
   * **描述性文字**：新增新區段的指示，例如。
   * **分割槽符號**：這是表單上包含數個欄位的區域。

     >[!TIP]
     >
     >建置Planning請求表單與建置Workfront自訂表單類似。 如需詳細資訊，請參閱[建立自訂表格](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md)。

1. （選擇性）按一下&#x200B;**預覽**&#x200B;以檢視其他使用者使用表單提交請求時表單的顯示方式。
1. 繼續下列其中一項：

   * [設定表單設定](#configure-form-settings) （如果您想要為生產環境中的表單設定更多詳細資料）
   * 如果您不想進一步設定，請[發佈表單](#publish-form)。
...
1. 建立表單並儲存後，按一下&#x200B;**發佈**&#x200B;以發佈表單並取得其唯一連結。
   ...
   * **取消發佈**&#x200B;按鈕會取代&#x200B;**發佈**&#x200B;按鈕。 按一下此按鈕，表單將無法存取。
   * **共用**&#x200B;按鈕已新增至表單。
...
1. 前往請求表單清單，然後執行下列任一項作業：

   * 按一下記錄型別頁面中要求表單名稱右側的&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)。
   * 按一下清單中請求表單的名稱以開啟它。
...
1. （視條件而定）如果您已開啟表單，請按一下&#x200B;**表單**&#x200B;標籤右下角的&#x200B;**儲存**&#x200B;以儲存表單。
...
1. 按一下頁面標頭中記錄型別名稱右側的&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)，然後按一下&#x200B;**管理請求表單**&#x200B;或&#x200B;<span class="preview">**請求表單**</span>。

   **請求表單**&#x200B;頁面隨即開啟，所有與記錄型別相關的請求表單都會顯示在清單檢視中。
...
1. （選擇性）將滑鼠停留在清單檢視中的要求表單名稱上，然後按一下表單名稱右側的&#x200B;**更多**&#x200B;功能表![更多](assets/more-menu.png)，然後按一下下列其中一項：
...
1. 按一下標題中&#x200B;**請求表單**&#x200B;左側的向左箭頭，關閉請求表單清單。
