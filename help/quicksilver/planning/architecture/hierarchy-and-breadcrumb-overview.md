---
title: 階層與階層連結概觀
description: 身為工作區管理員，您可以在Adobe Workfront Planning中的連線記錄型別與其他物件型別之間，定義彈性但結構化的階層。 階層是記錄型別之間的連線，或記錄型別與Workfront專案之間的連線。
...
* 如果貴公司同時購買Workfront和Planning套件，階層連結可跨Workfront和Planning運作。
