...
1. （視條件而定）如果您是Workfront管理員，請按一下下列其中一項：
   ...
   * **所有工作區**，以存取與您共用的工作區或您建立的工作區
   ...
   >[!NOTE]
   >
   ><span class="preview">您無法在&#x200B;**範例工作區**&#x200B;索引標籤上編輯工作區。 我們建議使用多工作區範本套件來建立類似於「範例工作區」索引標籤上的工作區，並編輯您自己的工作區。 如需詳細資訊，請參閱[建立工作區](/help/quicksilver/planning/architecture/create-workspaces.md).</span>
...
1. 按一下&#x200B;**編輯**。
   ...
   ![編輯工作區方塊](assets/edit-workspace-box.png)
...
1. （可選）若要新增工作區區段，請執行下列任一項作業：
   ...
   * 按一下工作區底部的&#x200B;**新增區段**。
   * 將游標暫留在區段名稱上，然後按一下&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)，然後按一下&#x200B;**新增區段以上**&#x200B;或&#x200B;**新增區段以下**。

1. （可選）若要變更區段位置，請執行下列任一項作業：

   * 將滑鼠停留在區段名稱上，然後按一下&#x200B;**抓取**&#x200B;圖示![抓取圖示](assets/grab-icon.png)，然後將它拖放到正確的位置。
   * 將游標暫留在區段名稱上，然後按一下&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)，然後按一下&#x200B;**上移**&#x200B;或&#x200B;**下移**。 區段在工作區中向上或向下移動。

1. （可選）若要刪除工作區區段，請執行下列動作：

   1. 將游標暫留在區段名稱上，然後按一下&#x200B;**更多**&#x200B;功能表![更多功能表](assets/more-menu.png)，然後按一下&#x200B;**刪除**。<!--add screen shot when UI is final?-->
...
1. （選擇性）將滑鼠停留在記錄型別卡片上，按一下右上角的&#x200B;**更多**&#x200B;功能表![更多](assets/more-menu.png)，然後按一下&#x200B;**編輯**&#x200B;以修改記錄型別的外觀。

   如需詳細資訊，請參閱[編輯記錄型別](/help/quicksilver/planning/architecture/edit-record-types.md)。

1. （選擇性）將滑鼠停留在記錄型別卡片上，按一下右上角的&#x200B;**更多**&#x200B;功能表![更多](assets/more-menu.png)，然後按一下&#x200B;**刪除**&#x200B;以刪除記錄型別。
...
1. （可選）按一下記錄型別卡片以將其拖放到新位置。 您可以將記錄型別從一個工作區區段拖放至另一個工作區區段。
   ...
   ![在工作區中拖放記錄型別](assets/drag-and-drop-record-types-in-a-workspace.png)
