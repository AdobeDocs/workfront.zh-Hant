...
1. 在&#x200B;**新欄位**&#x200B;索引標籤中新增下列資訊：
   * **名稱**：欄位型別的名稱，它將顯示在資料表或記錄的詳細資訊頁面中。<!--ensure they updated this; and update the screen shot: it used to be "Label"-->
   * **描述**：有關欄位的額外資訊。 當您將滑鼠游標停留在表格中的欄位欄位上時，會顯示欄位描述，或是在記錄的詳細資訊頁面中按一下欄位名稱旁的資訊圖示時顯示<span class="preview">。</span>
1. 按一下「**建立**」。
...
1. 在&#x200B;**新欄位**&#x200B;索引標籤中新增下列資訊：
   ...
   * **名稱**：輸入新欄位的名稱。
   * **描述**：新增有關新欄位的資訊。 當您將滑鼠游標停留在表格中的欄位欄位上時，會顯示欄位描述，或是在記錄的詳細資訊頁面中按一下欄位名稱旁的資訊圖示時顯示<span class="preview">。</span>
