...
**[!UICONTROL 年度預算計畫]**
此Blueprint包含一個[!DNL Workfront]專業服務組織在與財務團隊進行實施合約期間已使用多年的範本，以組織年度預算規劃相關的活動。 範本有助於業務單位負責人設定期望值，並引導他們完成在年度計畫流程中請求和預留預算的流程。

**[!UICONTROL 基線儀表板]**
此藍圖包含控制面板，可幫助您做出更聰明、更快速的專案決策。 基準線可讓您比較計畫內容與已發生內容，讓您一目瞭然地找出問題任務、範圍潛移和專案趨勢。 「基準線控制面板」包含下列報表：基準線 |進行中的專案，比較基準 |完成的專案，比較基準 |進行中的任務和基準線 |已完成的工作。

**[!UICONTROL 合約服務傳遞計畫]**
此Blueprint包含可組織與提供客戶導向服務相關的工作的範本。 其設計旨在建立合約服務交付的統一方法。

**[!UICONTROL 公司活動計畫]**
此Blueprint包含[!DNL Workfront]專業服務組織在與人力資源團隊進行實作合作期間使用多年的範本，以支援員工保留活動，特別是公司活動和派對。

**[!UICONTROL 停用已離職員工IT檢查清單]**
此藍圖包含[!DNL Workfront]專業服務組織在與企業IT團隊實作合約期間使用多年的範本，以管理員工離職時必須進行的各種活動。 請務必停用員工存取權，並進行其他系統變更，以降低風險暴露，並確保其他團隊成員在離職員工不在時仍可保持生產力。

**[!UICONTROL 數位資產製作] （整合）**
整合程式的[!UICONTROL 數位資產生產]藍圖包含可組織標準數位生產程式工作的範本。 該範本為團隊提供建立原始數位資產的精益程式，該團隊依賴標準作業程式來定義工作方式，並僅使用專案來排定工作優先順序及追蹤進度。

**[!UICONTROL 數位資產生產] （已管理）**
[!UICONTROL Digital Asset Production]封裝包含可組織標準數位製作程式的工作的範本。 其目的是作為管理Workfront中數位資產建立的入口點。 使用此套件建立數位內容建立的基礎，然後進行自訂，以符合數位資料的其他創意流程需求。

**[!UICONTROL 數位資產修訂] （整合）**
整合程式的[!UICONTROL 數位資產修訂]藍圖包含單一範本，用以組織修訂現有資產的相關工作程式。 樣版為依賴標準作業程式來定義工作方式的團隊提供精簡處理，並僅使用專案來排定工作的優先順序及追蹤進度。

**[!UICONTROL 數位資產修訂] （管理）**
[!UICONTROL 數位資產修訂版本]封裝包含單一範本，用以組織修訂現有資產的相關工作。 範本簡化了資產修訂流程，同時建立了與新資產生產專案相較的一致體驗。
...
**[!UICONTROL 月底營業關閉]**
此Blueprint包含[!DNL Workfront]專業服務組織在與財務團隊進行實作合約期間已使用多年的範本，以組織帳本的月底結算。 範本提供每個月必須完成的常見活動清單，以準確報告及促進業務健康。

**[!UICONTROL 財務組織設定]**
此Blueprint包含要擴充至財務部門的組織結構設定。

**[!UICONTROL 一般內部策略方案]**
[!UICONTROL 一般內部策略方案]藍圖包含專案範本，可在中執行專案以進行任何內部最佳化、流程轉出或其他策略投資。 其設計是要具備足夠的一般性，適用於整個企業的所有組織。
...
**[!UICONTROL 列印資產製作] （整合）**
[!UICONTROL Print Asset Production]封裝包含組織標準列印生產程式工作的範本。 樣版為團隊提供建立原始列印資產的精益處理，該團隊依賴標準作業程式來定義工作方式，且僅使用專案來排定工作優先順序並追蹤進度。
...
[!UICONTROL 列印：直接郵件資產製作]藍圖會組織印刷品宣傳品製作程式的工作。 此Blueprint旨在作為在Workfront中管理印刷宣傳品（特別是直接郵件）的入口點。
...
[!UICONTROL 風險控制自我評估] (RSCA)定義識別風險的程式，並測量貴組織為降低這些風險而建立的控制項。 此範本提供的結構可協助您建立初始風險登記簿、建立減輕每個風險的計畫，並提供檔案以顯示控制項的工作。

**[!UICONTROL 社交資產生產] （整合）**
[!UICONTROL Social Asset Production]封裝包含可組織工作以建立社交成品的範本。 此範本為團隊提供建立原始社交資產的精益處理，該團隊依賴標準作業程式來定義工作方式，並僅使用專案來排定工作優先順序及追蹤進度。

**[!UICONTROL 社交資產生產] （已管理）**
...
[!UICONTROL Video Asset Production]封裝包含可組織標準視訊製作程式的工作程式的範本。 此範本為團隊提供建立原始視訊資產的精益程式，該團隊依賴標準作業程式來定義工作方式，並僅使用專案來排定工作優先順序及追蹤進度。

**[!UICONTROL 視訊資產製作] （已管理）**
[!UICONTROL Video Asset Production]封裝包含組織標準視訊製作程式工作的範本。 此套件旨在作為在Workfront中管理視訊資產建立的入口點。 使用此套件來建立視訊內容建立的基礎，然後進行自訂，以符合其他創意程式對特殊視訊素材型別的需求。
