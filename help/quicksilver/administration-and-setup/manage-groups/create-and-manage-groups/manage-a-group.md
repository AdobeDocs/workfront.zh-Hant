...
1. 選取群組，然後按一下編輯 ![](assets/edit-icon.png)，複製 ![](assets/copy-icon.png)，或刪除 ![](assets/delete.png) 圖示。
   ...
   * **複製**： [複製現有群組或子群組來建立最上層群組](../../../administration-and-setup/manage-groups/create-and-manage-groups/create-a-group.md#copying-an-existing-group-and-sub-group) 在文章中 [建立群組](../../../administration-and-setup/manage-groups/create-and-manage-groups/create-a-group.md)
...
如果Workfront管理員解除鎖定為您組織中的群組設定事件通知的能力，則您可以為您管理的群組設定這些通知。 如需指示，請參閱 [檢視和設定群組的事件通知](../../../administration-and-setup/manage-groups/create-and-manage-groups/view-and-configure-event-notifications-group.md).
