...
* 變更存取層級：
  ...
  * 修改授權型別
  * 變更專案、任務、問題、投資組合、計畫、報告、檔案、使用者或範本的許可權
...
Business Rules僅適用於已購買Ultimate Workfront套件的客戶。 如需詳細資訊，請參閱[建立和編輯商業規則](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/business-rules.md)。
...
* 變更自訂欄位：
  ...
  * 變更欄位大小
    ...
    只有當欄位是以下其中一種型別時，才能使用此功能：單行、段落、RTF文字
