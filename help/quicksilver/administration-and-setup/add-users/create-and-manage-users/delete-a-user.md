...
* 刪除該使用者與下列物件的關聯：
   ...
   * 儀表板
     ...
     >若要深入瞭解，請參閱[如何存取包含已刪除使用者所擁有之報告的儀表板？](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md#how)報告常見問題集[文章的](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md)區段。
