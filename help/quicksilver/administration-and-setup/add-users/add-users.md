...
title: 新增使用者概觀
description: 您可以從草稿開始建立個別使用者，或複製現有使用者，借此在Adobe Workfront中新增使用者。
author: Caroline
...
* [新訪問級別如何工作](/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/access-levels-toc.md)
...
* [建立和管理團隊](../../administration-and-setup/add-users/create-and-manage-teams/create-and-manage-teams.md)