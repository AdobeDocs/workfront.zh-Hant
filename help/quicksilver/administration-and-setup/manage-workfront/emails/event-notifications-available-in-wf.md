...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>問題指派</p> </td> 
   <td> <p>問題受指派的使用者</p> </td> 
   <td> <p>我被指派到一個問題。</p> <p>僅當專案狀態為「目前」且問題狀態不是「已關閉」或等同於「已關閉」的狀態時，問題受指派人才會收到電子郵件通知。</p> <p>擁有「檢閱」或「請求」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>問題</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>任務指派</p> </td> 
   <td> <p>任務指派到的使用者</p> </td> 
   <td> <p>我被設為一項任務的主要受指派人。</p> <p>如果工作受指派人是工作的主要受指派人，則受指派人會收到電子郵件通知，除非受指派人是進行指派的使用者。</p> <p>如果專案狀態為「目前」且任務未標籤為「完成」，則會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>任務</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>時程表拒絕</p> </td> 
   <td> <p>時間表所屬的使用者</p> </td> 
   <td> <p>我的時程表已拒絕。</p> <p>時程表所有者會在時程表被拒絕時收到電子郵件通知，除非拒絕時程表的使用者也是所有者。</p> <p>只有在時程表狀態為「已拒絕」時，才會傳送電子郵件通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>時程表</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>工作專案請求</p> </td> 
   <td> <p>要求專案的團隊成員</p> </td> 
   <td> <p>我的團隊獲得新的工作請求。</p> <p>當團隊收到新的工作請求時，團隊成員會收到電子郵件通知。 （提交請求的使用者若是團隊成員，則不會收到通知。）</p> <p>只有在發出「工作請求」時專案狀態為「目前」，且「工作請求」狀態為「新建」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>啟用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>指派</p> </td> 
   ...
   <td> <p>我得到一個新工作要求。</p> <p>工作專案的受指派人會收到電子郵件通知，除非提出請求的使用者同時也是受指派人。 </p> <p>如果任務狀態為「完成」或問題狀態為「已關閉」，則不會傳送通知。</p> <p>只有在請求時的專案狀態為「目前」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>啟用中</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>我的任務之所有前置任務已完成。</p> <p>任務受指派人會收到電子郵件通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>問題</p> </td> 
   <td> <p>核准決定</p> </td> 
   <td> <p>問題受指派的使用者</p> </td> 
   <td> <p>我解決的問題已核准或已拒絕。</p> <p>當做出核准決定（核准或拒絕）時，問題的受分派者會收到電子郵件通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>任務</p> </td> 
   <td> <p>核准決定</p> </td> 
   <td> <p>任務指派到的使用者</p> </td> 
   <td> <p>我完成的任務已核准或已拒絕。</p> <p>當任務被核准或拒絕時，任務受指派人會收到電子郵件通知。</p> <p>只有在專案狀態為「目前」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>問題</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>問題狀態變更</p> </td> 
   <td> <p>問題受指派的使用者</p> </td> 
   <td> <p>我的工作專案之一的狀態變更。</p> <p>除非變更狀態的使用者也是受指派人，否則問題的受指派人會在狀態變更時收到電子郵件通知。</p> <p>只有在專案狀態為「目前」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>啟用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>文件</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>檔案新增</p> </td> 
   <td> <p>專案所有者</p> </td> 
   <td> <p>向我持有的專案新增一個檔案。</p> <p>除非新增檔案的使用者也是專案所有者，否則當檔案新增至專案時，專案所有者會收到電子郵件通知。</p> <p>只有在專案狀態為「目前」且檔案不是「私人」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>問題</p> </td> 
   <td> <p>問題新增</p> </td> 
   <td> <p>專案所有者</p> </td> 
   <td> <p>向我持有的專案新增了一個問題。</p> <p>將問題新增到專案時，專案所有者會收到電子郵件通知。</p> <p>僅當專案狀態為「目前」或「計畫」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>問題</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>問題完成</p> </td> 
   <td> <p>專案所有者</p> </td> 
   <td> <p>在我持有的專案上完成了一個問題。</p> <p>專案所有者會收到電子郵件通知。</p> <p>僅當專案狀態為「目前」或「計畫」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>任務</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>未指派問題新增</p> </td> 
   <td> <p>專案所有者</p> </td> 
   <td> <p>向我持有的專案新增未指派問題。</p> <p>當未指派的問題新增到專案時，專案所有者會收到電子郵件通知。</p> <p>僅當專案狀態為「目前」或「計畫」時，才會傳送通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>專案使用者新增</p> </td> 
   <td> <p>資源擁有者</p> </td> 
   <td> <p>我的一名人員已新增至專案。</p> <p>當經理的其中一個直接下屬新增至專案時，經理會收到電子郵件通知。</p> <p>擁有「檢閱」授權的使用者不會收到通知。</p> </td> 
   <td> <p>停用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>專案</p> </td> 
...
| 物件類型 | 事件 | 收件人 | 說明 | 預設狀態 |
|------------------|------|---------------------------------------------|--------------------------------------------------------------|---------------|
| 任務和問題 | 任務和問題委派 | 受託人 | 我委派了我的任務和問題 (確認) | 啟用中 |
| 任務和問題 | 停止任務和問題委派 | 受託人 | 我停止委派我的任務和問題 (確認) | 啟用中 |
| 任務和問題 | 任務和問題委派 | 委派 | 有人將其任務和問題委派給我 | 啟用中 |
| 任務和問題 | 停止任務和問題委派 | 委派 | 有人停止將其任務和問題委派給我 | 啟用中 |
