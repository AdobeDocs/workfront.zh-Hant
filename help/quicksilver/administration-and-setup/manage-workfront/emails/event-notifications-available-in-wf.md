...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>目前專案狀態</p> </td> 
   <td> <p>指派團隊的成員</p> </td> 
   <td> <p>我的團隊所在的一個專案變為使用中專案。</p> <p>指派的Workfront團隊成員會在他們被指派使用的專案生效時收到電子郵件通知。</p> </td> 
   <td> <p>非使用中</p> </td> 
  </tr> 
  <tr> 
   <td> <p>專案使用者</p> </td> 
...
| 物件類型 | 活動 | 收件人 | 說明 | 預設狀態 |
|------------------|--------------------------------------------|-----------|--------------------------------------------------------------|-----------------------|
| 任務和問題 | 任務和問題委派 | 被指派者 | 我委派了我的任務和問題 (確認) | 使用中（僅即時） |
| 任務和問題 | 停止任務和問題委派 | 被指派者 | 我停止委派我的任務和問題 (確認) | 使用中（僅即時） |
