...
* 使用者擁有管理匯率存取權的計畫授權。
  ...
  如需詳細資訊，請參閱 [授予使用者管理特定區域的存取權](../../../administration-and-setup/add-users/configure-and-grant-access/grant-users-admin-access-certain-areas.md).

* Workfront系統啟用多種貨幣。

如需使用者如何變更指定專案預設貨幣的詳細資訊，請參閱 [變更專案貨幣](../../../manage-work/projects/project-finances/change-project-currency.md).
...
如需使用者如何變更指定工作角色預設貨幣的詳細資訊，請參閱 [建立和管理職位角色](../../../administration-and-setup/set-up-workfront/organizational-setup/create-manage-job-roles.md).
