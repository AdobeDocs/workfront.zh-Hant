...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td>Planning （必要狀態）</td> 
   <td> <p>專案經理正在規劃專案的時間表、任務指派及核准。 專案經理在專案上手動設定此狀態。</p> <p><b>秘訣</p> <p> 建議您在Workfront中為新專案設定預設狀態至Planning。 身為Workfront管理員，您可以在「專案偏好設定」的「專案」區域中變更所有新專案的預設狀態。</p> <p>如需詳細資訊，請參閱 <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md">設定全系統專案偏好設定</a>.</p></td> 
