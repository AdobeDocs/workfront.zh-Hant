...
1. 按一下![自訂使用者看到的內容](assets/dropdown-arrow.png)底下的向下箭頭&#x200B;**[!UICONTROL 向下箭頭]**，然後按一下您要自訂其左側面板的物件型別或[!DNL Workfront]區域的名稱。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td>[!UICONTROL 專案]</td> 
      <td>[！UICONTROL主功能表]中的專案<img src="assets/projects-in-main-menu.png"> <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL 專案]</td> 
     </tr> 
     <tr> 
      <td><span class="preview">[！UICONTROL資源]</span></td> 
      <td><span class="preview">[！UICONTROL主功能表中的[！UICONTROL Resourcing] <img src="assets/main-menu-icon-left-nav.png"></span></td> 
      <td><span class="preview">[！UICONTROL Planner] （無法隱藏）、[！UICONTROL工作負載平衡器]、[！UICONTROL使用率]、[！UICONTROL資源集區]</span></td> 
     </tr> 
     <tr> 
      <td>[！UICONTROL請求]</td> 
      <td>請求的名稱</td> 
     ...
     <tr> 
       <td><span class="preview">[！UICONTROL使用者詳細資訊]</span></td> 
       <td><span class="preview">使用者的名稱</span></td> 
       <td><span class="preview">[！UICONTROL詳細資訊]、[！UICONTROL組織圖]、[！UICONTROL休假]、[！UICONTROL自訂Forms]、[！UICONTROL業務設定檔]、[！UICONTROL更新]、[！UICONTROL工作負載平衡器]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[！UICONTROL速率卡]</span></td> 
       <td><span class="preview">費率卡的名稱</span></td> 
       <td><span class="preview">[！UICONTROL職位角色和費率]、[！UICONTROL費率卡片詳細資料]、[！UICONTROL費用型別和費率]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[！UICONTROL群組]</span></td> 
       <td><span class="preview">群組的名稱</span></td> 
       <td><span class="preview">[！UICONTROL群組成員]、[！UICONTROL子群組成員]、[！UICONTROL群組詳細資料]、[！UICONTROL專案偏好設定]、[！UICONTROL任務和問題偏好設定]、[！UICONTROL時程表和時數]、[！UICONTROL子群組]、[！UICONTROL狀態]、[！UICONTROL事件通知]、[！UICONTROL產品組合]、[！UICONTROL uicontrol專案]、[！UICONTROL專案]、[！UICONTROL模板]、[！UICONTROL最近刪除]、[！UICONTROL最近恢復]、[！UICONTROL批准]、[！UICONTROL公司]、[！UICONTROL團隊]、[！UICONTROL計畫]、[！UICONTROL時間表配置檔案]、[！UICONTROL佈局模板]</span></td> 
     </tr>
     <!--
      <tr> 
       <td>Company</td> 
