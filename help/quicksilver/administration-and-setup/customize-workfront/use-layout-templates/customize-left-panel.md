...
![專案的左側面板](assets/left-panel-in-project-072326.png)
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      <td>[！UICONTROL專案]</td> 
      <td>專案名稱</td> 
      <td>[！UICONTROL任務]， [！UICONTROL專案詳細資料]， [！UICONTROL業務案例]， [！UICONTROL更新]， [！UICONTROL檔案]， [！UICONTROL問題]， [！UICONTROL風險]， [！UICONTROL核准]， [！UICONTROL基準]， [！UICONTROL計費率]，[！UICONTROL計費資源]，[！UICONTROL uicontrol計費記錄]、[！UICONTROL費用]、[！UICONTROL小時數]、[！UICONTROL工作負載均衡器]、[！UICONTROL人員]、[！UICONTROL利用率]、[！UICONTROL隊列詳細資訊]、[！UICONTROL路由規則]、[！UICONTROL隊列主題]、[！UICONTROL主題組]、[！UICONTROL量度]、[！UICONTROL Planning]*、[！UICONTROL自定義應用程式]**</td> 
     </tr> 
     <tr> 
      <td>[！UICONTROL任務]</td> 
      <td>任務的名稱</td> 
     ...
     <tr> 
      <td>[!UICONTROL 專案]</td> 
      <td>[！UICONTROL主功能表]中的專案 <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL 專案]</td> 
     </tr> 
     <tr> 
      <td>[！UICONTROL資源]</td> 
      <td>[！UICONTROL主功能表中的[！UICONTROL Resourcing] <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[！UICONTROL Planner] （無法隱藏）、[！UICONTROL工作負載平衡器]、[！UICONTROL使用率]、[！UICONTROL資源集區]</td> 
     </tr> 
     <tr> 
      <td>[！UICONTROL請求]</td> 
      <td>請求的名稱</td> 
     ...
     <tr> 
       <td>[！UICONTROL使用者詳細資訊]</td> 
       <td>使用者的名稱</td> 
       <td>[！UICONTROL詳細資訊]、[！UICONTROL組織圖]、[！UICONTROL休假]、[！UICONTROL自訂Forms]、[！UICONTROL業務設定檔]、[！UICONTROL更新]、[！UICONTROL工作負載平衡器]</td> 
     </tr>
     <tr> 
       <td>[！UICONTROL速率卡]</td> 
       <td>費率卡的名稱</td> 
       <td>[！UICONTROL職位角色和費率] （不能隱藏），[！UICONTROL費率卡片詳細資料]</td> 
     </tr>
     <tr> 
       <td>[！UICONTROL群組]</td> 
       <td>群組的名稱</td> 
       <td>[！UICONTROL群組成員]、[！UICONTROL子群組成員]、[！UICONTROL群組詳細資料]、[！UICONTROL專案偏好設定]、[！UICONTROL任務和問題偏好設定]、[！UICONTROL時程表和時數]、[！UICONTROL子群組]、[！UICONTROL狀態]、[！UICONTROL事件通知]、[！UICONTROL產品組合]、[！UICONTROL uicontrol專案]、[！UICONTROL專案]、[！UICONTROL模板]、[！UICONTROL最近刪除]、[！UICONTROL最近恢復]、[！UICONTROL批准]、[！UICONTROL公司]、[！UICONTROL團隊]、[！UICONTROL計畫]、[！UICONTROL時間表配置檔案]、[！UICONTROL佈局模板]</td> 
     </tr>
     <!--
      <tr> 
       <td>Company</td> 
