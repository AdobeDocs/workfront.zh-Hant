...
1. 按一下&#x200B;**[!UICONTROL 自訂使用者看到的內容]**&#x200B;底下的向下箭頭![向下箭頭](assets/dropdown-arrow.png)，然後按一下您要自訂其左側面板的物件型別或[!DNL Workfront]區域的名稱。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td>[!UICONTROL 專案]</td> 
      <td>[!UICONTROL 主功能表]中的專案 <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL 專案]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL 資源]</td> 
      <td>&lbrack;！UICONTROL主功能表中的[!UICONTROL Resourcing] <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL Planner] （無法隱藏）、[!UICONTROL 工作負載平衡器]、[!UICONTROL 使用率]、[!UICONTROL 資源集區]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL 請求]</td> 
      <td>請求的名稱</td> 
     ...
     <tr> 
       <td>[!UICONTROL 速率卡]</td> 
       <td>費率卡的名稱</td> 
       <td>[!UICONTROL 職位角色和費率] （不能隱藏），[!UICONTROL 費率卡片詳細資料]</td> 
     </tr>
     <tr> 
       <td>[!UICONTROL 群組]</td> 
       <td>群組的名稱</td> 
       <td>[!UICONTROL 群組成員]、[!UICONTROL 子群組成員]、[!UICONTROL 群組詳細資料]、[!UICONTROL 專案偏好設定]、[!UICONTROL 任務和問題偏好設定]、[!UICONTROL 時程表和時數]、[!UICONTROL 子群組]、[!UICONTROL 狀態]、[!UICONTROL 事件通知]、[!UICONTROL 產品組合]、[!UICONTROL uicontrol專案]、[!UICONTROL 專案]、[!UICONTROL 模板]、[!UICONTROL 最近刪除]、[!UICONTROL 最近恢復]、[!UICONTROL 批准]、[!UICONTROL 公司]、[!UICONTROL 團隊]、[!UICONTROL 計畫]、[!UICONTROL 時間表配置檔案]、[!UICONTROL 佈局模板]</td> 
     </tr>
     <!--
      <tr> 
       <td>Company</td> 
