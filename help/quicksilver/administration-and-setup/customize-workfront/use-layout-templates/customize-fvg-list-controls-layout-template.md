...
1. 按一下向下箭頭 ![](assets/down-arrow-blue.png) 在 **自訂使用者看到的內容**，然後按一下 **清單** ，位於顯示的下拉式功能表中。
...
1. （選擇性）如果要變更版面配置範本的預設篩選、檢視或分組，請將滑鼠游標停留在篩選、檢視或分組上，然後按一下 **設定為預設**.
   ...
   * **分組**：無
   ...
   如需有關刪除篩選器、檢視和群組的資訊，請參閱 [建立、編輯和共用預設的篩選器、檢視和群組](../../../administration-and-setup/set-up-workfront/configure-system-defaults/create-and-share-default-fvgs.md).
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>清除或勾選您要隱藏或顯示的清單控制項旁的方塊。</p> <p>如果核取方塊變暗，則無法隱藏該清單控制項。 預設 <img src="assets/default-pill.png"> 每個清單控制項的設定會變暗，因為您無法隱藏目前設定為預設值的設定。</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">新增自訂清單控制項</td> 
      <td> <p> 
        <ol> 
         <li value="1"> 按一下 <strong>新增篩選器</strong>， <strong>新增檢視</strong>，或 <strong>新增群組</strong> 位於篩選、檢視或分組清單底部。 在顯示的方塊中，開始輸入先前為您的組織建立的現有自訂清單控制項名稱，然後在其出現時按一下該名稱。</li> 
         <li value="2"> 如果您想要將新的自訂清單控制項設定為版面配置範本的預設篩選、檢視或分組，請按一下 <strong>設定為預設</strong>. </li> 
         <li value="3"> <p>按一下 <strong>新增</strong> 完成後。</p> <p><b>注意</b>： <p>使用者可以將自訂清單控制項新增到自己的清單中。 如果您在版面配置範本中新增自訂清單控制項，您的清單控制項會新增，並移至面板底部；您的清單控制項不會取代它們的位置。</p> <p>如果您將使用者指派給具有自訂清單控制項的新版面配置範本，也會發生這種情況。 </p> <p>如需自訂清單控制項的詳細資訊，請參閱 <a href="../../../reports-and-dashboards/reports/reporting-elements/filters-overview.md" class="MCXref xref">篩選器概觀</a>， <a href="../../../reports-and-dashboards/reports/reporting-elements/views-overview.md" class="MCXref xref">Adobe Workfront中的檢視概觀</a>、和 <a href="../../../reports-and-dashboards/reports/reporting-elements/groupings-overview.md" class="MCXref xref">Adobe Workfront中的群組概觀</a>.</p> </p> </li> 
        </ol> </p> </td> 
     </tr> 
    </tbody> 
   </table>
