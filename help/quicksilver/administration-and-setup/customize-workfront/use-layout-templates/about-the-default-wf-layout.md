...
預設版面配置是主要功能表![主要功能表圖示](assets/main-menu-icon-left-nav.png)、左側面板的排列，以及Adobe Workfront管理員使用版面配置範本進行任何變更之前的檢視、群組和篩選器。
...
下表顯示預設的「主要功能表」專案，以及針對每種舊版授權型別所顯示的左側面板專案：

<table class="tg"><thead>
  <tr>
    <th class="tg-0lax"><span style="font-weight:bold">區域</span></th>
