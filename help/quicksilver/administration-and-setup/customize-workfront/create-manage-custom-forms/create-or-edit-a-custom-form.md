...
如需從現有表單建立新自訂表單的相關資訊，請參閱[複製自訂表單，以使用舊版表單產生器建立新表單](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/copy-custom-form-to-create-a-new-one.md)。

本文說明如何使用舊版表單產生器建立自訂表單。 如需使用表單設計工具建立自訂表單的相關資訊，請參閱[使用表單設計工具設計表單](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md)。
...
1. 在開啟的&#x200B;**表單設定**&#x200B;索引標籤上，輸入自訂表單的&#x200B;**表單標題**&#x200B;和選用的&#x200B;**描述**。

1. （選擇性）如果您想要新增更多物件型別至表單，以便附加至更多物件，請按一下&#x200B;**物件型別**&#x200B;後面的&#x200B;**加號**，然後在顯示的功能表中選取您想要的物件型別。

   您可以重複此步驟，新增任意數目的物件型別。

1. （選擇性）按一下物件型別上的&#x200B;**X**，將其從表單中刪除。
...
1. 如果您想要新增自訂欄位至表單，請繼續[新增自訂欄位至自訂表單](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md)或[重複使用自訂表單中的自訂欄位或Widget](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)。
...
>[!CAUTION]
>
>如需有關從自訂表單中移除欄位而不遺失使用者在這些欄位中輸入的資料的資訊，請參閱區段[移除自訂欄位而不遺失使用者在文章[從系統中刪除自訂欄位或Widget](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/delete-a-custom-field.md)中輸入的資料](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/delete-a-custom-field.md#remove)。
>
...
1. （選擇性）若要變更自訂表單的標題和說明，請按一下&#x200B;**表單設定**&#x200B;索引標籤，然後輸入&#x200B;**表單標題**&#x200B;和&#x200B;**說明**。

1. （選擇性）如果您想要將更多物件型別新增至表單，以便將其附加至更多物件，請按一下&#x200B;**物件型別**&#x200B;之後的加號+，然後在顯示的功能表中選取您想要的型別。
