...
* [使用 [!DNL Workfront] 舊聯結器 [!DNL Adobe Experience Manager] 設定](../../administration-and-setup/configure-integrations/configure-workfront-aem.md)
...
* [在 [!DNL Adobe Workfront] 為您的使用者建立 [!DNL Creative Cloud]] 封裝的[！UICONTROL [!DNL Adobe Admin Console]](/help/quicksilver/administration-and-setup/configure-integrations/create-plugin-only-packages.md)
