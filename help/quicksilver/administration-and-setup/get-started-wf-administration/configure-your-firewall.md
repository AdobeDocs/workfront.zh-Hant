...
如果您的防火牆或郵件伺服器設定為僅允許存取特定廠商，則必須將下列IP位址新增至您的允許清單，以接收來自Workfront應用程式的電子郵件。

#### 美國地區：叢集1、2、3、5、6、7、8、9和10
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!DNL Adobe Workfront Fusion] Microsoft Azure叢集上</td> 
   <td> 
    <ul> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!DNL Adobe Workfront Fusion] Microsoft Azure叢集上</p> </td> 
...
請參閱上面的[接收來自Workfront應用程式的電子郵件](#to-receive-email-from-the-workfront-application)一節。
