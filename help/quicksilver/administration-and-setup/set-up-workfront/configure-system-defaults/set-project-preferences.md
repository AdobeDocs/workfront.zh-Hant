...
<tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>為將處理專案的使用者設定自訂每年季度。 自訂季度通常是不符合日曆年度中傳統季度劃分的季度。 您可以新增多個自訂季度。 如需詳細資訊，請參閱<a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/enable-custom-quarters-projects.md" class="MCXref xref" data-mc-variable-override="">啟用自訂季度</a>。</p>  <p><b>附註</b>： </p><p>[!DNL Workfront] 管理員無法解鎖[！UICONTROL自訂季度]喜好設定。</p> </td> 
  </tr> 
 </tbody> 
</table>
