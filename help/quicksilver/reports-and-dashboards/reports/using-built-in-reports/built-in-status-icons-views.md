...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>表示專案狀態是符合目標（綠色）、有問題（紅色）或處於風險（黃色）。<br>如需專案狀態的詳細資訊，請參閱<a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref">專案狀態與狀態型別概觀</a>。</td> 
   <td>專案</td> 
   <td>按一下以開啟專案的任務清單。 </td> 
   <td> </td> 
  </tr> 
