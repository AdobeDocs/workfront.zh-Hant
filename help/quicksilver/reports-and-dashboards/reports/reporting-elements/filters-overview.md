...
![舊版篩選器產生器](assets/filter-statements-with-or-and-and-nwe.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>您正在篩選之物件的屬性。 </p> <p>例如，您可以依「Portfolio名稱」或「專案所有者」篩選。 在這種情況下，「名稱」和「擁有者」是Portfolio和「專案」物件的欄位。 </p> </td> 
  </tr> 
  <tr> 
