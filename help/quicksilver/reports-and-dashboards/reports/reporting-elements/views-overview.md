...
<tr>
        <td><strong>增強型檢視</strong></td>
        <td>增強型檢視是以增強型清單為基礎。 Workfront的部分割槽域已提供這些選項。 這些清單使用表格格式來顯示清單專案，並且它們具有與標準檢視或清單不同的外觀和感覺。 也增強了檢視管理，包括篩選、分組、管理欄和搜尋。 如需詳細資訊，請參閱<a href="/help/quicksilver/workfront-basics/navigate-workfront/use-lists/enhanced-lists.md">使用增強型清單</a></td>
       </tr>    
</table>
