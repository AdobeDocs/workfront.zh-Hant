...
title: '''檢視：解決物件詳細資料的問題'
description: 此問題視圖顯示問題的解決對象的名稱和完成百分比，使問題創作者能夠洞察問題的進展，即使不能訪問解決任務或項目。
...
此問題視圖顯示問題的解決對象的名稱和完成百分比，使問題創作者能夠洞察問題的進展，即使不能訪問解決任務或項目。
...
![issue_custom_view_with_resoling_object_name_and_percent_complete.png](assets/issue-custom-view-350x77.png)
