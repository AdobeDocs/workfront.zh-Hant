...
如需詳細資訊，另請參閱 [檢視：顯示任務和專案清單上的原始問題資訊](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md).
...
1. 前往任務清單或專案清單。
1. 從 **檢視** 下拉式功能表，選取 **新檢視**.

1. 在&#x200B;**欄預覽** 區域，排除所有欄，一個除外。
1. 按一下剩餘欄的標頭，然後按一下 **切換到文字模式**.
