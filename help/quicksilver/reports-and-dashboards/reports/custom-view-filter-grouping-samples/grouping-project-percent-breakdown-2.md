...
title: '''分組：項目百分比細分2'
description: '''在此自定義項目分組中，您可以顯示按項目完成百分比值範圍分組的項目。 細目顯示10%點增量的完成百分比值：0-10%、11-20%、21-30%等。'
...
在此自定義項目分組中，您可以顯示按項目完成百分比值範圍分組的項目。 細目顯示10%點增量的完成百分比值：0-10%、11-20%、21-30%等。
...
![percent_complete_blank_for_projects_in_10_increments.png](assets/percent-complete-breakdown-350x94.png)
