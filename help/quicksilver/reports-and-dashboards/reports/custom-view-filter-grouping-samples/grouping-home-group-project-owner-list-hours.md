...
title: '''分組：小時清單中的項目所有者的主組'
description: 您可以在「小時」清單或報告中顯示項目所有者的「主組」的名稱。
...
您可以在「小時」清單或報告中顯示項目所有者的「主組」的名稱。

分組還按項目所有者和項目名稱的名稱對結果進行分組。

![分組_for_project_owner_home_group_png](assets/grouping-for-project-owner-home-group-350x51.png)
