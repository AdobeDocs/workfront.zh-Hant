...
1. （選擇性）選取&#x200B;**自訂顏色**&#x200B;將您偏好的顏色指定給每個欄。\
   如需自訂圖表色彩的詳細資訊，請參閱[自訂圖表色彩](#customize-chart-colors)。

1. （選擇性）選取&#x200B;**以3D**&#x200B;顯示，以三維檢視顯示圖表。
...
1. （選擇性）選取&#x200B;**組合圖表**&#x200B;以在圖表中包含其他值，以及您希望如何摘要資訊。\
   請考量下列選項：
...
1. 開始新增圖表至您的報表，如[新增圖表至報表](#add-a-chart-to-a-report)中所述。
1. 在&#x200B;**底部(X) Axis**&#x200B;欄位中，選取要包含在圖表X軸上的值，以及要如何摘要資訊。
1. 在&#x200B;**左(Y)軸**&#x200B;欄位中，選取您要包含在圖表中的群組。
1. （選擇性）選取&#x200B;**自訂顏色**&#x200B;以自訂長條的顏色。\
   如需自訂圖表色彩的詳細資訊，請參閱[自訂圖表色彩](#customize-chart-colors)。

1. （選擇性）選取&#x200B;**以3D**&#x200B;顯示，以三維檢視顯示圖表。
1. （選擇性）選取&#x200B;**群組列**&#x200B;以定義您要如何群組列。\
   從下列選項中選取：
...
1. 在&#x200B;**底部(X)軸**&#x200B;欄位中，選取要包含在圖表中的群組。
1. （選擇性）選取顏色以自訂線條的顏色。
1. （選擇性）選取&#x200B;**群組線**，為圖表選取其他群組。\
   （選擇性）選取&#x200B;**自訂顏色**&#x200B;以自訂新群組的顏色。\
   如需自訂圖表色彩的詳細資訊，請參閱[自訂圖表色彩](#customize-chart-colors)。

1. （選擇性）選取&#x200B;**組合圖表**&#x200B;以用其他值組合您的線條。\
   請考量下列選項：

   * 選取您要包含在圖表中的值，以及您想要如何摘要資訊。
   * 選取&#x200B;**次要座標軸**&#x200B;的繪圖欄位，在圖表右側繪製資料。\
...
1. 開始新增圖表至您的報表，如[新增圖表至報表](#add-a-chart-to-a-report)中所述。
1. 在&#x200B;**值**&#x200B;欄位中，選取您要在報表上顯示的值，以及您想要如何摘要這些值。 如果您選取&#x200B;**記錄計數**，則顯示的值為報表的物件。
...
1. 在&#x200B;**值範圍**&#x200B;欄位中，指定值範圍及代表要在量測軌圖表中顯示之值的色彩。
1. （選擇性）按一下&#x200B;**新增其他值範圍**&#x200B;以新增其他值範圍至圖表。\
...
1. 開始新增圖表至您的報表，如[新增圖表至報表](#add-a-chart-to-a-report)中所述。
1. 在&#x200B;**左(Y)軸**&#x200B;欄位中，選取您要包含在圖表Y軸上的值。 值來自報表的檢視。 指定您要如何摘要資訊。
...
1. 在&#x200B;**泡泡顏色**&#x200B;欄位中，選取要以泡泡顏色表示的欄位。
   ...
   **泡泡顏色**&#x200B;可以是您在報告中定義的群組，但只有當您在&#x200B;**泡泡**&#x200B;欄位中為報告的物件選取&#x200B;**Name**&#x200B;欄時，才能使用它。

   例如，如果您在任務報告中選取&#x200B;**任務名稱**，您可以新增&#x200B;**任務狀態**&#x200B;作為&#x200B;**泡泡顏色**&#x200B;欄位。

   ![](assets/bubbles-field-correct-can-select-bubbles-color-example.png)

   不過，如果您為&#x200B;**泡泡圖**&#x200B;欄位選取&#x200B;**任務狀態**，則無法選取&#x200B;**泡泡圖**&#x200B;欄位。 此外，您無法針對&#x200B;**泡泡顏色**&#x200B;欄位選取&#x200B;**專案名稱**，即使您針對&#x200B;**泡泡顏色**&#x200B;欄位選取&#x200B;**任務名稱**&#x200B;亦然。
