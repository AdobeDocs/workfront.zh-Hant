...
1. [!DNL Workfront]執行個體中必須有自訂日期欄位和可用欄位中的值。 如果您沒有設定自訂日期的自訂表單，請依照[建立或編輯自訂表單](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md)的前兩個區段中的指示操作。
