...
1. 首先，使用新增視覺效果區塊 **欄** 報表的視覺效果型別，如中所述 [在報告畫布中新增或編輯視覺效果區塊](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md).
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td><p>選取您要沿著欄視覺效果的水準或X軸描繪的資料。 視覺效果會根據垂直軸上的每個專案比較此軸上的專案。</p></td>
        </tr>
        <tr>
         <td role="rowheader">垂直軸</td>
         <td><p>在左側下拉式選單中，選取您要沿著水平軸或Y軸描繪的資料。 視覺效果會根據專案的值，將這個軸上的專案顯示為比較欄。</p><p>在右側的下拉式功能表中，選取您希望如何在顯示中計算這些值：</p>
          <ul>
