...
在建置圖表報告之前，您必須先建立儀表板。 如需詳細資訊，請參閱[建立畫布控制面板](/help/quicksilver/reports-and-dashboards/canvas-dashboards/create-dashboards/create-dashboards.md)。
...
1. （選擇性）在&#x200B;**圓形圖**&#x200B;區段中，將&#x200B;**顯示區段標籤**&#x200B;切換為開啟，以顯示區段標籤。
1. （選擇性）將&#x200B;**顯示總計**&#x200B;切換為開啟，以在圖表中間顯示總計。 啟用時，還有其他選項可顯示中心標籤並選擇值格式。
...
1. （選擇性）在[圖例]區段中，將&#x200B;**顯示圖例**&#x200B;切換為開啟，以顯示圖表圖例。

1. （選擇性）從下拉式功能表中選擇&#x200B;**圖例位置**。
