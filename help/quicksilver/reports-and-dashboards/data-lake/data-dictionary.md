...
<table>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>文件核准</td>
        <td>多卡普爾 |檔審批</td>
        <td><br>DOCAPPROVALS_CURRENT DOCAPPROVALS_DAILY_HISTORY<br>DOCAPPROVALS_EVENT</td>
        <td></td>
        <td>APPROVERID<br>DOCAPPROVALID （self）<br>DOCUMENTID<br>NOTEID<br>REQUESTORID<br>SYSID</td>
        <td>USERS_CURRENT |使用者ID  <br>自<br>DOCUMENTS_CURRENT |文件識別<br>NOTES_CURRENT |<br>註釋 ID USERS_CURRENT |USERID  <br>不是關係;用于內部應用程式目的</td>
    </tr>
    <tr>
        <td>文件資料夾</td>
        <td>文件資料夾</td>
    ...
    <tr>
        ...
        <td>費用類型</td>
        <td>EXPTYP | 費用型別</td>
        <td><br>EXPENSETYPES_CURRENT EXPENSETYPES_DAILY_HISTORY<br>EXPENSETYPES_EVENT</td>
        <td></td>
    ...
    <tr>
        ...
        <td>小時</td>
        <td>小時 |小時</td>
        <td><br>HOURS_CURRENT HOURS_DAILY_HISTORY<br>HOURS_EVENT</td>
        <td></td>
        ...
        <td>USER_CURRENT |使用者ID BILLINGRECORDS_CURRENT<br>|比林記錄ID<br>CATEGORIES_CURRENT |CATEGORYID<br>分類器表 目前<br>不支持 不是關係;用於內部應用程式目的<br>EXCHANGERATES_CURRENT |EXCHANGERATEID<br>不是工作前沿關係;用於與外部系統<br>集成 自我<br>HOURTYPE_CURRENT |小時類型ID<br>USER_CURRENT |使用者ID OPTASK_CURRENT<br>|OPTASKID<br>USER_CURRENT |使用者ID PROJECT_CURRENT<br>|投影 ID<br>不是關係;用于內部應用程式目的<br>ROLE_CURRENT |角色 ID<br>TASK_CURRENT |任務 ID<br>TIMESHEET_CURRENT |TIMESHEETID</td>
    </tr>
    <tr>
        <td>時數類型</td>
        <td>時數類型</td>
    ...
    <tr>
        ...
        <td>物件整合</td>
        <td>OBJINT |物件整合</td>
        <td><br>OBJECTINTEGRATION_CURRENT OBJECTINTEGRATION_DAILY_HISTORY<br>OBJECTINTEGRATION_EVENT</td>
        <td></td>
        <td>LINKEDOBJECTID<br>OBJECTINTEGRATIONID （self）<br>OBJID  <br>SYSID  </td>
        <td>在LINKEDOBJECTCODE欄位中  <br>標識的物件ID self<br>在 OBJCODE 字段中  <br>標識的物件ID不是關係;用於內部應用程式目的  </td>
    </tr>
    <tr>
        <td>物件類別</td>
        <td>物件類別</td>
    ...
    <tr>
        ...
        <td>專案組合</td>
        <td>連線埠 | Portfolio</td>
        <td><br>PORTFOLIOS_CURRENT PORTFOLIOS_DAILY_HISTORY<br>PORTFOLIOS_EVENT PORTFOLIOS_CUSTOM_VALUE_CURRENT<br><br>PORTFOLIOS_CUSTOM_VALUE_DAILY_HISTORY<br>PORTFOLIOS_CUSTOM_VALUE_EVENT</td>
        <td></td>
    ...
    <tr>
        ...
        <td></td>
        <td>APPGLOBALID<br>PPREFERENCESID （self）  <br>SYSID  </td>
        <td>不是關係;用於內部應用程式目的<br>自我  <br>不是關係;用於內部應用程式目的  </td>
    </tr>
    <tr>
        <td>方案</td>
        <td>方案</td>
    ...
    <tr>
        ...
        <td><br>RICHTEXTPARAMETERVALUES_CURRENT RICHTEXTPARAMETERVALUES_DAILY_HISTORY<br>RICHTEXTPARAMETERVALUES_EVENT</td>
        <td></td>
