...
* 您必須先安裝[!DNL Adobe Workfront for design and video]，才能從[!DNL Illustrator]上傳檔案。
...
>[!NOTE]
>
>如果檔案匯出為文字檔案，您可能需要在[!DNL Adobe Illustrator]中重設您的偏好設定。
>
>1. 在[!DNL Illustrator]中，按一下&#x200B;**[!UICONTROL 編輯]**&#x200B;索引標籤，然後選取&#x200B;**[!UICONTROL 偏好設定]**。
>1. 選取&#x200B;**[!UICONTROL 一般]**。
