...
&#42;若要瞭解您擁有的計畫、角色或校訂許可權設定檔，請聯絡您的 [!DNL Workfront] 或 [!DNL Workfront Proof] 管理員。

## 必要條件

* 您必須安裝 [!DNL Adobe Workfront for design and video] 上傳校樣之前，從 [!DNL Illustrator].
