...
description: 您可以從Marketplace安裝Adobe Workfront for Photoshop外掛程式。
author: Courtney
...
* 您必須安裝 [!DNL Adobe Photoshop] 安裝應用程式之前 [!DNL Workfront] 外掛程式。
...
1. 在 **[!UICONTROL 外掛程式面板]**，選擇 **[!UICONTROL 外掛程式]** 標籤和查找 **[!UICONTROL Workfront for Adobe Photoshop]**.

   >[!TIP]
   >
   >   如果您在從 [!UICONTROL 外掛程式面板]，可能是Photoshop應用程式的背後。 嘗試將Photoshop最小化以尋找外掛程式。
...
1. 返回 [!UICONTROL Adobe Photoshop] 看看你的作品。
