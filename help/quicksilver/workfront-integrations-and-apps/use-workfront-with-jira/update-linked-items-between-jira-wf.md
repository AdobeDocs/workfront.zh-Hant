...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[！UICONTROL問題名稱]</p> <p>有關名稱變更的註解已新增至[!DNL Jira]問題的<strong>[!DNL Workfront]</strong>索引標籤。 </p> </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL問題或任務說明]</td> 
   <td> <p> [！UICONTROL問題說明]</p> <p>有關已更新說明的註解已新增至[!DNL Jira]問題的<strong>[!DNL Workfront]</strong>索引標籤。<br></p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>[！UICONTROL附件]</p> <p>已上傳附件的相關註解已新增至[!DNL Jira]問題的<strong>[!DNL Workfront]</strong>索引標籤。<br></p> </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL計畫完成日期]</td> 
   <td> <p>[！UICONTROL到期日期]</p> <p>有關[！UICONTROL到期日]已變更的註解已新增至[!DNL Jira]問題的[!DNL Workfront]索引標籤。 </p> <p>注意：您必須針對您的[!DNL Jira]問題啟用<strong>[！UICONTROL到期日]</strong>，才能在[！UICONTROL Jira]中看到此欄位已更新。 </p> </td> 
  </tr> 
  <tr> 
   <td>自訂Forms和自訂欄位</td> 
  ...
  <tr> 
   ...
   <td>顯示在[!DNL Jira]問題的[!DNL Workfront]右側面板中。 <br>它不會更新[!DNL Jira]中的問題<strong>[！UICONTROL優先順序]</strong>欄位。 </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL記錄時間] </td> 
   <td> <p>有關記錄時間的註解已新增到[!DNL Jira]問題的<strong>[!DNL Workfront]</strong>索引標籤中。 這包括記錄時間的使用者名稱，以及記錄時間的使用者名稱（如果不同）。 [!DNL Jira]中的<strong>[！UICONTROL工作記錄檔]</strong>索引標籤未記錄任何時間。<br></p> </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL註解]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>時數<br>除了將登入Jira的時數新增至連結的[!DNL Workfront]專案外，有關登入時間的註解也會新增至[!DNL Workfront]專案的[！UICONTROL更新]索引標籤。</p> <p>如需有關連結[!DNL Jira]問題的記錄時間的詳細資訊，包括更新在[!DNL Workfront]中記錄時間的[!DNL Jira]使用者，請參閱連結[!DNL Jira]和[!DNL Workfront]專案的<a href="#log-time-for-linked-jira-and-workfront-items" class="MCXref xref">記錄時間</a>。</p> </td> 
  </tr> 
  <tr> 
   <td> 註解 <br><br></td> 
