...
核准是指舊版檔案核准。 [!DNL Microsoft Teams]目前不支援整合檔案核准。 如需Workfront中不同核准系統的詳細資訊，請參閱[檔案核准的可用功能](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)。
