...
1. 請考慮檢閱下列有關專案的額外資訊：
   ...
   * **[!UICONTROL Portfolio]**&#x200B;名稱：如需投資組合的詳細資訊，請參閱[瞭解投資組合方法](../../manage-work/portfolios/portfolios-overview/portfolio-overview.md)。
...
1. （選擇性）按一下工作名稱，在新的瀏覽器分頁中於[!DNL Workfront]開啟工作。
1. 請考慮檢閱下列有關工作的其他資訊：
