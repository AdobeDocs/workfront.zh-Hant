...
根據您的組織是否在AdobeUnified Shell，變更設定檔設定的程式會有所不同。

* [變更Unified Shell上的設定檔設定](#change-profile-settings-on-the-unified-shell)
* [在沒有Unified Shell的情況下變更設定檔設定](#change-profile-settings-without-the-unified-shell)

### 變更Unified Shell上的設定檔設定

如果您的組織在AdobeUnified Shell，您可以按一下頂端導覽區域中的個人資料圖片，存取個人資料和偏好設定選項。
