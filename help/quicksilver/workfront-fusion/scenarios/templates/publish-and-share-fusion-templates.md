...
## Publish和[!DNL Adobe Workfront Fusion]範本

1. 在左側導覽面板中，按一下&#x200B;**[!UICONTROL 範本]**。
1. 按一下「**[!UICONTROL 團隊範本]**」標籤。
1. 按一下範本的名稱。
1. 按一下畫面右上角的&#x200B;**[!UICONTROL Publish]**&#x200B;按鈕。
...
1. （視條件而定）如果您想要分享連結，請按一下&#x200B;**[!UICONTROL 分享公用連結]**。
   ...
   >[!NOTE]
   >
   >您可以與任何人共用此連結。 範本本身保留在[!UICONTROL 團隊範本]標籤中，不是公開的。

1. （視條件而定）如果您希望範本成為公開範本，請按一下&#x200B;**[!UICONTROL 要求核准]**，將其傳送給您的管理員以進行核准。

   >[!NOTE]
   >
   >* 範本一經核准，就會成為公開範本。 [!UICONTROL 公用範本]會顯示在所有[!DNL Workfront Fusion]使用者的[!UICONTROL 公用範本]標籤中，無論組織或團隊為何。
...
* **眼睛圖示**：範本已發佈，僅團隊能看見，而且未傳送核准要求。
* **黃色核取記號圖示**：範本已發佈，僅團隊能看見，且已傳送核准要求。
* **綠色核取記號圖示**：範本已發佈並公開。 在[!UICONTROL 公用範本]索引標籤中，任何Workfront Fusion使用者都可以看到它。 它仍會顯示在[!UICONTROL 團隊範本]標籤中，而且範本作者或其團隊成員仍可編輯它。
