...
在 [!DNL Adobe Workfront Fusion] 情境下，您可以自動化使用下列專案的工作流程： [!DNL OneDrive]，以及將其連線到多個協力廠商應用程式和服務。
...
當您設定 [!DNL OneDrive] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL OneDrive] 視您在應用程式或服務中的存取層級等因素而定，可能會顯示欄位。 模組中的粗體標題表示必填欄位。
  ...
  <tr> 
   ...
   <td> <p>選取您要如何監視檔案或資料夾：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL依更新時間]</b> </p> <p>留意更新的現有檔案或資料夾。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>選取您要觀看的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取您要模組觀看的SharePoint網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取您要模組觀看其磁碟機的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL選擇專案型別]</td> 
   <td> <p>選取您要監視檔案、資料夾或兩者。</p> <p>注意：您無法監視[！UICONTROL與我共用]磁碟機中的資料夾。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>選取您要搜尋的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的磁碟機]</b> </p> <p>選取是否啟用模組以輸入磁碟機ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>輸入您要模組搜尋的磁碟機ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> <p>導覽至您要模組搜尋的資料夾。 您也可以輸入查詢來篩選傳回的結果。</p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL與我共用]</b> </p> <p>模組會搜尋已與該磁碟機擁有者共用的檔案。</p> </li> 
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 您希望模組搜尋的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取您要搜尋模組之磁碟機的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL選擇專案型別]</td> 
   <td> <p>選取您要搜尋檔案、資料夾或兩者。</p> <p>注意：您無法在[！UICONTROL Shared With Me]磁碟機中搜尋資料夾。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL限制]</td> 
   <td> <p>輸入或對應您希望模組在每個案例執行週期內傳回的最大記錄數。</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何輸入檔案ID或檔案路徑：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL手動輸入]</b> </p> <p>如果您想要直接輸入ID或路徑，或是從先前的模組進行對應，請選取此選項。</p> </li> 
     <li> <p><b>[！UICONTROL從清單中選取]</b> </p> <p>如果您想要從可用檔案或路徑清單中選取，請選取此選項。 </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL選擇您的 [!DNL OneDrive] 位置]</td> 
   <td> <p>選取您要搜尋的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取包含您要取得之檔案的SharePoint網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要取得之檔案的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要取得之檔案的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>選取您要包含要下載之檔案的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的磁碟機]</b> </p> <p>選取是否啟用模組以輸入磁碟機ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>輸入包含您要下載之檔案的磁碟機ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取包含您要下載之檔案的SharePoint網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要下載之檔案的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要下載之檔案的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL檔案] / [！UICONTROL檔案識別碼] / [！UICONTROL檔案路徑]</td>
   <td> <p>如果您選取[！UICONTROL Enter Manually]，請輸入或對應您要下載之檔案的檔案ID或路徑。</p> <p>如果您選取了[！UICONTROL從清單中選取]，請選取您要下載的檔案。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL轉換為PDF]</td> 
   <td> <p>啟用此選項可將檔案轉換為PDF檔案。 您可以從下列檔案型別轉換：</p> 
    <table style="table-layout:auto"> 
     <col> 
     <col> 
     <col> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要上傳檔案的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 包含您要上傳檔案之資料夾的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要上傳檔案之資料夾的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取包含您要上傳檔案之資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL，如果存在同名檔案]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要建立資料夾的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 您要建立資料夾的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取擁有您要建立資料夾之驅動程式的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取您要建立資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL，如果存在同名資料夾]</td> 
   <td>選取當同名檔案已存在時如何繼續。</td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>選取您要擷取共用連結的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取包含您要擷取共用連結之檔案的SharePoint網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要擷取共用連結之檔案的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要擷取共用連結之檔案的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL檔案] / [！UICONTROL檔案識別碼] / [！UICONTROL檔案路徑]</td> 
   <td> <p>如果您選取[！UICONTROL Enter Manually]，請輸入或對應您要擷取共用連結的檔案ID或路徑。</p> <p>如果您從清單中選取[！UICONTROL選取]，請選取您要擷取共用連結的檔案。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取包含您要移動之檔案或資料夾的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 包含您要移動之檔案或資料夾的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要移動之檔案或資料夾的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要移動之檔案或資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>如果您選取[！UICONTROL Enter Manually]，請輸入或對應您要移動之檔案或資料夾的ID或路徑。</p> <p>如果您從清單中選取[！UICONTROL選取]，請選取您要移動的檔案或資料夾。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>選取您要移動檔案或資料夾的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 您要移動檔案或資料夾的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取您要移動檔案或資料夾至其磁碟機的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要移動檔案或資料夾之資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> <p>如果您將此專案留空，則檔案或資料夾只能在同一檔案或資料夾中移動 [!DNL OneDrive].</p> <p>您可以將檔案和資料夾從[！UICONTROL My Drive]移動到[！UICONTROL Site's Drive]或[！UICONTROL Group's Drive]。 </p> <p>您只能將檔案從[！UICONTROL網站的磁碟機]移動到相同網站的相同磁碟機。</p> <p>您只能將檔案從[！UICONTROL群組的磁碟機]移動到相同群組中的相同磁碟機。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL資料夾]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取包含您要複製之檔案的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取包含您要移動之檔案的SharePoint網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要複製之檔案的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要複製之檔案的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p role="rowheader">[！UICONTROL檔案] / [！UICONTROL檔案識別碼] / [！UICONTROL檔案路徑]</p> </td> 
   <td> <p>如果您選取[！UICONTROL Enter Manually]，請輸入或對應您要複製的檔案ID或路徑。</p> <p>如果您從清單中選取[！UICONTROL選取]，請選取您要複製的檔案。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL輸入新資料夾位置]</td> 
   <td> <p>選取您要如何輸入複製檔案的位置，或：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL手動輸入]</b> </p> <p>如果您想要直接輸入ID或路徑，或是從先前的模組進行對應，請選取此選項。</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>選取您要複製檔案管理員的位置。 如果您選擇從清單中選取新資料夾位置，即可使用此選項。</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的磁碟機]</b> </p> <p>選取是否啟用模組以輸入磁碟機ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>輸入您要複製檔案的磁碟機識別碼。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 您要複製檔案的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取您要複製檔案的磁碟機群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要複製檔案之資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> <p>如果您將此保留為空白，則檔案或資料夾只能在相同的[！UICONTROL OneDrive]中複製。</p> <p>您可以將檔案和資料夾從[！UICONTROL我的磁碟機]複製到[！UICONTROL網站的磁碟機]或[！UICONTROL群組的磁碟機]。 </p> <p>您只能將檔案從[！UICONTROL網站的磁碟機]複製到相同網站的相同磁碟機。</p> <p>您只能將檔案從[！UICONTROL群組的磁碟機]複製到相同群組中的相同磁碟機。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL資料夾]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要搜尋的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL網站磁碟機]</b> </p> <p>選取 [!DNL SharePoint] 包含您要刪除之檔案或資料夾的網站。 可用網站是登入使用者後跟的網站。</p> </li> 
     <li> <p><b>[！UICONTROL Group's Drive]</b> </p> <p>選取其磁碟機包含您要刪除之檔案或資料夾的群組。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL磁碟機ID]</td> 
   <td> <p>選取或對應包含您要刪除之檔案或資料夾的磁碟機。 如果您在[！UICONTROL啟用以輸入磁碟機ID]欄位中選取[！UICONTROL否]，則無法使用此欄位。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">選取[！UICONTROL檔案/資料夾]</td> 
   <td>選取您要刪除檔案還是資料夾。</td> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL檔案] / [！UICONTROL檔案識別碼] / [！UICONTROL檔案路徑]</td>
   <td> <p>如果您選取[！UICONTROL Enter Manually]，請輸入或對應您要刪除之檔案的檔案ID或路徑。</p> <p>如果您從清單中選取[！UICONTROL選取]，請選取您要刪除的檔案。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 上傳的檔案太大，超過您的檔案大小上限。 [!DNL OneDrive] 計畫或您已使用所有 [!DNL OneDrive] 帳戶的儲存配額。 若要取得更多儲存空間，請從刪除現有檔案 [!DNL OneDrive] 或升級您的 [!DNL OneDrive] 帳戶。
* OneDrive不允許將兩個同名檔案上傳至單一資料夾。 如果目標資料夾包含與正在上傳的檔案同名的檔案，則案例執行會以錯誤終止。 解決方案是直接重新命名要上傳的檔案。 如果您的目的是更新檔案，請使用 [!UICONTROL 更新檔案] 動作。
* 先前選取的資料夾（檔案將上傳至該資料夾）已不存在。 此情境會停止，您將需要再次選取目標資料夾。
