...
>本文資訊可在以下文章中找到：
>
>* [通用聯結器](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/apps-and-modules-toc.html#universal-connectors)
>
>請更新任何書籤。
>
>本文已不再更新，將於不久將來移除。
...
* [在 [!DNL Adobe Workfront Fusion]的HTTP模組中使用雙向TLS](../../../workfront-fusion/apps-and-their-modules/http-modules/use-mtls-in-http-modules.md)
