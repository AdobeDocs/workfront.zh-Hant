...
如需[!UICONTROL Adobe Workfront Fusion]授權的相關資訊，請參閱[Adobe Workfront Fusion授權](../../../workfront-fusion/get-started/license-automation-vs-integration.md)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>使用此選項來設定錯誤處理。</p> <p>如需詳細資訊，請參閱Adobe Workfront Fusion中的<a href="../../../workfront-fusion/errors/error-handling.md" class="MCXref xref">錯誤處理</a>。</p> </td> 
  </tr> 
  <tr> 
