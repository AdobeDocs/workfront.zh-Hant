...
>本文資訊可在以下文章中找到：
>
>* [在Adobe Workfront Fusion的HTTP模組中使用雙向TLS](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/use-mtls-in-http-modules.html)
>
>請更新任何書籤。
>
>本文已不再更新，將於不久將來移除。
