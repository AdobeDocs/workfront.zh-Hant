...
title: ServiceNow模組
description: 在 [!DNL Adobe Workfront Fusion] 情境下，您可以自動化使用下列專案的工作流程： [!DNL ServiceNow]，以及將其連線到多個協力廠商應用程式和服務。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 情境下，您可以自動化使用下列專案的工作流程： [!DNL ServiceNow]，以及將其連線到多個協力廠商應用程式和服務。
...
使用 [!DNL ServiceNow] 模組，您必須擁有 [!DNL ServiceNow] 帳戶。

## Connect [!DNL ServiceNow] 至 [!DNL Workfront Fusion]

若要為建立連線，請執行下列步驟： [!DNL ServiceNow] 模組：

1. 按一下 **[!UICONTROL 新增]** 旁邊 [!UICONTROL 連線] 方塊(當您開始設定第一個 [!DNL ServiceNow] 模組。
1. 輸入下列內容：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>輸入新專案的名稱 [!DNL ServiceNow] 連線</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>輸入您的電子郵件地址 [!DNL ServiceNow] 帳戶不含 <code>https://</code> (通常 <code>&lt;company>.service-now.com</code>)。</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
當您設定 [!DNL ServiceNow] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL ServiceNow] 視您在應用程式或服務中的存取層級等因素而定，可能會顯示欄位。 模組中的粗體標題表示必填欄位。
...
>[!NOTE]
>
>如果在「」中選取自訂記錄[!UICONTROL 記錄型別]」欄位，載入自訂欄位可能需要一些時間。
>
>如果沒有自訂記錄，下拉式清單將是空的。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>如需有關將ServiceNow帳戶連線至的說明 [!DNL Workfront Fusion]，請參閱 <a href="#connect-servicenow-to-workfront-fusion" class="MCXref xref">Connect [!DNL ServiceNow] 至[！UICONTROL Workfront Fusion]</a> 本文章內容。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL資料表型別]</td> 
   <td>選取您要觀看的表格是自訂表格還是標準表格。</td> 
  </tr> 
  <tr> 
...
此動作模組可讓您對 [!DNL ServiceNow] API。 如此一來，您就可以建立其他人無法完成的資料流程自動化 [!DNL ServiceNow] 模組。
...
此動作模組會讀取 [!DNL ServiceNow] 使用系統ID來記錄。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>輸入或對映唯一的 [!DNL ServiceNow] 您希望模組讀取的記錄ID。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL資料表型別]</td> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL記錄型別]</td> 
   <td>選取型別 [!DNL ServiceNow] 您希望模組讀取的記錄。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL顯示]</td> 
   <td>選取您要顯示的值型別。</td> 
...
此動作模組在中停用使用者 [!DNL ServiceNow] 使用系統ID。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 輸入或對映唯一的 [!DNL ServiceNow] 您希望模組停用的使用者ID。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 輸入或對映唯一的 [!DNL ServiceNow] 您希望模組下載的附件ID。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>輸入或對映唯一的 [!DNL ServiceNow] 您要上傳附件的系統ID。</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL記錄型別]</td> 
   <td>選取型別 [!DNL ServiceNow] 您要模組建立的記錄。 然後，您可以填寫此記錄型別的可用欄位。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL記錄系統ID]</td> 
   <td>輸入或對映唯一的 [!DNL ServiceNow] 您要模組更新的記錄ID。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL資料表型別]</td> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL記錄型別]</td> 
   <td>選取型別 [!DNL ServiceNow] 記錄您希望模組更新的內容。 然後，您可以填寫此記錄型別的可用欄位。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL系統ID]</td> 
   <td>輸入或對映唯一的 [!DNL ServiceNow] 您要模組刪除的記錄ID。</td> 
  </tr> 
 </tbody> 
</table>
   ...
   <td> <p>選取您希望模組執行的搜尋型別</p> 
    <ul> 
     <li> <p><strong>[！UICONTROL進階查詢]</strong> </p> 
      <ul> 
       <li> <p>[！UICONTROL搜尋查詢]</p> <p>輸入自訂搜尋查詢。 有關以下專案的資訊： [!DNL ServiceNow] 自訂搜尋查詢，請參閱 <a href="https://docs.servicenow.com/bundle/orlando-platform-user-interface/page/use/common-ui-elements/reference/r_OpAvailableFiltersQueries.html">ServiceNow查詢檔案</a>.</p> </li> 
      </ul> </li> 
     <li> <p><strong>[！UICONTROL簡單]</strong> </p> 
      <ul> 
       <li> <p>[！UICONTROL搜尋條件]</p> <p>輸入您希望模組搜尋的條件。 如需設定搜尋篩選器的詳細資訊，請參閱 <a href="../../workfront-fusion/scenarios/add-a-filter-to-a-scenario.md" class="MCXref xref">在Adobe Workfront Fusion中新增篩選器至案例</a>.</p> </li> 
       <li> <p>[！UICONTROL排序依據]</p> <p>指出您希望模組依據哪個欄位來排序結果，以及這些結果應依遞增或遞減排序。</p> </li> 
      </ul> </li> 
    </ul> <p> </p> </td> 
  </tr> 
  <tr> 
