...
title: 網路套裝模組
description: 在Adobe Workfront Fusion案例中，您可以自動化使用下列專案的工作流程： [!DNL NetSuite]，以及將其連線到多個協力廠商應用程式和服務。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 情境下，您可以自動化使用下列專案的工作流程： [!DNL NetSuite]，以及將其連線到多個協力廠商應用程式和服務。
...
當您設定 [!DNL NetSuite] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL NetSuite] 視您在應用程式或服務中的存取層級等因素而定，可能會顯示欄位。 模組中的粗體標題表示必填欄位。
