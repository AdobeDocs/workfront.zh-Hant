...
title: 應用程式及其模組
description: Adobe Workfront Fusion目前為此清單上的應用程式提供專用連接器。 如果您要使用的應用程式不在此清單中，您可以使用HTTP、SOAP或JSON模組連線至該應用程式。
author: Becky
...
>[!IMPORTANT]
>
>Adobe Workfront Fusion幾乎可以連接到任何Web服務。 不僅限於此清單上的應用程式。 如果您要使用的應用程式不在此清單中，您可以使用下列模組直接連線至Web服務：
>
...
* [[!DNL Intacct] 模組](../../workfront-fusion/apps-and-their-modules/intacct-modules.md)
