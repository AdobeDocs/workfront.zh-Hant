...
在 [!DNL Adobe Workfront Fusion] 情境中，您可以使用自動化工作流程 [!DNL Adobe Firefly]，並連結至多個協力廠商應用程式和服務。
...
開始使用 [!DNL Adobe Firefly] 聯結器時，您必須確定符合下列先決條件：

* 您必須擁有使用中 [!DNL Adobe Firefly] 帳戶。

## 建立與的連線 [!DNL Adobe Firefly]

若要為建立連線，請執行下列步驟： [!DNL Adobe Firefly] 模組：
...
當您設定 [!DNL Adobe Firefly] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL Adobe Firefly] 欄位可能會顯示，端視您應用程式或服務中的存取層級等因素而定。 模組中的粗體標題表示必填欄位。
...
如需特定可用的API，請參閱 [ADOBE FIREFLY API](https://developer.adobe.com/firefly-services/docs/firefly-api/) (位於Adobe Developer檔案中)。
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      ...
      <td>有關建立與的連線的指示 [!DNL Adobe Firefly]，請參閱 <a href="#create-a-connection-to-adobe-firefly" class="MCXref xref" >建立與的連線 [!DNL Adobe Firefly]</a> 本文章內容。</td>
    </tr>
    <tr>
      <td role="rowheader">[！UICONTROL URL]</td>
      <td>
        <p>輸入相對於 <code>https://firefly-api-enterprise-stage.adobe.io/</code>.</p>
      </td>
    </tr>
    <tr>
      <td role="rowheader">
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[！UICONTROL Connection]</td> 
   <td>有關建立與的連線的指示 [!DNL Adobe Campaign]，請參閱 <a href="#create-a-connection-to-adobe-firefly" class="MCXref xref" >建立與的連線 [!DNL Adobe Firefly]</a> 本文章內容。</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>  <p> 按一下 <b>新增遮色片</b>. 從先前的模組中選取來源檔案，或對應來源檔案的「遮罩」檔案名稱和「遮罩」資料。 遮色片檔案代表將會填滿產生內容的自訂遮色片。</p> </td> 
</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL大小]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>如果要使用預設樣式，請按一下「新增專案」，然後輸入或對應您要使用的樣式。<p>如需預設樣式清單，請參閱 <a href="https://developer.adobe.com/firefly-services/docs/firefly-api/guides/concepts/styles/" >影像模型樣式</a> (在Adobe開發人員檔案中)。</td> 
  </tr> 
  <tr> 
