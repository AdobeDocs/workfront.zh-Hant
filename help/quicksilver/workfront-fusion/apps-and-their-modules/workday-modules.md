...
title: Workday模組
description: 在Adobe Workfront Fusion案例中，您可以自動化使用下列專案的工作流程： [!DNL Workday]，並連結至多個協力廠商應用程式和服務。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 情境中，您可以使用自動化工作流程 [!DNL Workday]，並連結至多個協力廠商應用程式和服務。
...
* 在中建立OAuth應用程式 [!DNL Workday]. 如需指示，請參閱 [!DNL Workday] 檔案。

## 連線 [!DNL Workday] 至 [!DNL Workfront Fusion]
   ...
   <table style="table-layout:auto"> 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>輸入您的網址 [!DNL Workday] 主機不含 <code>https://</code>. 例如： <code>mycompany.workday.com</code>.</td>
            </tr>
            <tr>
                <td role="rowheader">[！UICONTROL服務URL]</td>
                <td>輸入您的網址 [!DNL Workday] 網路服務，不含 <code>https://</code>. 例如： <code>mycompany-services.workday.com</code>.</td>
            </tr>
            <tr>
                <td  role="rowheader">[！UICONTROL租使用者名稱稱]</td>
                <td>輸入此專案的租使用者 [!DNL Workday] 帳戶。 您的租使用者是您組織的識別碼，可在您用來登入Workday的URL中看見。 範例：在位址中 <code>https://www.myworkday.com/mycompany</code>，租使用者為 <code>mycompany</code>.</td>
            </tr>
            <tr>
                <td role="rowheader">[！UICONTROL使用者端ID]</td>
                <td>輸入的使用者端ID [!DNL Workday] 此連線使用的應用程式。 您可在中建立應用程式時取得此資訊 [!DNL Workday].</td>
            </tr>
            <tr>
                <td  role="rowheader">[！UICONTROL使用者端密碼]</td>
                <td>輸入的使用者端密碼 [!DNL Workday] 此連線使用的應用程式。 您可在中建立應用程式時取得此資訊 [!DNL Workday].</td>
            </tr>
            <tr>
...
當您設定 [!DNL Workday] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL Workday] 欄位可能會顯示，端視您應用程式或服務中的存取層級等因素而定。 模組中的粗體標題表示必填欄位。
...
<table style="table-layout:auto"> 
    ...
    <tbody>
        <tr>
            ...
            <td>如需有關連線您的電腦的指示 [!DNL Workday] Workfront Fusion的帳戶，請參閱 <a href="#Connect" class="MCXref xre[!DNL ]f" >連線 [!DNL Workday] 至 [!DNL Workfront Fusion]</a>.</td>
        </tr>
        <tr>
...
<table style="table-layout:auto"> 
    ...
    <tbody>
        <tr>
            <td role="rowheader">[！UICONTROL Connection]</td>
            <td>如需有關連線您的電腦的指示 [!DNL Workday] 帳戶至 [!DNL Workfront Fusion]，請參閱 <a href="#Connect" class="MCXref xre[!DNL ]f" >連線 [!DNL Workday] 至 [!DNL Workfront Fusion]</a>.</td>
        </tr>
        <tr>
            <td  role="rowheader">[！UICONTROL記錄型別]</td>
            <td>選取您要刪除的記錄型別。</td>
...
<table style="table-layout:auto"> 
      ...
      <tbody>
          <tr>
              <td role="rowheader">[！UICONTROL Connection]</td>
              <td>如需有關連線您的電腦的指示 [!DNL Workday] 帳戶至 [!DNL Workfront Fusion]，請參閱 <a href="#Connect" class="MCXref xref" >連線 [!DNL Workday] 至 [!DNL Workfront Fusion]</a></td>
          </tr>
          <tr>
              <td  role="rowheader">[！UICONTROL記錄型別]</td>
              <td>選取您要擷取的記錄型別。</td>
