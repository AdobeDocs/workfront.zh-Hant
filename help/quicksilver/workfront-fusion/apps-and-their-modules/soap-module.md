...
* 自訂XML結構描述元素是在的協助下定義 [[!UICONTROL SOAP] 編碼](https://schemas.xmlsoap.org) 結構描述和元素。
...
1. 插入 **[!UICONTROL HTTP] > [!UICONTROL 提出要求]** 個模組（在案例中）。
1. 開啟模組的設定，並填寫下列欄位：
...
1. 複製 [!UICONTROL 請求XML] 文字區域。
1. 在 [!UICONTROL Workfront Fusion]，將複製的內容貼到模組的URL欄位。
