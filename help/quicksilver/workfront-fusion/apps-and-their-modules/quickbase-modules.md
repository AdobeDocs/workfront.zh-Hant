...
title: Quickbase模組
description: 在 [!DNL Adobe Workfront Fusion] 案例中，您可以自動化使用Quickbase的工作流程，並將其連線到多個協力廠商應用程式和服務。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 情境中，您可以使用自動化工作流程 [!DNL Quickbase]，並連結至多個協力廠商應用程式和服務。
...
若要使用 [!DNL Quickbase] 模組，您必須擁有 [!DNL Quickbase] 帳戶。

## [!DNL Quickbase] 模組及其欄位

當您設定 [!DNL Quickbase] 模組， [!DNL Workfront Fusion] 顯示下列欄位。 除了這些以外， [!DNL Quickbase] 欄位可能會顯示，端視您應用程式或服務中的存取層級等因素而定。 模組中的粗體標題表示必填欄位。
...
此模組會呼叫任何可用的 [!DNL Quickbase] RESTful API端點已記錄在 [developer.quickbase.com](https://developer.quickbase.com/).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>如需有關連線您的電腦的指示 [!DNL Quickbase] 帳戶至 [!DNL Workfront Fusion]，請參閱 <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">建立與Adobe的連線 [!DNL Workfront Fusion]  — 基本指示</a></p> </td> 
  </tr> 
  <tr> 
